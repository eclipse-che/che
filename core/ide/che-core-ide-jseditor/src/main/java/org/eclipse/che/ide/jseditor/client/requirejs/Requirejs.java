...
import org.eclipse.che.ide.jseditor.client.requirejs.config.RequirejsConfig;
...
public class Requirejs extends JavaScriptObject {
    ...
    public final native void require(JsArrayString deps, RequirejsCallback callback, RequirejsErrorHandler errorHandler) /*-{
        var realCallback = function() {
            ...
            callback.@org.eclipse.che.ide.jseditor.client.requirejs.RequirejsCallback::onReady(Lcom/google/gwt/core/client/JsArray;)(param);
        };
        var realErrHandler = function(err) {
            if (errorHandler) {
                errorHandler.@org.eclipse.che.ide.jseditor.client.requirejs.RequirejsErrorHandler::onError(Lorg/eclipse/che/ide/jseditor/client/requirejs/RequirejsErrorHandler$RequireError;)(err);
            } else {
    ...
    public final native void setOnError(RequirejsErrorHandler handler) /*-{
        this.onError = function(err) {
            handler.@org.eclipse.che.ide.jseditor.client.requirejs.RequirejsErrorHandler::onError(Lorg/eclipse/che/ide/jseditor/client/requirejs/RequirejsErrorHandler$RequireError;)(err);
        };
    }-*/;
}