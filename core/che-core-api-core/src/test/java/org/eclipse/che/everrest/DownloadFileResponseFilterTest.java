...
public class DownloadFileResponseFilterTest {
    ...
    public void checkDownloadFileWithParameter() throws Exception {
        ...
        final ContainerResponse response = resourceLauncher
                .service(HttpMethod.GET, SERVICE_PATH + "/list?" + DownloadFileResponseFilter.QUERY_DOWNLOAD_PARAMETER + "=hello.json",
