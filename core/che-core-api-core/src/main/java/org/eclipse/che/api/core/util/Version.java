...
public class Version implements Comparable<Version> {
  ...
  private static final String MILESTONE =
      "(" + MILESTONE_VERSION_SUFFIX + "(?<milestone>" + POSITIVE_NUMBER + "))?";
  private static final String BETA =
      "(" + BETA_VERSION_SUFFIX + "(?<beta>" + POSITIVE_NUMBER + "))?";
  ...
  private static final Pattern VERSION =
      compile(MAJOR + "\\." + MINOR + "\\." + BUGFIX + HOTFIX + MILESTONE + BETA + RC + SNAPSHOT);
   ...
   *
   * @throws IllegalArgumentException if {@code version} format is wrong
   */
