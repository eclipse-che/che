...
/**
 * Abstract Filter used to provide the json result as a file download operation.
...
public abstract class DownloadFileResponseFilter {
     ...
     * @return
     */
    protected String getFileName(Request request, MediaType mediaType, UriInfo uriInfo, int responseStatus) {
