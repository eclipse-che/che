...
public class FunctionConfiguratorManyToOne<P, R> {
    private final static Logger LOGGER = getLogger(FunctionConfiguratorManyToOne.class);
    ...
    FunctionConfiguratorManyToOne(RequestHandlerManager handlerManager, String method, Class<P> pClass, Class<R> rClass) {
