...
public class ParamsConfigurator {
    ...
    ParamsConfigurator(LoggerFactory loggerFactory, JsonRpcMarshaller marshaller, ResponseDispatcher dispatcher,
    ...
    public <P> SendConfiguratorFromOne<P> paramsAsDto(P pValue) {
        ...
        logger.debug("Configuring outgoing request params: " +
                     "endpoint ID: " + endpointId + ", " +
                     "method: " + method + ", " +
                     "params object class: " + pValue.getClass() + ", " +
                     "params object value: " + pValue);

        return new SendConfiguratorFromOne<>(loggerFactory, marshaller, dispatcher, transmitter, method, pValue, endpointId);
    }
    ...
    public SendConfiguratorFromNone noParams() {
        ...
        return new SendConfiguratorFromNone(loggerFactory, marshaller, dispatcher, transmitter, method, endpointId);
    }
    ...
    public <P> SendConfiguratorFromMany<P> paramsAsListOfDto(List<P> pListValue) {
        ...
        return new SendConfiguratorFromMany<>(loggerFactory, marshaller, dispatcher, transmitter, method, pListValue, endpointId);
    }
