...
public class ParamsConfigurator {
    ...
    ParamsConfigurator(JsonRpcMarshaller marshaller, ResponseDispatcher dispatcher, WebSocketMessageTransmitter transmitter, String method,
                       String endpointId) {
    ...
    public <P> SendConfiguratorFromOne<P> paramsAsDto(P pValue) {
        ...
        return new SendConfiguratorFromOne<>(marshaller, dispatcher, transmitter, method, pValue, endpointId);
    }
    ...
    public <P> SendConfiguratorFromMany<P> paramsAsListOfDto(List<P> pListValue) {
        ...
        return new SendConfiguratorFromMany<>(marshaller, dispatcher, transmitter, method, pListValue, endpointId);
    }
