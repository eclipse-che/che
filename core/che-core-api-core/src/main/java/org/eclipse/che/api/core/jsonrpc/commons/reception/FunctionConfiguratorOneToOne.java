...
public class FunctionConfiguratorOneToOne<P, R> {
    private final static Logger LOGGER = getLogger(FunctionConfiguratorOneToOne.class);
    ...
    FunctionConfiguratorOneToOne(RequestHandlerManager handlerManager, String method, Class<P> pClass, Class<R> rClass) {
