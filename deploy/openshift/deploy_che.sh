...
CHE_IMAGE_TAG - Set che-server image tag, defaults to "7.3.1"
...
DEFAULT_KEYCLOAK_IMAGE_TAG="7.3.3"
...
###
DEFAULT_PLUGIN_REGISTRY_IMAGE_TAG="7.3.3"
...
###
DEFAULT_DEVFILE_REGISTRY_IMAGE_TAG="7.3.3"
