...
CHE_IMAGE_TAG - Set che-server image tag, defaults to "7.6.0"
...
DEFAULT_KEYCLOAK_IMAGE_TAG="7.6.0"
...
###
DEFAULT_PLUGIN_REGISTRY_IMAGE_TAG="7.6.0"
...
###
DEFAULT_DEVFILE_REGISTRY_IMAGE_TAG="7.6.0"
...
${CHE_VAR_ARRAY}"
    ...
    CHE_INFRA_KUBERNETES_NAMESPACE_DEFAULT=${CHE_OPENSHIFT_PROJECT}
    ...
    ${OC_BINARY} new-app -f ${BASE_DIR}/templates/che-server-template.yaml \
                         ...
                         -p CHE_INFRA_KUBERNETES_NAMESPACE_DEFAULT=${CHE_INFRA_KUBERNETES_NAMESPACE_DEFAULT} \
