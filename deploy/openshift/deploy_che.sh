...
CHE_IMAGE_TAG - Set che-server image tag, defaults to "7.2.0"
...
DEFAULT_KEYCLOAK_IMAGE_TAG="7.2.0"
...
###
DEFAULT_PLUGIN_REGISTRY_IMAGE_TAG="7.2.0"
...
###
DEFAULT_DEVFILE_REGISTRY_IMAGE_TAG="7.2.0"
