...
CHE_IMAGE_TAG - Set che-server image tag, defaults to "7.5.0"
...
DEFAULT_KEYCLOAK_IMAGE_TAG="7.5.1"
...
###
DEFAULT_PLUGIN_REGISTRY_IMAGE_TAG="7.5.1"
...
###
DEFAULT_DEVFILE_REGISTRY_IMAGE_TAG="7.5.1"
