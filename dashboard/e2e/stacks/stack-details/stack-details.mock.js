            ...
            'environments': {
              'default': {
                'machines': {
                  'dev-machine': {
                    'servers': {},
                    'agents': ['org.eclipse.che.exec', 'org.eclipse.che.terminal', 'org.eclipse.che.ws-agent'],
            ...
            'environments': {
              'default': {
                ...
                'machines': {
                  'dev-machine': {
                    'servers': {},
                    'agents': ['org.eclipse.che.ws-agent', 'org.eclipse.che.exec', 'org.eclipse.che.terminal'],
                    'attributes': {'memoryLimitBytes': '2147483648'}
                  }
                }
              }
