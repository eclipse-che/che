...
interface ICheButtonDropdown2Attributes extends ng.IAttributes {
...
/**
 * @ngdoc directive
 * @name components.directive:cheButtonDropdown2
 * @restrict E
 *
 * @description
 * `<che-button-dropdown2>` defines a dropdown button
 *
 ...
 *                           other-actions-config="ctrl.otherActions"></che-button-dropdown2>
 *   </file>
 * </example>
 *
 * @author Oleksii Kurinnyi
 */
export class CheButtonDropdown2Directive implements ng.IDirective {
  restrict = 'E';
  ...
  template($element: ng.IAugmentedJQuery,
           $attrs: ICheButtonDropdown2Attributes): string {
    return `
<div class="che-button-dropdown2 btn-group" uib-dropdown>
