...
import {NamespaceSelectorController} from './create-workspace/ready-to-go-stack/namespace-selector/namespace-selector.controller';
import {NamespaceSelectorSvc} from './create-workspace/ready-to-go-stack/namespace-selector/namespace-selector.service';
import {NamespaceSelector} from './create-workspace/ready-to-go-stack/namespace-selector/namespace-selector.directive';
import {ProjectSourceSelectorController} from './create-workspace/ready-to-go-stack/project-source-selector/project-source-selector.controller';
import {ProjectSourceSelectorService} from './create-workspace/ready-to-go-stack/project-source-selector/project-source-selector.service';
import {ProjectSourceSelector} from './create-workspace/ready-to-go-stack/project-source-selector/project-source-selector.directive';
import {AddImportProjectController} from './create-workspace/ready-to-go-stack/project-source-selector/add-import-project/add-import-project.controller';
import {AddImportProjectService} from './create-workspace/ready-to-go-stack/project-source-selector/add-import-project/add-import-project.service';
import {AddImportProject} from './create-workspace/ready-to-go-stack/project-source-selector/add-import-project/add-import-project.directive';
import {ImportBlankProjectController} from './create-workspace/ready-to-go-stack/project-source-selector/add-import-project/import-blank-project/import-blank-project.controller';
import {ImportBlankProjectService} from './create-workspace/ready-to-go-stack/project-source-selector/add-import-project/import-blank-project/import-blank-project.service';
import {ImportBlankProject} from './create-workspace/ready-to-go-stack/project-source-selector/add-import-project/import-blank-project/import-blank-project.directive';
import {ImportGitProjectController} from './create-workspace/ready-to-go-stack/project-source-selector/add-import-project/import-git-project/import-git-project.controller';
import {ImportGitProjectService} from './create-workspace/ready-to-go-stack/project-source-selector/add-import-project/import-git-project/import-git-project.service';
import {ImportGitProject} from './create-workspace/ready-to-go-stack/project-source-selector/add-import-project/import-git-project/import-git-project.directive';
import {ImportZipProjectController} from './create-workspace/ready-to-go-stack/project-source-selector/add-import-project/import-zip-project/import-zip-project.controller';
import {ImportZipProjectService} from './create-workspace/ready-to-go-stack/project-source-selector/add-import-project/import-zip-project/import-zip-project.service';
import {ImportZipProject} from './create-workspace/ready-to-go-stack/project-source-selector/add-import-project/import-zip-project/import-zip-project.directive';
import {ImportGithubProjectController} from './create-workspace/ready-to-go-stack/project-source-selector/add-import-project/import-github-project/import-github-project.controller';
import {ImportGithubProjectService} from './create-workspace/ready-to-go-stack/project-source-selector/add-import-project/import-github-project/import-github-project.service';
import {ImportGithubProject} from './create-workspace/ready-to-go-stack/project-source-selector/add-import-project/import-github-project/import-github-project.directive';
import {GithubRepositoryItem} from './create-workspace/ready-to-go-stack/project-source-selector/add-import-project/import-github-project/github-repository-item/github-repository-item.directive';
import {TemplateSelectorController} from './create-workspace/ready-to-go-stack/project-source-selector/add-import-project/template-selector/template-selector.controller';
import {TemplateSelectorSvc} from './create-workspace/ready-to-go-stack/project-source-selector/add-import-project/template-selector/template-selector.service';
import {TemplateSelector} from './create-workspace/ready-to-go-stack/project-source-selector/add-import-project/template-selector/template-selector.directive';
import {TemplateSelectorItem} from './create-workspace/ready-to-go-stack/project-source-selector/add-import-project/template-selector/template-selector-item/template-selector-item.directive';
import {EditProjectController} from './create-workspace/ready-to-go-stack/project-source-selector/edit-project/edit-project.controller';
import {EditProject} from './create-workspace/ready-to-go-stack/project-source-selector/edit-project/edit-project.directive';
import {EditProjectService} from './create-workspace/ready-to-go-stack/project-source-selector/edit-project/edit-project.service';
import {ProjectMetadataController} from './create-workspace/ready-to-go-stack/project-source-selector/edit-project/project-metadata/project-metadata.controller';
import {ProjectMetadataService} from './create-workspace/ready-to-go-stack/project-source-selector/edit-project/project-metadata/project-metadata.service';
import {ProjectMetadata} from './create-workspace/ready-to-go-stack/project-source-selector/edit-project/project-metadata/project-metadata.directive';
...
import {DevfileSelector} from './create-workspace/ready-to-go-stack/devfile-selector/devfile-selector.directive';
import {DevfileSelectorController} from './create-workspace/ready-to-go-stack/devfile-selector/devfile-selector.controller';
