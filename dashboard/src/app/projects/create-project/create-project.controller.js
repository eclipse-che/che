...
export class CreateProjectCtrl {
   ...
   */
  constructor(cheAPI, cheStack, $websocket, $routeParams, $filter, $timeout, $location, $mdDialog, $scope, $rootScope, createProjectSvc, lodash, $q, $log, $document, cheNotification) {
    this.$log = $log;
    this.cheAPI = cheAPI;
