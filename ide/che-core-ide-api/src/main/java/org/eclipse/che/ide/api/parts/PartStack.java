...
public interface PartStack extends Presenter {
    ...
    enum State {
         ...
         * Part stack can be maximized, collapsed or hidden.
         */
        NORMAL,

        /**
         * Hidden part stack can not be maximized or collapsed.
         * It only can be displayed using show() methd.
         */
        HIDDEN,
        ...
        /**
         * Part stack is minimized while another one is maximized.
         * The state will be changed to NORMAL after restoring the perspective.
         */
        MINIMIZED
    ...
    /**
     * Minimizes the part stack.
     * The part state can be restored to NORMAL state when restoring the perspective.
     */
    void minimize();
