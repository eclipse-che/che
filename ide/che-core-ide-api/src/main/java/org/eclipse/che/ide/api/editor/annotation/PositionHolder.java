...
final class PositionHolder {
    ...
    public void addPosition(Position position) throws BadLocationException {
        if ((0 > position.offset) || (0 > position.length) || (position.offset + position.length > document.getContentsCharCount()))
    ...
    private List<Position> getStartingPositions(int offset, int length) throws BadPositionCategoryException {
    ...
    private List<Position> getEndingPositions(int offset, int length) throws BadPositionCategoryException {
