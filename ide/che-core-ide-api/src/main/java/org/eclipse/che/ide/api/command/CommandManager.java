...
public interface CommandManager {
    ...
    /**
     * Creates new command of the specified goal, type and with the given {@link ApplicableContext}.
    ...
    /** Creates new command of the specified goal, type and with the given name and {@link ApplicableContext}. */
    Promise<ContextualCommand> createCommand(String goalId,
                                             String commandTypeId,
                                             String commandName,
                                             ApplicableContext applicableContext);

    /** Creates new command of the specified goal, type and with the given name, command line and {@link ApplicableContext}. */
    Promise<ContextualCommand> createCommand(String goalId,
                                             String commandTypeId,
                                             String commandName,
                                             String commandLine,
