...
class DropdownMenu extends PopupPanel {
     ...
     *
     * @param dropdownList
     *         a dropdown list to which the menu should be bound
     * @param syncWidths
     *         specifies whether this dropdown menu's width always should be the same as the given {@code dropdownList}'s width
     */
