...
/** Button with popup menu opened on long click. */
public class MenuPopupButton extends ButtonBase {
    ...
    public MenuPopupButton(SafeHtml content, PopupItemDataProvider dataProvider, PopupActionHandler actionHandler) {
