...
public class SendConfiguratorFromList<P> {
    ...
    private final List<P>                     paramsValue;
    private final String                      endpointId;

    public SendConfiguratorFromList(ResponseDispatcher responseDispatcher, WebSocketMessageTransmitter transmitter,
                                    JsonRpcFactory jsonRpcFactory, String method, List<P> paramsValue, String endpointIds) {
        this.responseDispatcher = responseDispatcher;
        this.transmitter = transmitter;
        this.jsonRpcFactory = jsonRpcFactory;
        this.method = method;
        this.paramsValue = paramsValue;
        this.endpointId = endpointIds;
    }
    ...
    private void transmitNotification() {
        JsonRpcParams params = jsonRpcFactory.createParamsList(paramsValue);
