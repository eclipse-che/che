...
/**
 * Loader that contains configurable message.
 * To obtain the instance of this loader you need to inject {@link LoaderFactory} and call one from two methods.
 * First one creates loader with default message. Second one allow to pass own loader initial message.
 * Loader will be showed to user if total operation time is more that 0.5 second.
 *
