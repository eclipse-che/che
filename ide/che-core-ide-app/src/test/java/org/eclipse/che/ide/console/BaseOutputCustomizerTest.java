...
public class BaseOutputCustomizerTest {
    ...
    /**
     * Sets the customizer to be tested and array of all the customizers.
     * Normally is to be called from setUp() method, before any test case run.
     *  
     * @param customizer 
     * @param customizers 
     */
    protected void setupTestCustomizers(OutputCustomizer customizer, OutputCustomizer... customizers) {
     ...
     * @throws Exception
     */
    protected void testStackTraceLine(Class expectedCustomizerClass, String line, String expectedCustomization)
            throws Exception {
