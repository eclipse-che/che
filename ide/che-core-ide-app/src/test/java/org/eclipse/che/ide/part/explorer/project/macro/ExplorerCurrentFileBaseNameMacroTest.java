...
public class ExplorerCurrentFileBaseNameMacroTest extends AbstractExplorerMacroTest {
    ...
    public void init() throws Exception {
        super.init();
        provider = new ExplorerCurrentFileBaseNameMacro(projectExplorer, promiseProvider, localizationConstants);
    }
    ...
    public void getMultipleValues() throws Exception {
        ...
        verify(promiseProvider).resolve(eq(Joiner.on(", ").join(FILE_1_NAME_WITHOUT_EXT, FILE_2_NAME_WITHOUT_EXT)));
    }
