...
public class PreferencesManagerImpl implements PreferencesManager {
    ...
    public Promise<Void> flushPreferences() {
        ...
        return updatePreferences(changedPreferences).thenPromise(result -> {
    ...
    public Promise<Map<String, String>> loadPreferences() {
        return getPreferences().then((Function<Map<String, String>, Map<String, String>>)preferences -> {
    ...
    private Promise<Map<String, String>> getPreferences() {
        return asyncRequestFactory.createGetRequest(PREFERENCES_SERVICE_ENDPOINT)
    ...
    private Promise<Map<String, String>> updatePreferences(Map<String, String> newPreferences) {
        ...
        return asyncRequestFactory.createPutRequest(PREFERENCES_SERVICE_ENDPOINT, null)
                                  .header(ACCEPT, APPLICATION_JSON)
                                  .header(CONTENT_TYPE, APPLICATION_JSON)
                                  .data(data)
                                  .send(new StringMapUnmarshaller());
