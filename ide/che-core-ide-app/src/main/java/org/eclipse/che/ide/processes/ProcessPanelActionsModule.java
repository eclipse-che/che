...
/**
 * Module for configuring Process Panel persistent actions.
 *
 * @author Vlad Zhukovskyi
 * @since 6.0.0
 */
@Singleton
public class ProcessPanelActionsModule {

  @Inject
  public ProcessPanelActionsModule(
      ActionManager actionManager, DisplayMachineOutputAction displayMachineOutputAction) {
