...
public class WsAgentURLModifierInitializer {
    ...
    @Inject
    public WsAgentURLModifierInitializer(WsAgentURLModifier wsAgentURLModifier, AppContext appContext, EventBus eventBus) {
        ...
        eventBus.addHandler(WorkspaceRunningEvent.TYPE, e -> appContext.getWorkspace()
                                                                       .getDevMachine()
                                                                       .ifPresent(wsAgentURLModifier::initialize));
    }
}
