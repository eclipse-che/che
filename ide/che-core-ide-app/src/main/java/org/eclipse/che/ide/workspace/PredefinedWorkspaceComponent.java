...
/**
 * Initializes workspace with predefined projects.
 */
@Singleton
public class PredefinedWorkspaceComponent extends WorkspaceComponent {

    private InitialProjectImporter initialProjectImporter;

    @Inject
    public PredefinedWorkspaceComponent(WorkspaceServiceClient workspaceServiceClient,
