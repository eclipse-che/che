...
import org.eclipse.che.ide.api.dialogs.Credentials;
...
public class AskCredentialsDialogImpl extends Window implements AskCredentialsDialog {
    ...
    private static AskAuthenticatorImplUiBinder uiBinder = GWT.create(AskAuthenticatorImplUiBinder.class);
    ...
    public AskCredentialsDialogImpl(CoreLocalizationConstant localizationConstant) {
        ...
        authenticateButton = createPrimaryButton(localizationConstant.authenticationDialogAuthenticate(),
                                                 "authentication-dialog-authenticate-button",
                                                 event -> onAuthenticateClicked());
        Button cancelButton = createButton(localizationConstant.cancel(),
