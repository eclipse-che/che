...
public class CurrentWorkspaceManager {
    ...
    private void subscribeToEvents() {
        ...
        subscriptionManagerClient.subscribe(WORKSPACE_STATUSES_ENDPOINT_ID, WORKSPACE_STATUS_CHANGED_METHOD, scope);
        subscriptionManagerClient.subscribe(WORKSPACE_STATUSES_ENDPOINT_ID, MACHINE_STATUS_CHANGED_METHOD, scope);
        subscriptionManagerClient.subscribe(WORKSPACE_STATUSES_ENDPOINT_ID, SERVER_STATUS_CHANGED_METHOD, scope);
        subscriptionManagerClient.subscribe(WORKSPACE_OUTPUT_ENDPOINT_ID, MACHINE_LOG_METHOD, scope);
        subscriptionManagerClient.subscribe(WORKSPACE_OUTPUT_ENDPOINT_ID, INSTALLER_LOG_METHOD, scope);
    }
}
