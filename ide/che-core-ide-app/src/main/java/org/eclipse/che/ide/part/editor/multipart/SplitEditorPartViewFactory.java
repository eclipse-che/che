...
/**
 * The factory creates instances of {@link SplitEditorPartView} to display view representation of editors
 * in {@link EditorMultiPartStackView}.
 *
...
public interface SplitEditorPartViewFactory {
     ...
     *
     * @param specimen
     *         widget which is regarded as a specimen when splitting
