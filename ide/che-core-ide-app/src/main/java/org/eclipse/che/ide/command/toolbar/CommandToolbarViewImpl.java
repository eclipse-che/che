...
public class CommandToolbarViewImpl implements CommandToolbarView {
    ...
    public CommandToolbarViewImpl(ProcessesListPresenter processesListPresenter,
        ...
        SafeHtmlBuilder play = new SafeHtmlBuilder();
        play.appendHtmlConstant(FontAwesome.PLAY);
        runPopupItemDataProvider = new RunPopupItemDataProvider();
        runCommands = new MenuPopupButton(play.toSafeHtml(), runPopupItemDataProvider, new PopupActionHandler() {
            @Override
            public void onItemSelected(PopupItem item) {
                if (item instanceof CommandPopupItem) {
                    ...
                    delegate.runCommand(machinePopupItem.getCommand(), machinePopupItem.getMachine());
                }
        ...
        SafeHtmlBuilder bug = new SafeHtmlBuilder();
        bug.appendHtmlConstant(FontAwesome.BUG);
        debugCommands = new MenuPopupButton(bug.toSafeHtml(), new PopupItemDataProvider() {
