...
@Beta
@Singleton
public class ExplorerCurrentFileParentPathProvider implements CommandPropertyValueProvider {
    ...
    @Inject
    public ExplorerCurrentFileParentPathProvider(ProjectExplorerPresenter projectExplorer,
