 ...
 */
public class PartStackViewImpl extends Composite implements RequiresResize, PartStackView, MouseDownHandler, ContextMenuHandler {

    interface PartStackViewImplUiBinder extends UiBinder<Widget, PartStackViewImpl> {
    }

    private static final PartStackViewImplUiBinder UI_BINDER = GWT.create(PartStackViewImplUiBinder.class);
    ...
    @UiField
    FlowPanel                                 partButtons;

    @UiField
    FlowPanel                                 partStackActions;
    ...
    @UiField
    DeckLayoutPanel                           partStackContent;
    ...
    private void addMaximizeButton() {
        ...
        maximizeToolButton.addClickHandler(new ClickHandler() {
            @Override
        ...
        if (maximizeButton.getElement() instanceof elemental.dom.Element) {
            Tooltip.create((elemental.dom.Element) maximizeButton.getElement(),
                    PositionController.VerticalAlign.BOTTOM, PositionController.HorizontalAlign.MIDDLE, localizationConstant.maximizePartStackTitle());
        }
    }
    ...
    private void addMenuButton() {
        ...
        if (menuButton.getElement() instanceof elemental.dom.Element) {
            Tooltip.create((elemental.dom.Element) menuButton.getElement(),
                    PositionController.VerticalAlign.BOTTOM, PositionController.HorizontalAlign.MIDDLE, localizationConstant.partStackOptionsTitle());
        }
    }
