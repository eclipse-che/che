...
public class PreviewsViewImpl implements PreviewsView {
  ...
  @Inject
  public PreviewsViewImpl(ToolbarMessages messages, WsAgentMachineUtil wsAgentMachineUtil) {
  ...
  public void addUrl(String previewUrl) {
    ...
    final PreviewUrl displayablePreviewUrl = new PreviewUrl(previewUrl, wsAgentMachineUtil);
