...
/**
 * Provider which is responsible for retrieving the resource name without extension from the project explorer.
 * <p>
 * Macro provided: <code>${explorer.current.file.basename}</code>
 * <p>
...
public class ExplorerCurrentFileBaseNameMacro implements Macro {
    ...
    private Predicate<Node> resNodePredicate = input -> {
        checkNotNull(input);
    ...
    @Inject
    public ExplorerCurrentFileBaseNameMacro(ProjectExplorerPresenter projectExplorer,
