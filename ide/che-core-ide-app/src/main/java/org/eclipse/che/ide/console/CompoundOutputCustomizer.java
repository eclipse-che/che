...
public class CompoundOutputCustomizer implements OutputCustomizer {
    ...
    /**
     * Constructs the compound customizer object from a number of specified output
     * customizers
     * 
     * @param customizers
     */
    ...
    public String customize(String text) {
        Optional<OutputCustomizer> optional = Stream.of(customizers).filter(customizer -> customizer.canCustomize(text))
                .findFirst();
