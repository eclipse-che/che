...
/**
 * //TODO Doc
 * //TODO Mb move it to another module
 *
...
public class AuthServerCheckerFactoryImpl extends ServerCheckerFactoryImpl {
  ...
  @Override
  public HttpConnectionServerChecker httpChecker(URL url, RuntimeIdentity runtimeIdentity,
      String machineName, String serverRef,
      Timer timer) throws InfrastructureException {

    try {
      URL newUrl = UriBuilder.fromUri(url.toString())
          .queryParam("token", machineTokenRegistry
              .getOrCreateToken(EnvironmentContext.getCurrent().getSubject().getUserId(),
