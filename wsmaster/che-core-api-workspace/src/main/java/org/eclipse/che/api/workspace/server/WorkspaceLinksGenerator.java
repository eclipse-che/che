...
public class WorkspaceLinksGenerator {
    ...
    @Inject
    public WorkspaceLinksGenerator(WorkspaceRuntimes workspaceRuntimes,
    ...
    private void addRuntimeLinks(Map<String, String> links, String workspaceId) throws ServerException {
