 ...
 */
@Singleton
public class AddJustRunMachineIntoWorkspaceRuntime implements EventSubscriber<MachineStatusEvent> {
    ...
    @Inject
    public AddJustRunMachineIntoWorkspaceRuntime(EventService eventService,
