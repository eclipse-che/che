...
public class AgentConfigApplierTest {
    ...
    public void shouldAddExposedPorts() throws Exception {
        ...
        when(agent1.getServers()).thenAnswer(invocation -> singletonMap("serv1", serverConf1));
        when(agent2.getServers()).thenAnswer(invocation -> singletonMap("serv2", serverConf2));
