...
public class RecipeDaoTest {
  ...
  @Inject private TckRepository<OldRecipeImpl> tckRepository;
  ...
  public void shouldFindRecipeByUser() throws Exception {
    final List<OldRecipeImpl> result = recipeDao.search(null, null, null, 0, recipes.size());
  ...
  public void shouldFindRecipeByType() throws Exception {
    final OldRecipeImpl recipe = recipes.get(0);
    final List<OldRecipeImpl> result =
