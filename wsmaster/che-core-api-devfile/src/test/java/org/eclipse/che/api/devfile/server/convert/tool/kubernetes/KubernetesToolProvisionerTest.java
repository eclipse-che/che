...
public class KubernetesToolProvisionerTest {

  private KubernetesToolProvisioner kubernetesToolProvisioner;

  @BeforeMethod
  public void setUp() {
    kubernetesToolProvisioner = new KubernetesToolProvisioner();
  }
  ...
  public void shouldThrowExceptionIfWorkspaceHasMultipleEnvironmentsWithKubernetesOpenShiftRecipes()
    ...
    // when
    kubernetesToolProvisioner.provision(new Devfile(), workspaceConfig);
  }
