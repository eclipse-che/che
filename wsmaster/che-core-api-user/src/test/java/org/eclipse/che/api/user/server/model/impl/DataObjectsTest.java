...
public class DataObjectsTest {
    ...
    public Object[][] singleObjectProvider() {
        return new Object[][] {
                ...
                {
                        new ProfileImpl("user123", "user@company.com", ImmutableMap.of("attribute1", "value1",
                                                                                       "attribute2", "value2",
                                                                                       "attribute3", "value3"))
                }
        };
    ...
    public Object[][] consistencyDatProvider() {
        return new Object[][] {
                ...
                {
                        new ProfileImpl("user123", "user@company.com", null),
                        new ProfileImpl("user123", "user@company.com", new HashMap<>())
                }
        };
    }
}
