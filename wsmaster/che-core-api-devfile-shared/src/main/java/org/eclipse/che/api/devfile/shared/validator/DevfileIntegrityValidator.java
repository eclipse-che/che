 ...
 */
package org.eclipse.che.api.devfile.shared.validator;
...
import org.eclipse.che.api.devfile.shared.kubernetes.SelectorFilter;
...
public class DevfileIntegrityValidator {
  ...
  private final RecipeParser kubernetesRecipeParser;

  @Inject
  public DevfileIntegrityValidator(Map<String, RecipeParser> recipeParsers) {
    this.kubernetesRecipeParser = recipeParsers.get(KUBERNETES_COMPONENT_TYPE);
    if (kubernetesRecipeParser == null) {
      throw new IllegalStateException(
          "Could not find a recipe parser for parsing kubernetes lists");
    }
  }
  ...
  private List<HasMetadata> validateSelector(
      ...
      throws ValidationException, IOException, DevfileException {
