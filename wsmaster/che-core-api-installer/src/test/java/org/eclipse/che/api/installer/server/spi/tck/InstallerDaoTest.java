...
public class InstallerDaoTest {
    ...
    @Inject
    private TckRepository<InstallerImpl> tckRepository;
    ...
    public void shouldCreateInstaller() throws Exception {
        ...
        assertEquals(installerDao.getByFqn(new InstallerFqn("id_new", "1.0.0")), new InstallerImpl(newInstaller));
    }
    ...
    public void shouldUpdateInstaller() throws Exception {
        InstallerImpl updatedInstaller = TestInstallerFactory.createInstaller(installers[0].getId(), installers[0].getVersion());
