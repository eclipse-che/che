...
public class LocalInstallerRegistryTest {
    ...
    public static Object[][] versions() {
        return new Object[][] {{"installer1", ImmutableSet.of("1.0.0", "2.0.0")},
    ...
    public void sortInstallersRespectingDependencies() throws Exception {
        ...
        List<Installer> sorted = registry.getOrderedInstallers(asList("installer1:1.0.0", "installer2", "installer3"));
    ...
    @Test(expectedExceptions = InstallerException.class,
          expectedExceptionsMessageRegExp = "Installers circular dependency found between 'installer1:1.0.0'" +
