 ...
 *
 * <p>Instance of {@link RemoteInstallerRegistry} will be provided if it is configured
 * otherwise instance of {@link LocalInstallerRegistry} will be provided.
 *
 * @author gazarenkov
...
public class InstallerRegistryProvider implements Provider<InstallerRegistry> {
    ...
    public InstallerRegistry get() {
        return remoteInstallerRegistry.isConfigured() ? remoteInstallerRegistry : localInstallerRegistry;
    }
}
