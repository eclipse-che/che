...
public class InstallerRegistryService extends Service {
    ...
    public InstallerDto getInstaller(@ApiParam("The installer key") @PathParam("key") String key) throws InstallerException {
    ...
    @ApiResponses({@ApiResponse(code = 201, message = "Installer successfully added"),
                   @ApiResponse(code = 409, message = "Installer with corresponding fully-qualified name already exists"),
    ...
    @ApiResponses({@ApiResponse(code = 204, message = "Installer successfully removed"),
    ...
    @ApiResponses({@ApiResponse(code = 204, message = "Installer successfully updated"),
                   @ApiResponse(code = 404, message = "Installer with corresponding fully-qualified name doesn't exist in the registry"),
