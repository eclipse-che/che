 ...
 *      |
 *      -- version_1
 *      |   |------- installer_1_version_1.script.sh
 *      |   |------- installer_1_version_1.json
 *      -- version_2
 *          |------- installer_1_version_2.script.sh
...
public class InstallersProvider implements Provider<Set<Installer>> {
    ...
    private Installer init(Path descriptorPath, Path scriptPath) {
        try {
            ...
            InstallerDto installer = DtoFactory.getInstance().createDtoFromJson(descriptor, InstallerDto.class);
