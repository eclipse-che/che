...
public class RecipeService extends Service {
    ...
    public Response createRecipe(NewOldRecipe newRecipe) throws ApiException {
        ...
        final OldRecipeImpl recipe = new OldRecipeImpl().withId(NameGenerator.generate("recipe", 16))
    ...
    public List<OldRecipeDescriptor> searchRecipes(@QueryParam("tags") List<String> tags,
    ...
    private OldRecipeDescriptor asRecipeDescriptor(ManagedOldRecipe recipe) {
        final OldRecipeDescriptor descriptor = DtoFactory.getInstance()
