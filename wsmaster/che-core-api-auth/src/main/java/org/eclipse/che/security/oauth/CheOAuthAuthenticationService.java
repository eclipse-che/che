...
@Path("oauth")
public class CheOAuthAuthenticationService extends OAuthAuthenticationService {
  private static final Logger LOG = LoggerFactory.getLogger(CheOAuthAuthenticationService.class);
