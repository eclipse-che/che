...
public class SvnUpdateToRevision {
    ...
    public void waitMainFormIsOpen() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(mainFormUpdateRevision));
    }
    ...
    public void waitMainFormIsClosed() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.invisibilityOfElementLocated(By.id
                (Locators.UPDATE_TO_REVISION_FORM)));
    }
    ...
    public void clickOnUpdateBtn() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.elementToBeClickable(buttonUpdate));
        buttonUpdate.click();
    }
