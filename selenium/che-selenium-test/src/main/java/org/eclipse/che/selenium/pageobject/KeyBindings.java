...
public class KeyBindings {
    ...
    public void waitKeyBindingsFormIsOpened() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(keyBindingsForm));
    }
    ...
    public void clickOkButton() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.elementToBeClickable(okButton))
                                                                   .click();
    }
     ...
     *
     * @param keyBindingsList
     *         is expected list binding keys
     */
     ...
     *
     * @param keyBinding
     *         is name or part of name binding key
     * @param result
     *         is expected number of matches
     */
    public void checkSearchResultKeyBinding(String keyBinding, int result) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(
                ExpectedConditions.visibilityOfElementLocated(By.xpath(Locators.SEARCH_INPUT))).sendKeys(keyBinding);
        List<WebElement> webElementList = getListElementsKeyBindingById(Locators.ID_KEY_BY_KEY_BINDINGS);
        new WebDriverWait(seleniumWebDriver, MINIMUM_SEC).until((WebDriver webDriver) -> webElementList.size() == result);
    ...
    public void enterKeyCombination(Keys... key) {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(
                ExpectedConditions.visibilityOfElementLocated(By.tagName("body"))).sendKeys(Keys.chord(key));
    }
