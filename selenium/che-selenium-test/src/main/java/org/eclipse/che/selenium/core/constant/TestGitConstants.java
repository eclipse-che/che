...
public final class TestGitConstants {
    ...
    public static final String GIT_NOTHING_TO_ADD                          = "Selected item does not have any unstaged changes";
    ...
    public static final String CONFIGURING_PROJECT_AND_CLONING_SOURCE_CODE = "Configuring project and cloning source code.";
}
