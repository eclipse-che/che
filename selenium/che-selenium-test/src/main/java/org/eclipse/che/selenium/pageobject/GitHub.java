...
public class GitHub {
    ...
    public void waitClosingLoginPage() {
        new WebDriverWait(seleniumWebDriver, 10).until(ExpectedConditions.invisibilityOfElementLocated(By.id(Locators.PASS_FIELD)));
        new WebDriverWait(seleniumWebDriver, 10).until(ExpectedConditions.invisibilityOfElementLocated(By.id(Locators.LOGIN_FIELD)));
    }
    ...
    public void clickOnSignInButton() {
        new WebDriverWait(seleniumWebDriver, 15).until(ExpectedConditions.elementToBeClickable(signInBtn));
        signInBtn.click();
    }
    ...
    public void waitAccountSettingsBtn() {
        new WebDriverWait(seleniumWebDriver, 30).until(ExpectedConditions.visibilityOfElementLocated(By.id(Locators.ACCOUNT_SETTINGS)));
    }
    ...
    public void waitApplicationsBtn() {
        new WebDriverWait(seleniumWebDriver, 30).until(ExpectedConditions.visibilityOfElementLocated(By
    ...
    public void waitRevokeBtnDisappear() {
        new WebDriverWait(seleniumWebDriver, 30).until(ExpectedConditions.invisibilityOfElementLocated(By
    ...
    public void waitSshKeysBtn() {
        new WebDriverWait(seleniumWebDriver, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(Locators.SSH_KEYS_BTN)));
    }
    ...
    public boolean isDeleteSshKeyButtonPresent() {
        try {
            WebElement element = seleniumWebDriver.findElement(By.xpath(String.format(
                    Locators.DELETE_SSH_KEY_BTN, testUser.getName())));
            return element.isDisplayed();
        } catch (Exception e) {
            System.err.println("Element not found!");
            return false;
    ...
    public void waitDeleteButton() {
        new WebDriverWait(seleniumWebDriver, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(String.format(
                Locators.DELETE_SSH_KEY_BTN, testUser.getName()))));
    }
    ...
    public void waitDeleteButtonDisappear() {
        new WebDriverWait(seleniumWebDriver, 30).until(ExpectedConditions.invisibilityOfElementLocated(By.xpath(String.format(
                Locators.DELETE_SSH_KEY_BTN, testUser.getName()))));
    }
    ...
    public void clickOnDeleteSshKeyButton() {
        WebElement elem =
                seleniumWebDriver.findElement(By.xpath(String.format(Locators.DELETE_SSH_KEY_BTN, testUser.getName())));
        elem.click();
    }
    ...
    public void waitConfirmPasswordInput() {
        new WebDriverWait(seleniumWebDriver, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(Locators.CONFIRM_PASS_INPUT_ID)));
    }
    ...
    public void waitApplicationsPage() {
        new WebDriverWait(seleniumWebDriver, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(Locators.APPLICATIONS_PAGE)));
    }
    ...
    public void waitSshPage() {
        new WebDriverWait(seleniumWebDriver, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(Locators.SSH_PAGE)));
    }
}
