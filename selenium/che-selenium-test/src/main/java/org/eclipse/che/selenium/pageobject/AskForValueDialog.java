...
public class AskForValueDialog {
    ...
    private static final String ERROR_LABEL           = "//*[@id='gwt-debug-askValueDialog-window']//" +
    ...
    private static final String INTERFACE_ITEM        = "//*[@id='gwt-debug-newJavaSourceFileView-typeField' ]//option[@value='Interface']";
    private static final String ENUM_ITEM             = "//*[@id='gwt-debug-newJavaSourceFileView-typeField' ]//option[@value='Enum']";
    ...
    public void clickCancelButtonJava() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(cancelButtonJava))
                                                                       .click();
    }
    ...
    public void selectInterfaceItemFromDropDown() {
        ...
        type.click();
        new WebDriverWait(seleniumWebDriver, 7).until(ExpectedConditions.elementToBeClickable(By.xpath(INTERFACE_ITEM)));
        interfaceItem.click();
    }
    ...
    public void selectEnumItemFromDropDown() {
        new WebDriverWait(seleniumWebDriver, 7).until(ExpectedConditions.visibilityOf(type));
        type.click();
        new WebDriverWait(seleniumWebDriver, 7).until(ExpectedConditions.elementToBeClickable(By.xpath(ENUM_ITEM)));
        enumItem.click();
    }
    ...
    public void waitInputNameContains(final String expectedText) {
        new WebDriverWait(seleniumWebDriver, 3).until((ExpectedCondition<Boolean>)
                                                         webDriver -> seleniumWebDriver.findElement(By.id(INPUT)).getAttribute("value")
