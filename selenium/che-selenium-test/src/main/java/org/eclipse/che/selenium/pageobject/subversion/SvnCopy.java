...
public class SvnCopy {
    ...
    @Inject
    public SvnCopy(SeleniumWebDriver seleniumWebDriver, ActionsFactory actionsFactory, Loader loader) {
    ...
    public void waitCopyFormOpened() {
        new WebDriverWait(seleniumWebDriver, ELEMENT_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(svnCopyForm));
    }
    ...
    public void waitItem(String path, int timeout) throws Exception {
        ...
        new WebDriverWait(seleniumWebDriver, timeout).until(ExpectedConditions.presenceOfElementLocated(
                By.xpath(locator)));
    }
    ...
    public void clickCopyButton() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.elementToBeClickable(copyButton));
        copyButton.click();
    }
}
