...
public class ProjectExplorer {
    ...
    private interface Locators {
        ...
        String PROJECT_EXPLORER_TAB_IN_THE_LEFT_PANEL = "//div[@id='gwt-debug-leftPanel']//div[text()='Projects']";
    }
    ...
    public void clickCollapseAllButton() {
        new WebDriverWait(seleniumWebDriver, 10).until(ExpectedConditions.elementToBeClickable(collapseAllBtn));
