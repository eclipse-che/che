...
public class SvnMove {
    ...
    @Inject
    public SvnMove(SeleniumWebDriver seleniumWebDriver, ActionsFactory actionsFactory, Loader loader) {
    ...
    public void waitMoveFormOpened() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(moveForm));
    }
    ...
    public void clickMoveButton() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.elementToBeClickable(moveButton));
        moveButton.click();
    }
