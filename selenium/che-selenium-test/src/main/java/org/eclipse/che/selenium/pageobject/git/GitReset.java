...
public class GitReset {
    ...
    public void waitOpen() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(form));
    }
    ...
    public void waitClose() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC)
                .until(ExpectedConditions.invisibilityOfElementLocated(By.xpath(Locators.RESET_TO_COMMIT_FORM)));
    }
    ...
    public void clickResetBtn() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(resetBtn)).click();
    }
    ...
    public void waitCommitIsPresent(String text) {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC)
                .until(ExpectedConditions.visibilityOfElementLocated(By.xpath(String.format(Locators.COMMENT, text))));
    ...
    public void selectCommit(int numberLine) {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC)
                .until(ExpectedConditions.visibilityOfElementLocated(By.xpath(String.format(Locators.COMMIT_ITEM, numberLine)))).click();
    }
}
