...
public class GitHistory {
    ...
    private interface Locators {
        ...
        String COMMIT_INTO_HISTORY_FORM = "//div[@id='gwt-debug-git-history-window']//following::div[contains(text(), '%s')]";
    }

    @FindBy
            (id = Locators.HISTORY_FORM_ID)
    WebElement historyForm;

    @FindBy
            (xpath = Locators.HISTORY_EDITOR)
    WebElement historyEditor;

    @FindBy
            (id = Locators.CLOSE_BUTTON_HISTORY)
    ...
    public void waitHistoryForm() {
        new WebDriverWait(seleniumWebDriver, ELEMENT_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(historyForm));
    }
    ...
    public void clickCompareButton() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.elementToBeClickable(By.id(Locators.COMPARE_BUTTON_HISTORY))).click();
    }
    ...
    public String getFullDescription() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(historyEditor));
    ...
    public void selectHistoryRowByIndex(int rowIndex) {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOfElementLocated
                (By.xpath(String.format(Locators.HISTORY_ROW_NUMBER, Integer.toString(rowIndex))))).click();
        loader.waitOnClosed();
    }
    ...
    public void waitTextInHistoryList(final String expectedText) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until((ExpectedCondition<Boolean>)
                                                                                      webDriver -> historyForm.getText().contains(
                                                                                              expectedText));
    }
    ...
    public void waitContentIntoHistoryEditor(final String expectedContent) {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(
                (ExpectedCondition<Boolean>)webDriver -> getFullDescription().contains(expectedContent));
    }
    ...
    public void clickCommitInHistoryForm(String text) {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOfElementLocated
                (By.xpath(String.format(Locators.COMMIT_INTO_HISTORY_FORM, text)))).click();
    }
    ...
    public void clickOnCloseButtonHistory() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.elementToBeClickable(closeButtonHistory)).click();
