...
public class CommandsExplorer {
    ...
    @Inject
    public CommandsExplorer(SeleniumWebDriver seleniumWebDriver, AskDialog askDialog, CommandsEditor commandsEditor, Loader loader) {
    ...
    private static class Locators {
        static final String COMMANDS_TAB_IN_THE_LEFT_PANEL_LOCATOR = "//div[@id='gwt-debug-partButton-Commands']";
        static final String MAIN_FORM                              = "//div[@id='gwt-debug-commands-explorer']";
        static final String ADD_COMMAND_TYPE                       = "//div[@class='popupContent']/select/option[text()='%s']";
        static final String CHOOSE_COMMAND_BY_NAME                 = "//div[@id='gwt-debug-commands-explorer']//div[text()='%s']";
        ...
        static final String ADD_COMMAND_BUTTON_LOCATOR             = "//div[@id='goal_%s']/span[@id='commands_tree-button-add']";
    ...
    private WebElement getCommandTypeElementInContextMenu(String commandType) {
        return seleniumWebDriver.findElement(By.xpath(String.format(Locators.ADD_COMMAND_TYPE, commandType)));
    }

    private WebElement getCommandByName(String commandlName) {
        return seleniumWebDriver.findElement(By.xpath(String.format(Locators.CHOOSE_COMMAND_BY_NAME, commandlName)));
    }
    ...
    public void waitCommandExplorerIsOpened() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(mainForm));
    ...
    public void clickAddCommandButton(String goalName) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath(String.format(Locators.ADD_COMMAND_BUTTON_LOCATOR, goalName)))).click();
    }
    ...
    public void chooseCommandTypeInContextMenu(String type) {
        ...
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.elementToBeClickable(
                getCommandTypeElementInContextMenu(type))).click();
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(
                ExpectedConditions.elementToBeSelected(getCommandTypeElementInContextMenu(type)));
        new Actions(seleniumWebDriver).doubleClick(getCommandTypeElementInContextMenu(type)).build().perform();
    }
     ...
     *
     * @param commandName
     *         is a visible command name in command explorer
     */
    ...
    public void cloneCommandByName(String commandName) {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//div[@id='command_" + commandName + "']//span[@id='commands_tree-button-duplicate']"))).click();
    }

    public void clickOnRemoveButtonInExplorerByName(String commandName) {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//div[@id='command_" + commandName + "']"))).click();
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//div[@id='command_" + commandName + "']//span[@id='commands_tree-button-remove']"))).click();
    }
    ...
    public void waitRemoveCommandFromExplorerByName(String commandName) {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.invisibilityOfElementLocated(
                By.xpath("//div[@id='command_" + commandName + "']")));
    }

    public void checkCommandIsPresentInGoal(String goalName, String commandName) {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//div[@id='goal_" + goalName + "']/parent::div//div[@id='command_" + commandName + "']")));
    }
