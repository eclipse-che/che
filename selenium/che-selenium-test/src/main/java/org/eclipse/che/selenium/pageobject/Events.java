...
public class Events {
    ...
    @Inject
    public Events(SeleniumWebDriver seleniumWebDriver, Loader loader, NotificationsPopupPanel notificationsPopupPanel,
    ...
    public void waitProjectEventsTab() {
        new WebDriverWait(seleniumWebDriver, 30).until(ExpectedConditions.visibilityOf(projectEventsTab));
    }
    ...
    public void waitOpened() {
        new WebDriverWait(seleniumWebDriver, 20).until(ExpectedConditions.presenceOfElementLocated(By.id(EVENTS_AREA)));
    }
    ...
    public void waitEventsPanelIsClosed() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until
                (ExpectedConditions.invisibilityOfElementLocated(By.id(EVENTS_AREA)));
    }
    ...
    public void doubleClickProjectEventsTab() {
        ...
        waitProjectEventsTab();
        loader.waitOnClosed();
        actionsFactory.createAction(seleniumWebDriver).doubleClick().doubleClick(projectEventsTab).perform();
    }
    ...
    public void clickMinimizeButtonEventsPanel() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.id(MINIMIZE_BUTTON))).click();
