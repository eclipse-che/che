...
public class WarningDialog {
    ...
    public void waitWaitClosingWarnDialogWindow() {
        new WebDriverWait(seleniumWebDriver, 10).until(ExpectedConditions.invisibilityOfElementLocated(By.id(Locators.WARNING_DIALOG_ID)));
    }
    ...
    public void waitWaitWarnDialogWindowWithSpecifiedTextMess(String mess) {
        new WebDriverWait(seleniumWebDriver, 15).until(ExpectedConditions.textToBePresentInElement(warningDialog, mess));
    }
