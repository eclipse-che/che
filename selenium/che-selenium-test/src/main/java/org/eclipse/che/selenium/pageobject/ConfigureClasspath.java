...
public class ConfigureClasspath {
    ...
    public static final String CONFIGURE_CLASSPATH_FORM       = "//div[text()='Configure Classpath']/ancestor::div[3]";
    public static final String CONFIGURE_CLASSPATH_CLOSE_ICON = "//div[text()='Configure Classpath']/following::div[1]";
    ...
    public static final String ITEM_SELECT_PATH_FORM          = "//div[text()='Select Path']/following::div[text()='%s']";
    ...
    public static final String SELECT_PATH_SELECT_BTN         = "//div[text()='Select Path']/ancestor::div[3]//button[text()='Select']";
    ...
    @Inject
    public ConfigureClasspath(SeleniumWebDriver seleniumWebDriver, Loader loader, ActionsFactory actionsFactory) {
    ...
    public void waitConfigureClasspathFormIsOpen() {
        ...
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.xpath(CONFIGURE_CLASSPATH_FORM)));
    }
    ...
    public void waitConfigureClasspathFormIsClosed() {
        loader.waitOnClosed();
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.invisibilityOfElementLocated(By.xpath(CONFIGURE_CLASSPATH_FORM)));
    }
    ...
    public void closeConfigureClasspathFormByIcon() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.xpath(CONFIGURE_CLASSPATH_CLOSE_ICON))).click();
    ...
    public void clickOnJavaBuildPathHeader() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.id(JAVA_BUILD_PATH))).click();
    }
    ...
    public void waitExpectedTextJavaBuildPathArea(String expText) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(
                (WebDriver driver) -> getTextFromJavaBuildPathArea().contains(expText));
    ...
    public void selectLibrariesCategory() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.id(LIBRARIES_CATEGORY))).click();
        loader.waitOnClosed();
    }
    ...
    public void clickLibraryContainer(String container) {
        WebElement element = seleniumWebDriver.findElement(By.xpath(String.format("//div[text()='%s']", container)));
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(
    ...
    public void selectSourceCategory() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.id(SOURCE_CATEGORY))).click();
        loader.waitOnClosed();
    }
    ...
    public void waitExpectedTextJarsAndFolderArea(String expText) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(
                (WebDriver driver) -> getTextFromJarsAndFolderArea().contains(expText));
     ...
     *
     * @param nameJarFolder
     *         is name of the jar or folder
     */
    public void deleteJarOrFolderFromBuildPath(String nameJarFolder) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.xpath(String.format("//div[text()='%s']", nameJarFolder))));
        WebElement element = seleniumWebDriver.findElement(By.xpath(String.format("//div[text()='%s']", nameJarFolder)));
        ...
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath(String.format(DELETE_JAR_OR_FOLDER, nameJarFolder)))).click();
    }
     ...
     *
     * @param folderType
     *         is the type of the folder
     */
    public void addJarOrFolderToBuildPath(String folderType) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.xpath(folderType))).click();
    }
    ...
    public void clickOnDoneBtnConfigureClasspath() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.id(DONE_BUTTON))).click();
        loader.waitOnClosed();
        waitConfigureClasspathFormIsClosed();
    }
    ...
    public void waitSelectPathFormIsOpen() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.xpath(SELECT_PATH_FORM)));
    }
    ...
    public void waitSelectPathFormIsClosed() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.invisibilityOfElementLocated(By.xpath(SELECT_PATH_FORM)));
    }
    ...
    public void clickOkBtnSelectPathForm() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.id(SELECT_PATH_OK_BTN))).click();
        loader.waitOnClosed();
    ...
    public void clickCancelBtnSelectPathForm() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.id(SELECT_PATH_CANCEL_BTN))).click();
        loader.waitOnClosed();
        waitSelectPathFormIsClosed();
    }
    ...
    public void clickSelectBtnSelectPathForm() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.xpath(SELECT_PATH_SELECT_BTN))).click();
        loader.waitOnClosed();
        waitSelectPathFormIsClosed();
    }
    ...
    public void waitItemInSelectPathForm(String item) {
        ...
        new WebDriverWait(seleniumWebDriver, ELEMENT_TIMEOUT_SEC).until
                (ExpectedConditions.presenceOfElementLocated(By.xpath(String.format(ITEM_SELECT_PATH_FORM, item))));
        loader.waitOnClosed();
    }
    ...
    public void selectItemInSelectPathForm(String itemName) {
        ...
        WebElement item = seleniumWebDriver.findElement(By.xpath(String.format(ITEM_SELECT_PATH_FORM, itemName)));
        item.click();
    }
