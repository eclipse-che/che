...
public class NodeJsDebugConfig extends AbstractDebugConfig {
    ...
    interface Locators {
        ...
        String NODE_JS_SCRIPT_FIELD_CSS = "div#gwt-debug-nodeJsDebugConfigurationPageView-mainPanel>input";
    }
    ...
    public void setPathToScriptForNodeJs(String pathToNodeJsFile) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(scriptNodeJsField))
                                                                                          .clear();
