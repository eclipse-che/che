...
public class GitBranches {
    ...
    private interface Locators {
        ...
        String BRANCH_NAME_WITH_CHECKOUT_IMG_XPATH = "//div[@id='gwt-debug-git-branches-%s']/parent::td/following-sibling::td/img";
    ...
    @FindBy
            (id = Locators.CREATE_BTN_ID)
    WebElement createBtn;


    @FindBy
            (id = Locators.DELETE_BTN_ID)
    WebElement deleteBtn;


    @FindBy
            (id = Locators.RENAME_BTN_ID)
    WebElement renameBtn;


    @FindBy
            (id = Locators.CLOSE_BTN_ID)
    WebElement closeBtn;


    @FindBy
            (xpath = Locators.DELBRANCH_FORM)
    WebElement delBranchForm;

    @FindBy
            (id = Locators.DELBRANCH_BUTN_OK)
    WebElement buttonOK;
    ...
    public void waitBranchesFormISIsClosed() {
        new WebDriverWait(seleniumWebDriver, 15).until(ExpectedConditions.invisibilityOfElementLocated(By.id(Locators.MAIN_FORM_ID)));
    }
    ...
    public void waitBranchWithName(String nameOfBranch) {
        new WebDriverWait(seleniumWebDriver, 5)
                .until(ExpectedConditions.visibilityOfElementLocated(By.id(String.format(Locators.BRANCH_NAME_IN_LIST_PREFIX,
                                                                                         nameOfBranch))));
    }

    public void disappearBranchName(String nameOfBranch) {
        new WebDriverWait(seleniumWebDriver, 5)
                .until(ExpectedConditions.invisibilityOfElementLocated(By.id(String.format(Locators.BRANCH_NAME_IN_LIST_PREFIX,
                                                                                           nameOfBranch))));
    }
    ...
    public void waitBranchWithNameCheckoutState(final String nameOfBranch) {
        new WebDriverWait(seleniumWebDriver, 10).until((WebDriver webDriver) -> {
            return seleniumWebDriver.findElement(By.xpath(String.format(Locators.BRANCH_NAME_WITH_CHECKOUT_IMG_XPATH, nameOfBranch)))
                      .getAttribute("src").contains(Locators.CHECKOUT_IMG_BASE64);
        });
    }
    ...
    /**
     * select given branch
     * check enabled or not button delete
     *
     * @param nameOfBranch
     *         is name of branch
     */
    public void selectBranchInListAndCheckEnabledButtonDelete(final String nameOfBranch) {
        new WebDriverWait(seleniumWebDriver, 10).until(new ExpectedCondition<Boolean>() {
            @Override
            public Boolean apply(WebDriver webDriver) {
                seleniumWebDriver.findElement(By.id(String.format(Locators.BRANCH_NAME_IN_LIST_PREFIX, nameOfBranch))).click();
    ...
    /**
     * select given branch
     * check enabled or not button rename
     *
     * @param nameOfBranch
     *         is name of branch
     */
    public void selectBranchInListAndCheckEnabledButtonRename(final String nameOfBranch) {
        new WebDriverWait(seleniumWebDriver, 15).until(new ExpectedCondition<Boolean>() {
            @Override
            public Boolean apply(WebDriver webDriver) {
                seleniumWebDriver.findElement(By.id(String.format(Locators.BRANCH_NAME_IN_LIST_PREFIX, nameOfBranch))).click();
    ...
    /**
     * select given branch
     * check enabled or not button checkout
     *
     * @param nameOfBranch
     *         is name of branch
     */
    ...
    public void closeDelBranch() {
        new WebDriverWait(seleniumWebDriver, 3).until(ExpectedConditions.invisibilityOfElementLocated
                (By.xpath(Locators.DELBRANCH_FORM)));
    }
