...
public class SvnExport {
    ...
    public void waitMainFormOpened() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(mainFormExport));
    }
    ...
    public void clickExportBtn() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.elementToBeClickable(buttonExport));
        buttonExport.click();
    }
