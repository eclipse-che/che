...
@Singleton
public class MultiUserCheTestWorkspaceUrlResolver implements TestWorkspaceUrlResolver {

  private final TestIdeUrlProvider testIdeUrlProvider;

  public MultiUserCheTestWorkspaceUrlResolver(TestIdeUrlProvider testIdeUrlProvider) {
