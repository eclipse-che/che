...
public class Wizard {
    ...
    public void setVersionOnWizard(String version) {
        ...
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC)
                .until(ExpectedConditions.presenceOfElementLocated(By.xpath(Locators.VERSION_INPUT))).sendKeys(version);
    }
    ...
    public void setArtifactIdOnWizard(String artifactId) {
        ...
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC)
                .until(ExpectedConditions.presenceOfElementLocated(By.xpath(Locators.ARTIFACT_ID_INPUT))).sendKeys(artifactId);
    }
    ...
    public void setGroupIdOnWizard(String groupId) {
        ...
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC)
                .until(ExpectedConditions.presenceOfElementLocated(By.xpath(Locators.GROUP_ID_INPUT))).sendKeys(groupId);
    }
    ...
    public void waitCreateProjectWizardFormIsClosed() {
        new WebDriverWait(seleniumWebDriver, 20).until(ExpectedConditions.invisibilityOfElementLocated(By.id(Locators.CREATE_PROJECT_WIZARD)));
    }
    ...
    public void waitSample(String sample) {
        new WebDriverWait(seleniumWebDriver, 30)
                .until(ExpectedConditions
                               .visibilityOfElementLocated(By.xpath(String.format(Locators.SAMPLES_SELECTOR_BY_FORMAT_STRING, sample))));
    }
    ...
    public void selectSample(String sample) {
        waitSample(sample);
        loader.waitOnClosed();
        seleniumWebDriver.findElement(By.xpath(String.format(Locators.SAMPLES_SELECTOR_BY_FORMAT_STRING, sample))).click();
    }
     ...
     *
     * @param projectName
     *         is expected text from the project 'Name' input
     */
    ...
    public void typeProjectNameOnWizard(String projectName) {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(projectNameInput)).clear();
        waitProjectNameOnWizard();
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(projectNameInput))
    ...
    public void clickCreateButton() {
        loader.waitOnClosed();
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.elementToBeClickable(saveCreateBtn));
        saveCreateBtn.click();
        loader.waitOnClosed();
    }
    ...
    /**
     * wait main form Project Configuration when importing
     * project from remote repo
     */
    ...
    public void waitCloseProjectConfigForm() {
        new WebDriverWait(seleniumWebDriver, 30).until(ExpectedConditions.invisibilityOfElementLocated(By.id(Locators.MAIN_FORM_ID)));
    }
    ...
    public void waitParentDirectoryInputOnWizard() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(parentDirectoryInput));
    }
     ...
     *
     * @param nameDirectory
     *         is expected text from the 'Parent Directory' input
     */
    ...
    public void clickNextButton() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.elementToBeClickable(nextButton)).click();
    ...
    public void clickBrowseButton(String typeFolder) {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.elementToBeClickable(
                By.xpath(String.format(Locators.FOLDER_BROWSE_BUTTON_XPATH, typeFolder)))).click();
    }
    ...
    public void waitExpTextInSourceFolder(String expText, String typeFolder) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(
                ExpectedConditions.visibilityOfElementLocated(By.xpath(String.format(Locators.FOLDER_PATH_FIELD_XPATH, typeFolder))));
        WebElement fieldFolder = seleniumWebDriver.findElement(By.xpath(String.format(Locators.FOLDER_PATH_FIELD_XPATH, typeFolder)));
    ...
    public void selectPackagingType(PackagingMavenType mavenType) {
        ...
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath(Locators.SELECT_PACKAGING_DROPDOWN))).click();
    ...
    /**
     * create a project from existed samples in the wizard widget, type name of project field and click on the create button
     *
    ...
    public void clickOnSelectPathForParentBtn() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.elementToBeClickable(
                By.xpath(Locators.SELECT_PATH_FOR_PARENT_BTN))).click();
    }
    ...
    public void waitExpectedPackaging(PackagingMavenType mavenType) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC)
                .until(ExpectedConditions.textToBe(By.xpath(Locators.SELECT_PACKAGING_DROPDOWN), mavenType.toString()));
    }
    ...
    public void waitArcheTypeDropdawn() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(archetypeDropDown));
    }
    ...
    public void selectArcheTypeFromList(Archetypes type) {
        ...
        WebElement item = new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(
