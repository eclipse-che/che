...
public class CreateMachineWidget {
    ...
    @FindBy
            (xpath = Locators.MAIN_FORM_XPATH)
    WebElement mainForm;


    @FindBy
            (id = Locators.NAME_FIELD_ID)
    WebElement nameOfMashineField;


    @FindBy
            (id = Locators.RECIPE_FIELD_ID)
    WebElement recipeUrlOfMashine;


    @FindBy
            (id = Locators.FIND_BY_TAG_ID)
    ...
    @FindBy
            (id = Locators.REPLACE_DEV_MASHINE_ID)
    WebElement replaceBtn;


    @FindBy
            (id = Locators.CANCEL_ID)
    ...
    public void typeNameOfMachine(String nameOfMachine) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(nameOfMashineField))
                                                                       .sendKeys(nameOfMachine);
        new WebDriverWait(seleniumWebDriver, MINIMUM_SEC).until((WebDriver input) -> {
    ...
    public void typeFindByTags(String tagName, boolean withClearing) {
        WebElement currentElem = new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC)
    ...
    public void clickCreateBTn() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(createBtn)).click();
    }
     ...
     *
     * @param dockerImg
     *         the docker image into drop dawn
     */
    public void selectDockerImgFromDropDawn(String dockerImg) {
        String locator = "//div[@class='gwt-PopupPanel']//td[text()='" + dockerImg + "']";
        WebElement dropdownItem = new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC)
