...
public class Subversion {
    ...
    @Inject
    public Subversion(SvnStatusBar svnStatusBar,
    ...
    public String getLatestRevisionSvnLog() throws Exception {
        menu.runCommand(TestMenuCommandsConstants.Subversion.SUBVERSION, TestMenuCommandsConstants.Subversion.SVN_VIEW_LOG);
        loader.waitOnClosed();
     ...
     *
     * @param path
     *         path to item in project file tree
     */
     ...
     * type url and name of importing project
     ...
     * @param user
     *         is the user name into 'User Name' field
     * @param password
     *         is the password into 'Password' field
     */
    public void waitAndTypeImporterAsSvnInfo(String uri, String nameOfProject, String user, String password) throws InterruptedException {
