...
public class CreateWorkspace {
    ...
    private interface Locators {
        ...
        String SELECT_QUICK_START_STACKS_TAB    = "//che-toggle-joined-button[@che-title =  'Quick Start']";
        String SELECT_SINGLE_MACHINE_STACKS_TAB = "//che-toggle-joined-button[@che-title =  'Single Machine']";
        String SELECT_MULTI_MACHINE_STACKS_TAB  = "//che-toggle-joined-button[@che-title =  'Multi Machine']";
    }

    @FindBy
            (id = Locators.TOOLBAR_TITLE_ID)
    WebElement toolbarTitle;

    @FindBy
            (xpath = Locators.WORKSPACE_NAME_INPUT)
    WebElement workspaceNameInput;

    @FindBy
            (xpath = Locators.CREATE_BUTTON)
    WebElement createWorkspaceButton;

    @FindBy
            (xpath = Locators.SEARCH_INPUT)
    WebElement searchInput;

    @FindBy
            (xpath = Locators.SELECT_ALL_STACKS_TAB)
    WebElement selectAllStacksTab;

    @FindBy
            (xpath = Locators.SELECT_QUICK_START_STACKS_TAB)
    WebElement selectQuickStartStacksTab;

    @FindBy
            (xpath = Locators.SELECT_SINGLE_MACHINE_STACKS_TAB)
    WebElement selectSingleMachineStacksTab;

    @FindBy
            (xpath = Locators.SELECT_MULTI_MACHINE_STACKS_TAB)
    ...
    public void waitToolbar() {
        new WebDriverWait(seleniumWebDriver, TestTimeoutsConstants.LOADER_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.id(Locators.TOOLBAR_TITLE_ID)));
    }
    ...
    public void selectStack(String stackId) {
        WebElement stack = seleniumWebDriver.findElement(By.xpath(String.format(Locators.STACK_ROW_XPATH, stackId)));
    ...
    public void typeWorkspaceName(String name) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOf(workspaceNameInput));
    ...
    public void setMachineRAM(String machine, String value) {
        WebElement ramInput = seleniumWebDriver.findElement(By.id(String.format(Locators.MACHINE_RAM_ID, machine)));
        ramInput.clear();
        ramInput.sendKeys(value);
    }
    ...
    public void clickAllStacksTab() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOf(selectAllStacksTab)).click();
    }

    public void clickQuickStartTab() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOf(selectQuickStartStacksTab)).click();
    }

    public void clickSingleMachineTab() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOf(selectSingleMachineStacksTab)).click();
    }

    public void clickMultiMachineTab() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOf(selectMultiMachineStacksTab)).click();
    }
}
