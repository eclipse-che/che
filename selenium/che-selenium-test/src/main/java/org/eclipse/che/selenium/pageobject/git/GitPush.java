...
public class GitPush {
    ...
    public void waitFormToClose() {
        new WebDriverWait(seleniumWebDriver, 7).until(ExpectedConditions.invisibilityOfElementLocated(By.id(Locators.PUSH_FORM)));
    }
    ...
    public void selectForcePushCheckBox() {
        ...
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC)
                .until(ExpectedConditions.elementToBeSelected(By.id(Locators.FORCE_PUSH_CHECKBOX + "-input")));
    }
    ...
    public void waitPushBtnIsDisabled() {
        new WebDriverWait(seleniumWebDriver, 7).until(ExpectedConditions.not(ExpectedConditions.elementToBeClickable(pushBtn)));
    }
    ...
    /**
     * click on remote repository
     * wait the list of names remote repositories
     *
     * @param listNames
     *         is list of names remote repositories
     */
