...
public class ToastLoader {
    ...
    @FindBy
            (css = Locators.MAIN_FORM_CSS)
    WebElement mainForm;

    @FindBy
            (css = Locators.START_BUTTON)
    WebElement startBtn;
    ...
    public void waitToastLoaderIsOpen() {
        new WebDriverWait(seleniumWebDriver, ELEMENT_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(mainForm));
    }
    ...
    public void waitAppeareanceAndClosing(int userTimeout) {
        ...
        new WebDriverWait(seleniumWebDriver, userTimeout).until(new ExpectedCondition<Boolean>() {
            @Override
            public Boolean apply(WebDriver driver) {
                try {
                    return getTextFromToastLoader().isEmpty();
    ...
    public String getTextFromToastLoader() {
        return new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(mainForm))
                                                                                                 .getText();
    }
    ...
    public void waitStartButtonInToastLoader() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(startBtn));
    }
