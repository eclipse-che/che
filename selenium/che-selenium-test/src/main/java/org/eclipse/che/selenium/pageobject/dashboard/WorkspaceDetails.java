...
public class WorkspaceDetails {
  ...
  public void clickOnDeleteItInDialogWindow() {
    ...
    new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC)
        .until(elementToBeClickable(deleteItBtn))
        .click();
  }
  ...
  public void clickOnCloseDialogButton() {
    new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC)
        .until(visibilityOfElementLocated(By.xpath(Locators.CLOSE_DIALOG_BUTTON)))
        .click();
  }
  ...
  public void clickOnDeleteDialogButton() {
    new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC)
        .until(visibilityOfElementLocated(By.xpath(Locators.DELETE_DIALOG_BUTTON)))
        .click();
  }
