...
public class CommandsEditor extends CodenvyEditor {
    ...
    private static final class CommandsLocators {
        ...
        static final String DROP_DOWN_GOAL_ICON =
                ACTIVE_EDITOR_ENTRY_POINT + "//div[@id='gwt-debug-command_editor-goal']//following::*[local-name()='svg']";
    ...
    public void waitTabCommandWithUnsavedStatus(String nameCommand) {
        elemDriverWait.until(visibilityOfElementLocated(By.xpath(String.format(Locators.ACTIVE_TAB_FILE_NAME, "* " + nameCommand))));
    }
    ...
    public void waitTextIntoNameCommandField(String expText) {
        redrawWait.until((ExpectedCondition<Boolean>)webDriver -> nameCommandField.getAttribute("value").equals(expText));
    }

    public void waitTextIntoGoalField(String expText) {
        redrawWait.until((ExpectedCondition<Boolean>)webDriver -> nameGoalField.getText().equals(expText));
    }
    ...
    public void selectGoalNameIntoCommandEditor(String goalName) {
        ...
        redrawWait.until(visibilityOfElementLocated
                                 (By.xpath(String.format(CommandsLocators.NAME_IN_GOAL_DROP_DOWN, goalName)))).click();
    }
