...
public class RecentFiles {
    ...
    public void waitItemIsPresent(String nameItem) {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC)
                .until(ExpectedConditions.visibilityOfElementLocated(By.xpath(format(Locators.RECENT_FILES_ITEM, nameItem))));
    }
    ...
    public void waitItemIsNotPresent(String nameItem) {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC)
                .until(ExpectedConditions.invisibilityOfElementLocated(By.xpath(format(Locators.RECENT_FILES_ITEM, nameItem))));
    }
    ...
    public void openItemByName(String nameItem) {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC)
                .until(ExpectedConditions.visibilityOfElementLocated(By.xpath(format(Locators.RECENT_FILES_ITEM, nameItem)))).click();
