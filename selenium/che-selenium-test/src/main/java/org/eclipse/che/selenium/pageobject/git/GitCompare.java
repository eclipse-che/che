...
public class GitCompare {
    ...
    @Inject
    public GitCompare(SeleniumWebDriver seleniumWebDriver, Loader loader, ActionsFactory actionsFactory) {
    ...
    private interface Locators {
        ...
        String REVISION_ITEM            = "//div[@id='gwt-debug-git-compare-revision-window']//tr[@__gwt_row='%s']";
        ...
        String PATH_TO_FILE_COMPARE     = "//div[@id='gwt-debug-git-compare-changed_files']//div[text()='%s']";
        String GROUP_COMPARE_TEXT_AREA  = "gwt-debug-git-compare-changed_files";
        String GROUP_COMPARE_CLOSE_BTN  = "git-compare-btn-close";
        String GROUP_GIT_COMPARE_BTN    = "git-compare-btn-compare";
    }

    @FindBy
            (id = Locators.COMPARE_BRANCH_FORM)
    WebElement compareBranchForm;

    @FindBy
            (id = Locators.BRANCH_COMPARE_BUTTON)
    WebElement gitCompareBranchBtn;

    @FindBy
            (id = Locators.COMPARE_BRANCH_CLOSE_BTN)
    WebElement gitCompareBranchCloseBtn;

    @FindBy
            (xpath = Locators.MAIN_FORM_COMPARE)
    WebElement mainFormCompare;

    @FindBy
            (id = Locators.LEFT_COMPARE_EDITOR)
    WebElement leftCompareEditor;

    @FindBy
            (id = Locators.RIGHT_COMPARE_EDITOR)
    WebElement rightCompareEditor;

    @FindBy
            (id = Locators.COMPARE_CLOSE_BUTTON)
    WebElement compareCloseBtn;

    @FindBy
            (id = Locators.COMPARE_REVISION_FORM)
    WebElement compareRevisionForm;

    @FindBy
            (id = Locators.REVISION_COMPARE_BUTTON)
    WebElement compareRevisionBtn;

    @FindBy
            (id = Locators.REVISION_CLOSE_BUTTON)
    ...
    public void waitGitCompareFormIsOpen() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(mainFormCompare));
    }
    ...
    public void toSwitchFrameGitCompareForm() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until
                (ExpectedConditions.frameToBeAvailableAndSwitchToIt(By.xpath("//iframe[contains(@src, 'app//Compare.html')]")));
    }
    ...
    public void waitExpectedTextIntoLeftEditor(String expText) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                ((ExpectedCondition<Boolean>)webDriver -> getTextFromLeftEditorCompare().contains(expText));
    }
    ...
    public void waitTextNotPresentIntoRightEditor(String expText) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                ((ExpectedCondition<Boolean>)webDriver -> !(getTextFromRightEditorCompare().contains(expText)));
    }
     ...
     *
     * @param status
     *         is expected line and column position. For example: 'Line 2 : Column 1'
     */
    public void waitLineAndColumnInLeftCompare(String status) {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until
                (ExpectedConditions.presenceOfElementLocated(By.xpath(String.format(Locators.LEFT_COMPARE_STATUS, status))));
    ...
    public void setCursorToLine(int positionLine, String status) {
        ...
        Alert alert =
                new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.alertIsPresent());
    ...
    public void clickOnCompareCloseButton() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOf(compareCloseBtn)).click();
    }
    ...
    public void waitCompareBranchIsOpen() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(compareBranchForm));
    }
    ...
    public void selectBranchIntoCompareBranchForm(String branchName) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.id(Locators.ID_PREFIX_BRANCH + branchName))).click();
    }
    ...
    public void clickOnBranchCompareButton() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.elementToBeClickable(gitCompareBranchBtn)).click();
    }
    ...
    public void waitCompareRevisionIsOpen() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(compareRevisionForm));
    }
    ...
    public void selectRevisionIntoCompareRevisionForm(int revision) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOfElementLocated
                (By.xpath(String.format(Locators.REVISION_ITEM, Integer.toString(revision))))).click();
    ...
    public void clickOnRevisionCompareButton() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.elementToBeClickable(compareRevisionBtn)).click();
    }
    ...
    public void clickOnCloseRevisionButton() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.elementToBeClickable(closeRevisionBtn)).click();
    }
    ...
    public void waitGroupGitCompareIsOpen() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(
                ExpectedConditions.visibilityOfElementLocated(By.xpath(Locators.GROUP_GIT_COMPARE_FORM)));
    }
    ...
    public void waitGroupGitCompareIsClosed() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until
                (ExpectedConditions.invisibilityOfElementLocated(By.xpath(Locators.GROUP_GIT_COMPARE_FORM)));
    }
    ...
    public void waitExpTextInGroupGitCompare(String expText) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(
                (WebDriver driver) -> getTextFromGroupGitCompare().contains(expText));
    }
    ...
    public String getTextFromGroupGitCompare() {
        return new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.id(Locators.GROUP_COMPARE_TEXT_AREA))).getText();
    }
    ...
    public void selectChangedFile(String name) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOfElementLocated
                (By.xpath(String.format(Locators.PATH_TO_FILE_COMPARE, name)))).click();
    ...
    public void clickOnGroupCompareButton() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.id(Locators.GROUP_GIT_COMPARE_BTN))).click();
    ...
    public void clickOnGroupCloseButton() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.id(Locators.GROUP_COMPARE_CLOSE_BTN))).click();
    }
}
