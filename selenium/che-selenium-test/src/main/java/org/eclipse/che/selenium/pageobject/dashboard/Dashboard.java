...
public class Dashboard {
    ...
    @Inject
    public Dashboard(SeleniumWebDriver seleniumWebDriver,
    ...
    public void waitDashboardToolbarTitle() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(dashboardTitle));
    }
    ...
    public void selectWorkspacesItemOnDashboard() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOf(workspacesItem)).click();
    }
    ...
    public void selectDashboardItemOnDashboard() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOf(dashboardItem)).click();
    }
    ...
    public void selectFactoriesOnDashbord() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOf(factoriesItem)).click();
    }
    ...
    public void waitNotificationMessage(String notification) {
        new WebDriverWait(seleniumWebDriver, LOADER_TIMEOUT_SEC).until(
                ExpectedConditions.textToBePresentInElement(notificationPopUp, notification));
    }
    ...
    public void waitNotificationIsClosed() {
        ...
        new WebDriverWait(seleniumWebDriver, ELEMENT_TIMEOUT_SEC).until(
                ExpectedConditions.invisibilityOfElementLocated(By.id(Locators.NOTIFICATION_CONTAINER)));
    }
    ...
    public void waitNotificationIsOpen() {
        new WebDriverWait(seleniumWebDriver, ELEMENT_TIMEOUT_SEC).until(
                ExpectedConditions.visibilityOf(notificationPopUp));
    }
    ...
    public void waitDeveloperFaceImg() {
        new WebDriverWait(seleniumWebDriver, EXPECTED_MESS_IN_CONSOLE_SEC).until
                (ExpectedConditions.visibilityOf(developersFace));
    }
    ...
    public void checkUserName(String userName) {
        new WebDriverWait(seleniumWebDriver, EXPECTED_MESS_IN_CONSOLE_SEC)
                .until(ExpectedConditions.presenceOfElementLocated(By.xpath(String.format(Locators.USER_NAME, userName))));
    }

    /**
     * Get text of nag message which displays at the top of Dashboard, or throw an exception if nag message doesn't appear in some time.
     */
