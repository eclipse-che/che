...
public class NotificationsPopupPanel {
    ...
    private static final String CLOSE_POPUP_IMG_XPATH   = "//div[@id='gwt-debug-popup-container']/descendant::*[local-name()='svg'][2]";
    ...
    public void waitProgressBarControl() {
        new WebDriverWait(seleniumWebDriver, EXPECTED_MESS_IN_CONSOLE_SEC).until(ExpectedConditions.visibilityOf(progressPopupPanel));
    }
    ...
    public void waitProgressBarControl(int userTimeout) {
        new WebDriverWait(seleniumWebDriver, userTimeout).until(ExpectedConditions.visibilityOf(progressPopupPanel));
    }
    ...
    public void waitProgressPopupPanelClose() {
        new WebDriverWait(seleniumWebDriver, EXPECTED_MESS_IN_CONSOLE_SEC).until(ExpectedConditions.invisibilityOfElementLocated(
                By.xpath(PROGRESS_POPUP_PANEL_ID)));
    }
    ...
    public void waitProgressPopupPanelClose(int userTimeout) {
        new WebDriverWait(seleniumWebDriver, userTimeout).until(ExpectedConditions.invisibilityOfElementLocated(
                By.xpath(PROGRESS_POPUP_PANEL_ID)));
    }
    ...
    public void waitExpectedMessageOnProgressPanelAndClosed(final String message) {
        new WebDriverWait(seleniumWebDriver, LOADER_TIMEOUT_SEC).until((ExpectedCondition<Boolean>)
                                                                      input -> getAllMessagesFromProgressPopupPanel()
                                                                              .contains(message));
    ...
    public void waitExpectedMessageOnProgressPanelAndClosed(final String message, final int timeout) {
        try {
            new WebDriverWait(seleniumWebDriver, timeout).until((ExpectedCondition<Boolean>)
            ...
            new WebDriverWait(seleniumWebDriver, timeout).until(ExpectedConditions.textToBePresentInElement(progressPopupPanel, message));
        }
