...
public class AskDialog {
    ...
    public static final String ASK_DIALOG_FORM_XPATH = "//button[@id='ask-dialog-ok']/ancestor::div[3]";
    public static final String WARNING_TEXT_XPATH    = "//button[@id='ask-dialog-ok']/ancestor::div[3]//span";
    ...
    public void containsText(final String expectedText) {
        ...
        new WebDriverWait(seleniumWebDriver, 7).until((ExpectedCondition<Boolean>)
                                                         webDriver -> warning_Text.getText().contains(expectedText));
    }

    /**
     * wait dialog contains expected text
     * click on ok button and wait closing form
     *
     * @param expectedText
     *         expected text in widget
     */
    ...
    /**
     * wait dialog contains expected text
     * click on cancel button and wait closing form
     *
     * @param expectedText
     *         expected text in widget
     */
