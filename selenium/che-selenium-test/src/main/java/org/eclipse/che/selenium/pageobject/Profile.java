...
public class Profile {
    ...
    public enum Field {
        FirstName("firstName"), LastName("lastName"), Company("employer");
    ...
    public enum Role {
        Developer("Developer"), Frilanse("Freelance");
    ...
    public enum Country {
        Ukraine("Ukraine"), UnitedStates("United States");
    ...
    public boolean isGetStartedButtonPresent() {
        try {
            new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(getStartedButton));
            return true;
        } catch (TimeoutException e) {
            return false;
        }
    ...
    public void clickOnGetStarted() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(getStartedButton)).click();
    }
    ...
    public void selectRole(Role role) {
        Select select =
                new Select(new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(roleSelect)));
    ...
    public void selectCountry(Country country) {
        Select select = new Select(
                new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(countySelect)));
