...
public class GitStatusBar {
    ...
    interface Locators {
        ...
        String GIT_STATUS_BAR_MINIMIZE_BTN  = "(//div[text()='Processes'])[position()=2]/following::div[3]";
    }

    @FindBy
            (id = Locators.GIT_STATUS_BAR_TAB_ID)
    WebElement statusBarTab;

    @FindBy
            (xpath = Locators.GIT_STATUS_BAR_INFO_PANEL)
    WebElement gitStatusBarInfoPanel;

    @FindBy
            (xpath = Locators.GIT_STATUS_BAR_NAVIGATE_BTN)
    WebElement gitStatusBarNaviBtn;

    @FindBy
            (xpath = Locators.GIT_STATUS_BAR_REMOVE_BUTTON)
    WebElement gitStatusBarRemoveBtn;

    @FindBy
            (xpath = Locators.GIT_STATUS_BAR_MINIMIZE_BTN)
    ...
    public void waitGitStatusBarOpenedTab() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(statusBarTab));
    }
    ...
    public void waitGitStatusBarInfoPanel() {
        new WebDriverWait(seleniumWebDriver, 10).until(ExpectedConditions.visibilityOf(gitStatusBarInfoPanel));
    }
    ...
    public void waitGitStatusBarPanelIsClosed() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(
                ExpectedConditions.invisibilityOfElementLocated(By.id(Locators.GIT_STATUS_BAR_INFO_PANEL)));
    }
    ...
    public void clickOnStatusBarMinimizeBtn() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(
                ExpectedConditions.visibilityOf(gitStatusBarMinimizeBtn)).click();
    }
}
