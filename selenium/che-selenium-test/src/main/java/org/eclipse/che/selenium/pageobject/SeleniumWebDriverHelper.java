...
public class SeleniumWebDriverHelper {
  ...
  /**
   * Waits during {@code timeout} until specified {@code element} is contain the defined {@code
   * expectedText}.
   *
   * <p>Note! The text extracts by {@link WebElement#getAttribute(String)} method.
   *
  ...
  /**
   * Waits until specified {@code element} is contain the defined {@code expectedText}.
   *
   * <p>Note! The text extracts by {@link WebElement#getAttribute(String)} method.
   *
   * @param element element which should be checked
   ...
   * is contain the specified {@code expectedText}.
   *
   * <p>Note! The text extracts by {@link WebElement#getAttribute(String)} method.
   *
  ...
  /**
   * Waits until {@link WebElement} which defined by {@code elementLocator} is contain the specified
   * {@code expectedText}.
   *
   * <p>Note! The text extracts by {@link WebElement#getAttribute(String)} method.
   *
  ...
  /**
   * Waits during {@code timeout} until specified {@code element} is contain the specified {@code
   * expectedText}.
   *
   * <p>Note! Text extracts by {@link WebElement#getText()} method.
   *
   * @param element element which should be checked
   * @param expectedText text which should be presented
   * @param timeout waiting time in seconds
  ...
  /**
   * Waits until specified {@code element} is contain the specified {@code expectedText}.
   *
   * <p>Note! Text extracts by {@link WebElement#getText()} method.
   *
   * @param element element which should be checked
