...
public class SearchReplacePanel {
    ...
    @Inject
    public SearchReplacePanel(SeleniumWebDriver seleniumWebDriver, ActionsFactory actionsFactory, CodenvyEditor editor) {
    ...
    public void closeSearchReplacePanel() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(closeBtn)).click();
    ...
    public void waitSearchReplacePanel() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(searchReplacePanel));
    }
    ...
    public void enterTextInFindInput(String text) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(findInput))
                                                                       .clear();
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(findInput))
                                                                       .sendKeys(text);
    }
    ...
    public void enterTextInReplaceInput(String text) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(replaceInput))
                                                                       .clear();
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(replaceInput))
                                                                       .sendKeys(text);
    }
    ...
    public void clickOnNextBtn() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(nextBtn)).click();
    ...
    public void clickOnPreviousBtn() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(previousBtn))
                                                                       .click();
    }
    ...
    public void clickOnToggleCaseBtn() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(toggleCaseBtn))
                                                                       .click();
    }
    ...
    public void clickOnToggleWholeBtn() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(toggleWholeBtn))
                                                                       .click();
    }
    ...
    public void clickOnReplaceBtn() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(replaceBtn))
                                                                       .click();
    }
    ...
    public void clickOnReplaceAllBtn() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(replaceAllBtn))
                                                                       .click();
    }
}
