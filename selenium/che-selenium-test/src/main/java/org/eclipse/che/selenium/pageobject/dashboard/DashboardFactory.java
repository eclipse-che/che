...
public class DashboardFactory {
    ...
    public enum SourcesTypes {
        ...
        GIT("Git Repository"), GITHUB("Github"), WORKSPACES("Workspace"), CONFIG_FILE("Config File"), TEMPLATE("Template");
        private String type;
    ...
    @Inject
    public DashboardFactory(SeleniumWebDriver seleniumWebDriver, Loader loader, ActionsFactory actionsFactory, Dashboard dashboard,
    ...
    public void waitFactoryItemOnNavBar() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(factoryNavBarItem));
    }
    ...
    public void waitAllFactoriesPage() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(factoryListContainer));
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(addFactoryBtn));
    }
    ...
    public void waitJsonFactoryIsNotEmpty() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(
                (WebDriver driver) -> jsonAreaEditor.getText().length() > LOAD_PAGE_TIMEOUT_SEC);
    }
    ...
    public void clickOnCreateFactoryBtn() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(createFactoryBtn))
                                                                       .click();
    }
    ...
    public void setNameFactory(String name) {
        WebElement field = new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(
                ExpectedConditions.visibilityOf(factoryNameField));
        field.clear();
        field.sendKeys(name);
    }
    ...
    public void clickOnDoneBtn() {
        scrollOnDoneButton();
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(doneBtn)).click();
    }
    ...
    public void clickNamedFactoryUrl() {
        waitFactoryUrl();
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC)
                .until(ExpectedConditions.visibilityOfElementLocated(By.partialLinkText(ideUrl + "f?name="))).click();
    }
    ...
    public void selectAction(AddAction addAction) {
        ...
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.presenceOfElementLocated(
                By.xpath(String.format(AddActionWindow.ACTION_SELECT_XPATH, addAction.actionName)))).click();
    }
    ...
    public void enterParamValue(String paramValue) {
        ...
        loader.waitOnClosed();
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC)
                .until(ExpectedConditions.presenceOfElementLocated(By.xpath(AddActionWindow.PARAM_XPATH))).sendKeys(paramValue);
        loader.waitOnClosed();
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC)
                .until(ExpectedConditions.textToBePresentInElementValue(By.xpath(AddActionWindow.PARAM_XPATH), paramValue));
    }
