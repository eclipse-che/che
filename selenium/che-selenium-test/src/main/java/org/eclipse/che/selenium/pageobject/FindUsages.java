...
public class FindUsages {
    ...
    private interface Locators {
        ...
        String FIND_USAGES_ICON_NODE        = "//div[@id='gwt-debug-findUsages-panel']//div[text()='%s']" +
                                              "/preceding::*[local-name()='svg'][2]";
        String FIND_USAGES_HIGHLIGHTED_ITEM = "//div[@id='gwt-debug-findUsages-panel']//span[contains(text(), '%s')]";

    }

    @FindBy
            (id = Locators.FIND_USAGES_INFO_PANEL)
    WebElement findPanel;

    @FindBy
            (id = Locators.FIND_USAGES_TAB)
    WebElement findTab;
    ...
    public void waitFindUsagesPanelIsOpen() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.id(Locators.FIND_USAGES_INFO_PANEL)));
    }

    /**
     * wait the 'find usages' panel is closed
     */
    public void waitFindUsegesPanelIsClosed() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.invisibilityOfElementLocated(By.id(Locators.FIND_USAGES_INFO_PANEL)));
    }
    ...
    public void waitExpectedTextInFindUsagesPanel(String expText) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until((WebDriver driver) -> {
    ...
    public void waitExpectedTextIsNotPresentInFindUsagesPanel(String expText) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(
                (WebDriver driver) -> !(getTextFromFindUsagesPanel().contains(expText)));
    }
    ...
    public void clickOnIconNodeInFindUsagesPanel(String nameNode) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.xpath(String.format(Locators.FIND_USAGES_ICON_NODE, nameNode)))).click();
    }
    ...
    public void selectNodeInFindUsagesByDoubleClick(String node) {
        WebElement findUsagesNode = new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(
                ExpectedConditions.visibilityOfElementLocated(By.xpath(String.format(Locators.FIND_USAGES_NODE, node))));
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOf(findUsagesNode));
    ...
    public void selectNodeInFindUsagesPanel(String node) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.xpath(String.format(Locators.FIND_USAGES_NODE, node)))).click();
    }
     ...
     *
     * @param numLine
     *         is the number line of usage
     */
    public void selectHighlightedItemInFindUsagesByDoubleClick(int numLine) {
        WebElement findHighlightedItem = seleniumWebDriver.findElement(By.xpath(String.format(Locators.FIND_USAGES_HIGHLIGHTED_ITEM, numLine)));
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOf(findHighlightedItem));
    ...
    public void waitSelectedElementInFindUsagesPanel(String nameElement) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions
                         .visibilityOfElementLocated(By.xpath(String.format(Locators.FIND_USAGES_HIGHLIGHTED_ITEM, nameElement))));
        final WebElement item = seleniumWebDriver.findElement(By.xpath(String.format
                (Locators.FIND_USAGES_HIGHLIGHTED_ITEM, nameElement)));
