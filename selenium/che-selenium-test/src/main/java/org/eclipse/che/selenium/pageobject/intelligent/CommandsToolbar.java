...
public class CommandsToolbar {
    ...
    private static final class Locators {
        ...
        static final String PREVIEWS                    = "//div[@id='gwt-debug-dropdown-preview_url']//*[local-name()='svg']";
    ...
    public void selectProcessFromExecDropDawnAndStop(String commandName) {
        clickOnExecDropDawn();
        appearanceWait.until(ExpectedConditions.elementToBeClickable(By.xpath(String.format(Locators.EXEC_COMMAND_SELECTOR, commandName))))
                      .click();
    }
    ...
    /**
     * click on the launch command button, hold left button of mouse, wait name of Command into dropdown list
     */
    public void clickWithHoldAndLaunchCommandFromList(String nameOfCommand) {
        ...
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath(String.format(Locators.COMMAND_DROPDAWN, nameOfCommand))))
            .click();
        action.release();
    }
     ...
     *
     * @param nameOfCommand
     *         an expected command in the dropdawn
     */
    ...
    public void clickOnExecDropDawn() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOf(executeCommandToolbar)).click();
    }
    ...
    public String getTimerValue() {
        ...
        String timerVal = wait.until(new Function<WebDriver, String>() {
    ...
    /**
     * click with holding on preview button of intelligence toolbar, wait dropdown list, select expected url
     *
     * @param urlCommand
     *         an expected url
     */
