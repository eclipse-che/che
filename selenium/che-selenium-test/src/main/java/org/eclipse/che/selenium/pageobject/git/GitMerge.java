...
public class GitMerge {
    ...
    public void waitMergeExpandRemoteBranchIconIsNotPresent() {
        new WebDriverWait(seleniumWebDriver, 7).until(ExpectedConditions.invisibilityOfElementLocated
    ...
    /**
     * click on remote branch
     * wait the list of the names remote branches
     *
     * @param listNames
     *         is the list of the names remote branches
     */
    ...
    public void waitItemInMergeList(String branchName) {
        new WebDriverWait(seleniumWebDriver, 7).until(ExpectedConditions.visibilityOfElementLocated(
    ...
    public void selectItemInMergeList(String branchName) {
        ...
        new WebDriverWait(seleniumWebDriver, 7).until(ExpectedConditions.elementToBeClickable(
                By.xpath(String.format(Locator.ITEM_IN_TREE, branchName))))
                                          .click();
    }

    public void clickCancelMergeBtn() {
        new WebDriverWait(seleniumWebDriver, 7).until(ExpectedConditions.elementToBeClickable(By.id(Locator.CANCEL_BUTTON_ID)));
        mergeCancelBtn.click();
    }

    public void clickMergeBtn() {
        new WebDriverWait(seleniumWebDriver, 7).until(ExpectedConditions.elementToBeClickable(mergeMergeBtn));
        mergeMergeBtn.click();
    }

    public void waitMergeBtnIsDisabled() {
        new WebDriverWait(seleniumWebDriver, 7).until(ExpectedConditions.not(ExpectedConditions.elementToBeClickable(mergeMergeBtn)));
    }

    public void waitMergeViewClosed() {
        new WebDriverWait(seleniumWebDriver, 7).until(ExpectedConditions.invisibilityOfElementLocated(By.id(Locator.MERGE_VIEW_ID)));
    }
}
