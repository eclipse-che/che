...
public class PullRequestPanel {
    ...
    public void selectBranch(String branchName) {
        ...
        loadPageDriverWait.until(visibilityOfElementLocated(By.xpath(String.format(PullRequestLocators.BRANCH_NAME, branchName)))).click();
    }
    ...
    public void waitStatusOk(Status status) {
        widgetDriverWait.until(visibilityOfElementLocated(By.xpath(String.format(PullRequestLocators.STATUS_OK, status.getMessage()))));
        loader.waitOnClosed();
    ...
    public void waitProjectName(String project) {
        loadPageDriverWait.until(visibilityOfElementLocated(By.xpath(String.format(PullRequestLocators.PROJECT_ITEM, project))));
    }
    ...
    public void waitBranchName(String branch) {
        loadPageDriverWait.until(visibilityOfElementLocated(By.xpath(String.format(PullRequestLocators.BRANCH_ITEM, branch))));
    }
    ...
    public void waitRepoUrl(String url) {
        loadPageDriverWait.until(visibilityOfElementLocated(By.xpath(String.format(PullRequestLocators.URL_ITEM, url))));
    }

    public void openPullRequestOnGitHub() {
        loadPageDriverWait.until(elementToBeClickable(By.xpath(PullRequestLocators.OPEN_GITHUB_BTN))).click();
    }
