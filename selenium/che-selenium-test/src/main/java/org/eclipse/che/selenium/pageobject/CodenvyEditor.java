...
public class CodenvyEditor {
    ...
    public static final class MarkersType {
        public static final String ERROR_MARKER_OVERVIEW   = "//div[@class='ruler annotations']/div[@class='annotation error']";
        public static final String WARNING_MARKER_OVERVIEW = "//div[@class='ruler annotations']/div[@class='annotation warning']";
        public static final String TASK_MARKER_OVERVIEW    = "//div[@class='ruler annotations']/div[@class='annotation task']";
        public static final String ERROR_MARKER            = "//div[@class='ruler overview']/div[@class='annotationOverview error']";
        public static final String WARNING_MARKER          = "//div[@class='ruler overview']/div[@class='annotationOverview warning']";
    ...
    @Inject
    public CodenvyEditor(SeleniumWebDriver seleniumWebDriver, Loader loader, ActionsFactory actionsFactory, AskForValueDialog askForValueDialog) {
    ...
    public static final class Locators {
        ...
        public static final String SELECTED_ITEM_IN_EDITOR             = "//div[@contenteditable='true']//span[contains(text(), '%s')]";

        public static final String ASSIST_CONTENT_CONTAINER = "//div[@class='contentassist']/following-sibling::div";
        public static final String AUTOCOMPLETE_CONTAINER   = "//div[text()='Proposals:']//following::div/ulist";
        ...
        public static final String IMPLEMENTATION_CONTAINER = "//div[contains(text(), 'Choose Implementation of %s')]/parent::div";
        public static final String IMPLEMENTATION_CONTENT   = "//div[contains(text(), 'Choose Implementation of')]/following::div";
        public static final String IMPLEMENTATIONS_ITEM     =
                "//div[contains(text(), 'Choose Implementation of')]/following::span[text()='%s']";
        public static final String PUNCTUATION_SEPARATOR    = "//span[contains(@class,'punctuation separator space')]";
        ...
        public static final String TAB_LIST_BUTTON = "//div[@id='gwt-debug-editorPartStack-tabsPanel']/div[1]/div";
        public static final String ITEM_TAB_LIST   = "//div[@class='popupContent']//div[text()='%s']/parent::div";

        public static final String NOTIFICATION_PANEL_ID                = "gwt-debug-leftNotificationGutter";
        public static final String DEBUGGER_PREFIX_XPATH                = "//div[@class[contains(., 'rulerLines')] and text()='%d']";
        public static final String DEBUGGER_BREAK_POINT_INACTIVE        = "//div[@class='breakpoint inactive' and text()='%d']";
        public static final String DEBUGGER_BREAK_POINT_ACTIVE          = "//div[@class='breakpoint active' and text()='%d']";
    ...
    public enum TabAction {
        CLOSE("contextMenu/Close"), CLOSE_ALL("contextMenu/Close All"),
        CLOSE_OTHER("contextMenu/Close Other"), CLOSE_ALL_BUT_PINNED("contextMenu/Close All But Pinned"),
        REOPEN_CLOSED_TAB("contextMenu/Reopen Closed Tab"), PIN_UNPIN_TAB("contextMenu/Pin/Unpin Tab"),
        SPLIT_VERTICALLY("contextMenu/Split Pane In Two Columns"), SPIT_HORISONTALLY("contextMenu/Split Pane In Two Rows");
    ...
    public String getVisibleTextFromEditor() {
        waitActiveEditor();
        List<WebElement> lines = elemDriverWait.until
     ...
     *
     * @param indexOfEditor
     *         index of editor that was split
     */
    public String getTextFromSplitEditor(int indexOfEditor) {
        List<WebElement> lines = seleniumWebDriver.findElements(By.xpath(Locators.ORION_ACTIVE_EDITOR_CONTAINER_XPATH));
     ...
     *         expected text
     * @param customTimeout
     *         time for waiting , that was defined by user
     */
    public void waitTextIntoEditor(final String text, final int customTimeout) {
        new WebDriverWait(seleniumWebDriver, customTimeout).until((ExpectedCondition<Boolean>)
                                                                     driver -> getVisibleTextFromEditor().contains(text));
    }
     ...
     *
     * @param numOfEditor
     *         number of the split editor
     * @param customTimeout
     *         timeout defined by user
     */
    public void waitTextInDefinedSplitEditor(int numOfEditor, final int customTimeout, String expectedText) {
        new WebDriverWait(seleniumWebDriver, customTimeout).until((ExpectedCondition<Boolean>)
    ...
    public void waitTextIntoEditor(final String text) {
        try {
            loadPageDriverWait.until((ExpectedCondition<Boolean>)driver -> getVisibleTextFromEditor().contains(text));
        } catch (Exception ex) {
            ex.printStackTrace();
            WaitUtils.sleepQuietly(REDRAW_UI_ELEMENTS_TIMEOUT_SEC);
            attachElemDriverWait.until((ExpectedCondition<Boolean>)driver -> getVisibleTextFromEditor().contains(text));
        }
        loader.waitOnClosed();
    }
    ...
    public void waitTextNotPresentIntoEditor(final String text) {
        loadPageDriverWait.until((ExpectedCondition<Boolean>)webDriver -> !(getVisibleTextFromEditor().contains(text)));
    }
    ...
    public void waitWhileFileIsClosed(String nameOfFile) {
        elemDriverWait.until(invisibilityOfElementLocated(By.xpath(String.format(Locators.TAB_FILE_NAME_XPATH, nameOfFile))));
    }

    /**
     * select tab by name, click on close icon and wait while content will be saved and orion disappear
     ...
     *
     * @param fileName
     *         name of File which must be close
     */
    public void clickOnCloseFileIcon(String fileName) {
        loadPageDriverWait.until(visibilityOfElementLocated(By.xpath(String.format(Locators.TAB_FILE_CLOSE_ICON, fileName)))).click();
    }
    ...
    public void closeAllTabs() {
        ...
        tabs = redrawDriverWait.until(visibilityOfAllElementsLocatedBy(By.xpath(Locators.ALL_TABS_XPATH)));
    ...
    public void closeAllTabsByContextMenu() {
        List<WebElement> tabs;
        tabs = redrawDriverWait.until(visibilityOfAllElementsLocatedBy(By.xpath(Locators.ALL_TABS_XPATH)));
        WebElement tab = loadPageDriverWait.until(visibilityOfElementLocated(By.xpath
                (String.format(Locators.TAB_FILE_CLOSE_ICON, tabs.get(tabs.size() - 1).getText()))));
    ...
    public void openContextMenuForTabByName(String tabName) {
        WebElement tab = redrawDriverWait.until(visibilityOfElementLocated(By.xpath(String.format(Locators.TAB_FILE_CLOSE_ICON, tabName))));
        actionsFactory.createAction(seleniumWebDriver).contextClick(tab).perform();
    ...
    /**
     * type text into orion editor
     * pause for saving on server side is not set
     *
     * @param text
     *         text to type
     */
    ...
    /**
     * type text into specific line editor. Cursor will be activated id the end of the line.
     * Line must not be empty. Not recommended to use
     *
     * @param text
     *         text to type
     */
    ...
    public void returnFocusInCurrentLine() {
        List<WebElement> lines = seleniumWebDriver.findElements(By.xpath(Locators.ACTIVE_LINE_HIGHLIGHT));
        Collections.sort(lines, (o1, o2) -> Integer.compare(o1.getLocation().getX(), o2.getLocation().getX()));
    ...
    public void setCursorToLine(int positionLine) {
        loader.waitOnClosed();
        actionsFactory.createAction(seleniumWebDriver).sendKeys(Keys.chord(Keys.CONTROL, "l")).perform();
    ...
    public void setCursorToDefinedLineAndChar(int positionLine, int positionChar) {
        ...
        askForValueDialog.waitFormToOpen();
        loader.waitOnClosed();
        askForValueDialog.typeAndWaitText(String.valueOf(positionLine) + ":" + String.valueOf(positionChar));
        loader.waitOnClosed();
        askForValueDialog.clickOkBtn();
        askForValueDialog.waitFormToClose();
        waitActiveEditor();
    ...
    public void waitAutocompleteContainerIsClosed() {
        loadPageDriverWait.until(invisibilityOfElementLocated(By.xpath(Locators.AUTOCOMPLETE_CONTAINER)));
    }
    ...
    public void waitTextIntoAutocompleteContainer(final String value) {
        elemDriverWait.until((ExpectedCondition<Boolean>)webDriver -> getAllVisibleTextFromAutocomplete().contains(value));
    }
     ...
     *
     * @param markerType
     *         is the type of the marker
     * @param position
     *         is the number position
     */
    public void waitMarkerInPosition(String markerType, int position) {
        loadPageDriverWait.until(visibilityOfElementLocated(By.xpath(String.format(markerType, position))));
    ...
    public void waitMarkerInPositionAndClick(String markerType, int position) {
        loadPageDriverWait.until(visibilityOfElementLocated(By.xpath(String.format(markerType, position)))).click();
    }
    ...
    public void waitMarkerDisappears(String markerType, int position) {
        elemDriverWait.until(invisibilityOfElementLocated(By.xpath(String.format(markerType, position))));
        expectedNumberOfActiveLine(position);
    }
     ...
     *
     * @param markerType
     *         is type of the marker
     */
    public void waitAllMarkersDisappear(String markerType) {
        loaderDriverWait.until((ExpectedCondition<Boolean>)driver -> driver.findElements(By.xpath(markerType)).size() == 0);
    }
    ...
    public void waitCodeAssistMarkers(String markerType) {
        elemDriverWait.until((ExpectedCondition<Boolean>)driver -> driver.findElements(By.xpath(markerType)).size() > 0);
    }
     ...
     *
     * @param item
     *         item in the autocomplete proposals list.
     */
    public void enterAutocompleteProposal(String item) {
        selectAutocompleteProposal(item);
        WebElement highlightEItem = autocompleteContainer.findElement(
    ...
    /**
     * select the item into autocomplete container
     * and send double click to item
     *
     * @param item
     *         item in the autocomplete proposals list.
     */
    ...
    public void selectAutocompleteProposal(String item) {
        ...
        redrawDriverWait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(locator))).click();
    }
    ...
    public void waitAnnotationCodeAssistIsClosed() {
        loaderDriverWait.until(invisibilityOfElementLocated(By.xpath(Locators.ASSIST_CONTENT_CONTAINER)));
    }
    ...
    public void waitTextIntoAnnotationAssist(final String expectedText) {
        elemDriverWait.until((ExpectedCondition<Boolean>)webDriver -> {
            List<WebElement> items = seleniumWebDriver.findElements(By.xpath(Locators.ASSIST_CONTENT_CONTAINER + "//span"));
     ...
     *
     * @param value
     *         expected text in error proposition
     */
    public void waitTextIntoFixErrorProposition(final String value) {
        elemDriverWait.until((ExpectedCondition<Boolean>)webDriver -> getAllVisibleTextFromProposition().contains(value));
    }
    ...
    /**
     * selected the first item into the 'assist proposition' container
     * and send double click to the first item
     */
    public void selectFirstItemIntoFixErrorPropByDoubleClick() {
        ...
        actionsFactory.createAction(seleniumWebDriver).doubleClick(seleniumWebDriver.findElement(By.xpath(tmpLocator))).perform();
        waitErrorPropositionPanelClosed();
    }

    /**
     * selected the first item into the 'assist proposition' container
     * and send enter key to the first item
     */
    ...
    /**
     * select the expectedItem into assist proposition container
     * and send double click to expectedItem
     *
     * @param expectedItem
     */
    ...
    public void enterTextIntoFixErrorPropByDoubleClick(String expectedItem) {
        WebElement itemForClick = seleniumWebDriver.findElement(By.xpath
                (String.format(Locators.PROPOSITION_CONTAINER + "/li/span[text()=\"%s\"]", expectedItem)));
    ...
    /**
     * click on the item into proposition container
     * and send enter key to item
     *
     * @param item
     */
    public void enterTextIntoFixErrorPropByEnter(String item) {
        attachElemDriverWait.until(visibilityOf(propositionContainer.findElement
                (By.xpath(String.format("//li//span[text()=\"%s\"]", item))))).click();
        WebElement highlightEItem = propositionContainer.findElement(
    ...
    /**
     * in Js file editor click on the item into proposition container
     * and send enter key to item
     *
     * @param item
     */
    public void enterTextIntoFixErrorPropByEnterForJsFiles(String item, String description) {
        attachElemDriverWait.until(presenceOfElementLocated(
                By.xpath(String.format("//span[text()='%s']/span[text()='%s']/ancestor::div[1]", description, item)))).click();
    }
    ...
    public void callShowHintsPopUp() {
        loader.waitOnClosed();
        actionsFactory.createAction(seleniumWebDriver).keyDown(Keys.CONTROL).sendKeys("p").keyUp(Keys.CONTROL).perform();
        loader.waitOnClosed();
    }
    ...
    public void waitExpTextIntoShowHintsPopUp(String expText) {
        loadPageDriverWait.until((ExpectedCondition<Boolean>)webDriver -> getTextFromShowHintsPopUp().contains(expText));
    }
     ...
     *
     * @param nameOfFile
     *         name of tab for checking
     */
    public void waitTabFileWithSavedStatus(String nameOfFile) {
        elemDriverWait.until(visibilityOfElementLocated(By.xpath(String.format(Locators.ACTIVE_TAB_FILE_NAME, nameOfFile))));
    }
     ...
     *
     * @param nameOfFile
     *         is specified file name
     */
    public void waitActiveTabFileName(String nameOfFile) {
        loadPageDriverWait.until(presenceOfElementLocated(By.xpath(String.format(Locators.ACTIVE_TAB_FILE_NAME, nameOfFile))));
    }
    ...
    public void waitWhileAllFilesWillClosed() {
        elemDriverWait.until(invisibilityOfElementLocated(By.xpath("//div[@id='gwt-debug-editorPartStack-tabsPanel']//div[text()]")));
        elemDriverWait.until(invisibilityOfElementLocated(By.xpath(Locators.ORION_ACTIVE_EDITOR_CONTAINER_XPATH)));
    }
     ...
     *
     * @param nameOfFile
     *         name of tab for select
     */
    public void selectTabByName(String nameOfFile) {
        redrawDriverWait.until(visibilityOfElementLocated(By.xpath(String.format(Locators.TAB_FILE_NAME_XPATH, nameOfFile)))).click();
    }
     ...
     *
     * @param nameOfFile
     *         name of appearing tab
     */
    public void waitTabIsPresent(String nameOfFile) {
        loadPageDriverWait.until(visibilityOfAllElementsLocatedBy(By.xpath(String.format(Locators.TAB_FILE_NAME_XPATH, nameOfFile))));
        loader.waitOnClosed();
    }
     ...
     *         name of appearing tab
     * @param customTimeout
     *         time  waiting of tab in editor. Set in seconds.
     */
    public void waitTabIsPresent(String nameOfFile, int customTimeout) {
        new WebDriverWait(seleniumWebDriver, customTimeout).until(visibilityOfAllElementsLocatedBy
    ...
    public void waitDebugerLineIsVisible(int line) {
        loadPageDriverWait.until(visibilityOfElementLocated(By.xpath(String.format(Locators.DEBUGGER_PREFIX_XPATH, line))));
    }
     ...
     *
     * @param position
     *         the position in the codenvy - editor
     */
    public void waitBreakPointWithInactiveState(int position) {
        redrawDriverWait.until(visibilityOfElementLocated(By.xpath(String.format(Locators.DEBUGGER_BREAK_POINT_INACTIVE, position))));
    }
    ...
    public void setBreakPointAndWaitInactiveState(int position) {
        ...
        seleniumWebDriver.findElement(By.xpath(String.format(Locators.DEBUGGER_PREFIX_XPATH, position))).click();
        waitBreakPointWithInactiveState(position);
    }

    /**
     * Set breakpoint on specified position on the IDE breakpoint panel and wait on active state of it.
     *
     * @param position
     *         position of the breakpoint
     */
    ...
    public void waitBreakPointWithActiveState(int position) {
        redrawDriverWait.until(visibilityOfElementLocated(By.xpath(String.format(Locators.DEBUGGER_BREAK_POINT_ACTIVE, position))));
    }
    ...
    public void checkTextAfterGoToLinkInJavaDocPopUp(String text, String textLink) {
        loadPageDriverWait.until(frameToBeAvailableAndSwitchToIt(By.xpath(Locators.JAVA_DOC_POPUP)));
        WebElement link = loadPageDriverWait.until(elementToBeClickable(By.xpath(String.format("//a[text()='%s']", textLink))));
     ...
     *
     * @param text
     *         is the text of elements active line
     */
    public void waitTextElementsActiveLine(final String text) {
        waitActiveEditor();
        redrawDriverWait.until(visibilityOf(activeLineXpath));
        redrawDriverWait.until((ExpectedCondition<Boolean>)driver -> activeLineXpath.getText().contains(text));
    }
    ...
    public int getNumberOfActiveLine() {
        waitActiveEditor();
        int numberLine = Integer.parseInt(redrawDriverWait.until(visibilityOf(activeLineNumber)).getText().split(":")[0]);
        return numberLine;
    }
     ...
     *
     * @param expectedLine
     *         expected number of active line
     */
    public void expectedNumberOfActiveLine(final int expectedLine) {
        waitActiveEditor();
        redrawDriverWait.until((ExpectedCondition<Boolean>)driver -> expectedLine == getNumberOfActiveLine());
    }
    ...
    public int getPositionOfLine() {
        ...
        List<WebElement> numLines = seleniumWebDriver.findElements(By.xpath(Locators.ACTIVE_LINE_NUMBER));
        int numberLine = 0;
        for (WebElement numLine : numLines) {
            if (numLine.isDisplayed()) {
                numberLine = Integer.parseInt(redrawDriverWait.until(visibilityOf(numLine)).getText().split(":")[0]);
                break;
            }
        }
        return numberLine;
    ...
    public int getPositionOfChar() {
        ...
        for (WebElement numLine : numLines) {
            if (numLine.isDisplayed()) {
                numberChar = Integer.parseInt(redrawDriverWait.until(visibilityOf(numLine)).getText().split(":")[1]);
                break;
            }
        }
        return numberChar;
     ...
     * @param charPosition
     *         expected char position
     */
    public void waitSpecifiedValueForLineAndChar(final int linePosition, final int charPosition) {
        redrawDriverWait.until(
                (ExpectedCondition<Boolean>)webDriver -> (getPositionOfLine() == linePosition) && (getPositionOfChar() == charPosition));
    }
     ...
     *
     * @param lineAndChar
     *         expected line and char position. For example: 1:25
     */
    public void waitSpecifiedValueForLineAndChar(String lineAndChar) {
        redrawDriverWait.until(visibilityOfElementLocated(By.xpath(String.format(Locators.POSITION_CURSOR_NUMBER, lineAndChar))));
    }
    ...
    public void clickOnSelectedElementInEditor(String nameElement) {
        WebElement item = seleniumWebDriver.findElement(By.xpath(String.format(Locators.SELECTED_ITEM_IN_EDITOR, nameElement)));
        item.click();
        waitActiveEditor();
    }
     ...
     *
     * @param fileName
     *         is name of the selected file
     */
    public void waitImplementationFormIsOpen(String fileName) {
        redrawDriverWait.until(visibilityOfElementLocated(By.xpath(String.format(Locators.IMPLEMENTATION_CONTAINER, fileName))));
    }
    ...
    public void waitImplementationFormIsClosed(String fileName) {
        redrawDriverWait.until(invisibilityOfElementLocated(By.xpath(String.format(Locators.IMPLEMENTATION_CONTAINER, fileName))));
    }
    ...
    public void launchImplementationFormByKeyboard() {
        loader.waitOnClosed();
        Actions action = actionsFactory.createAction(seleniumWebDriver);
        action.keyDown(Keys.CONTROL).keyDown(Keys.ALT).sendKeys("b").keyUp(Keys.ALT).keyUp(Keys.CONTROL).perform();
    }
    ...
    public void waitTextInImplementationForm(String expText) {
        redrawDriverWait.until((ExpectedCondition<Boolean>)driver -> getTextFromImplementationForm().contains(expText));
    }
    ...
    public void chooseImplementationByDoubleClick(String fileName) {
        WebElement fileImplement = seleniumWebDriver.findElement(By.xpath(String.format(Locators.IMPLEMENTATIONS_ITEM, fileName)));
    ...
    public void selectImplementationByClick(String fileName) {
        redrawDriverWait.until(visibilityOfElementLocated(By.xpath(String.format(Locators.IMPLEMENTATIONS_ITEM, fileName)))).click();
    }
    ...
    public boolean checkWhatTextLinePresentOnce(String line) {
        ...
        if (index > 0) {
            return !visibleTextFromEditor.substring(index + 1, visibleTextFromEditor.length()).contains(line);
        }
        return false;
    }
    ...
    public int getQuantityMarkers(String markerType) {
        ...
        List<WebElement> annotationList = redrawDriverWait.until(presenceOfAllElementsLocatedBy(By.xpath(markerType)));
    ...
    public void waitAllPunctuationSeparatorsArePresent() {
        redrawDriverWait.until(visibilityOfAllElementsLocatedBy(By.xpath(Locators.PUNCTUATION_SEPARATOR)));
    }
    ...
    public void clickOnDownloadSourcesLink() {
        redrawDriverWait.until(visibilityOfElementLocated(By.xpath(Locators.DOWNLOAD_SOURCES_LINK))).click();
    }
    ...
    public void changeWidthWindowForEditor(int xOffset) {
        WebElement moveElement = redrawDriverWait.until
                (visibilityOfElementLocated(By.xpath("//div[@id='gwt-debug-navPanel']/parent::div/following::div[1]")));
        actionsFactory.createAction(seleniumWebDriver).dragAndDropBy(moveElement, xOffset, 0).perform();
    }

    /**
     * Open list of  the tabs
     * Note: This possible if opened tabs don't fit in the tab bar.
     */
    ...
    public void waitTabIsPresentInTabList(String tabName) {
        redrawDriverWait.until(visibilityOfElementLocated(By.xpath(String.format(Locators.ITEM_TAB_LIST, tabName))));
    ...
    public void waitTabIsNotPresentInTabList(String tabName) {
        redrawDriverWait.until(invisibilityOfElementLocated(By.xpath(String.format(Locators.ITEM_TAB_LIST, tabName))));
    ...
    public void clickOnTabInTabList(String tabName) {
        redrawDriverWait.until(visibilityOfElementLocated(By.xpath(String.format(Locators.ITEM_TAB_LIST, tabName)))).click();
    }
     ...
     *
     * @param index
     *         index of editor window
     * @param tabName
     *         name of tab
     */
    public void selectTabByIndexEditorWindow(int index, String tabName) {
        List<WebElement> windowList = redrawDriverWait.until
                (presenceOfAllElementsLocatedBy(By.xpath(String.format(Locators.TAB_FILE_NAME_XPATH, tabName))));
    ...
    public void selectTabByIndexEditorWindowAndOpenMenu(int index, String tabName) {
        List<WebElement> windowList = redrawDriverWait.until
                (presenceOfAllElementsLocatedBy(By.xpath(String.format(Locators.TAB_FILE_CLOSE_ICON, tabName))));
    ...
    public boolean tabIsPresentOnce(String expectTab) {
        List<WebElement> windowList = redrawDriverWait.until(presenceOfAllElementsLocatedBy(By.id(Locators.EDITOR_TABS_PANEL)));
        int counter = 0;
     ...
     *
     * @param lines
     *         List of WebElements that contain text (mostly <div> tags after ORION_ACTIVE_EDITOR_CONTAINER_XPATH locator)
     ...
     *         is the selected element into editor
     */
    public void openContextMenuOnElementInEditor(String selectedElement) {
        WebElement element = loadPageDriverWait.until
                (visibilityOfElementLocated(By.xpath(String.format(Locators.SELECTED_ITEM_IN_EDITOR, selectedElement))));
        Actions act = actionsFactory.createAction(seleniumWebDriver);
        act.contextClick(element).perform();
        waitContextMenu();
    }
     ...
     *
     * @return html code of JavaDoc of already opened autocomplete proposal by making request on 'src' attribute of iframe of JavaDoc popup.
     */
