...
import org.eclipse.che.selenium.core.provider.CheTestWorkspaceAgentApiEndpoint;
...
public class CheSeleniumSuiteModule extends AbstractModule {
  ...
  public void configure() {
    ...
    bind(TestWorkspaceAgentApiEndpoint.class).to(CheTestWorkspaceAgentApiEndpoint.class);
