...
public class WorkspaceMachines {
  ...
  private interface Locators {
    ...
    String SAVE_MACHINE_NAME_BUTTON = "//che-button-primary[@che-button-title='Save']/button";
  ...
  public void clickOnSaveNameDialogButton() {
    new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC)
        .until(visibilityOfElementLocated(By.xpath(Locators.SAVE_MACHINE_NAME_BUTTON)))
        .click();
  }
}
