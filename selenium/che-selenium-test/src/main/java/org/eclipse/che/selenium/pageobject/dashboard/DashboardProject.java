...
public class DashboardProject {
    ...
    @FindBy
            (css = Locators.NAME_WORKSPACE_FIELD)
    WebElement nameOfWorkspaceField;

    @FindBy
            (css = Locators.NAME_OF_PROJECT_FIELD)
    WebElement nameOfProjectField;

    @FindBy
            (xpath = Locators.CREATE_PROJECT_BUTTON)
    WebElement createProjectButton;

    @FindBy
            (xpath = Locators.CREATE_NEW_WS)
    WebElement createWsFromStack;

    @FindBy
            (xpath = Locators.NEW_PROJECT_LINK)
    ...
    public void selectCreateNewWorkspace() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(createWsFromStack))
                                                                       .click();
    }
     ...
     *
     * @param wsName
     *         is name of the existing workspace
     */
    public void selectExistingWs(String wsName) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.xpath(Locators.EXISTING_WS_RADIO_BUTTON))).click();
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.xpath(String.format(Locators.SELECT_EXISTING_WS, wsName)))).click();
    }
     ...
     *
     * @param projectName
     *         is name of the existing template project
     */
    public void selectTemplateProject(String projectName) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.xpath(String.format(Locators.SELECT_TEMPLATE_PROJECT, projectName))))
                                                                       .click();
    }
    ...
    public void selectSource(String nameSource) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.xpath(String.format(Locators.SELECT_SOURCE_ITEM, nameSource))))
                                                                       .click();
    }
    ...
    public void clickOnNewProjectButton() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(newProject))
                                                                       .click();
    }
     ...
     *
     * @param url
     *         URL for project on git repository
     */
    public void enterGitURL(String url) {
        WebElement input = new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOf(gitUrlInput));
        input.clear();
        input.sendKeys(url);
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.textToBePresentInElementValue(gitUrlInput, url));
    }
    ...
    public void enterZipURL(String url) {
        WebElement input = new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOf(zipUrlInput));
        input.clear();
        input.sendKeys(url);
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.textToBePresentInElementValue(zipUrlInput, url));
    }
    ...
    public void selectExistingLocation(String location) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.xpath(String.format(Locators.LOCATION_TAB, location))))
                                                                       .click();
    }
    ...
    public void waitProjectIsPresent(String projectName) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.xpath(String.format(Locators.PROJECT_BY_NAME, projectName))));
    ...
    public void waitProjectIsNotPresent(String projectName) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.invisibilityOfElementLocated(By.xpath(String.format(Locators.PROJECT_BY_NAME, projectName))));
    }
    ...
    public void openSettingsForProjectByName(String projectName) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.xpath(String.format(Locators.PROJECT_BY_NAME, projectName)))).click();
    }
    ...
    public void clickOnDeleteProject() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.xpath(Locators.DELETE_PROJECT))).click();
    }
    ...
    public void clickOnDeleteItInDialogWindow() {
        ...
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.xpath(Locators.DELETE_IT_PROJECT))).click();
    }
    ...
    public void clickOnSkipRootFolder() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.xpath(Locators.SKIP_ROOT_FOLDER))).click();
    }
     ...
     *
     * @param wsName
     *         name of workspace to place the project
     * @param template
