...
public class FindText {
    ...
    private interface Locators {
        ...
        String FIND_INFO_PANEL           = "//div[@id='gwt-debug-infoPanel']//div[text()='Find']/following::div[9]";
        String FIND_TAB                  = "gwt-debug-partButton-Find";
        String HIDE_FIND_PANEL           = "//div[@id='gwt-debug-infoPanel']//div[text()='Find']/following::div[3]";
        String ITEM_FIND_PANEL           = "//div[@id='gwt-debug-infoPanel']//div[text()='Find']/following::div[9]//div[text()='%s']";
    }
