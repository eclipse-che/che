...
public abstract class AbstractDebugConfig {
    ...
    interface Locators {
        ...
        String DEBUG_CONFIG_SAVE_BTN_XPATH  = "//button[@id='window-edit-debug-configurations-save' and not(@disabled)]";
     ...
     *
     * @param configName
     *         name of configuration to remove.
     */
    ...
    void createConfigWithoutClosingDialog(String configName) {
        ...
        expandDebugCategory();
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(nameFieldOfDebugConf));
