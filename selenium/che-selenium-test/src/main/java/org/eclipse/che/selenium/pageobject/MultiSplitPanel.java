...
public class MultiSplitPanel {
    ...
    private interface Locators {
        ...
        String SPLIT_PANE_MENU_ICON       = "(//div[@id='gwt-debug-multiSplitPanel-tabsPanel']/div[1])[position()=%s]";
        String SPLIT_PANE_MENU            = "//div[@class='popupContent']";
        String SPLIT_PANE_COMMAND         = "//div[@class='popupContent']//following::div[text()='%s']";
        String PROCESS_IN_MENU_CLOSE_ICON = "//div[@class='popupContent']//following::div[text()='%s']/following-sibling::div";
        String TAB_PROCESS_NAME           = "(//div[@id='gwt-debug-multiSplitPanel-tabsPanel'])[position()=%s]//div[text()='%s']";
        String TAB_PROCESS_CLOSE_ICON     = "//div[@id='gwt-debug-multiSplitPanel-tabsPanel']//div[text()='%s']/following-sibling::div";
     ...
     *
     * @param iconPosition
     *         is a position of split pane icon;
     *         the most right and lowest open pane has position number one
     */
    public void clickOnIconMultiSplitPanel(int iconPosition) {
        ...
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.elementToBeClickable
                (By.xpath(String.format(Locators.SPLIT_PANE_MENU_ICON, iconPosition)))).click();
    }
    ...
    public void waitSplitPanelMenuIsOpen() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.xpath(Locators.SPLIT_PANE_MENU)));
    }
    ...
    public void waitSplitPanelMenuIsClosed() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.invisibilityOfElementLocated(By.xpath(Locators.SPLIT_PANE_MENU)));
    }
     ...
     *
     * @param numberPanels
     *         is a number of open split panels
     */
    ...
    public void selectSplitPanel(int numberPanel) {
        ...
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOfElementLocated
                (By.xpath(String.format(Locators.SPLIT_PANEL_AREA, numberPanel)))).click();
    }
    ...
    public void selectCommandSplitPane(String paneCommands) {
        loader.waitOnClosed();
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.elementToBeClickable
                (By.xpath(String.format(Locators.SPLIT_PANE_COMMAND, paneCommands)))).click();
    }
     ...
     *
     * @param nameProcess
     *         is name of process into the split pane widget
     */
    ...
    public void closeProcessIntoPaneMenu(String nameProcess) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.elementToBeClickable
                (By.xpath(String.format(Locators.PROCESS_IN_MENU_CLOSE_ICON, nameProcess)))).click();
    }
     ...
     *         the most right and lowest open pane has position number one
     * @param nameProcess
     *         is name of tab process for select
     */
    public void selectProcessByTabName(int numberPanel, String nameProcess) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOfElementLocated
                (By.xpath(String.format(Locators.TAB_PROCESS_NAME, numberPanel, nameProcess)))).click();
    }
     ...
     *
     * @param nameProcess
     *         is name tab name of process
     */
    public void closeProcessByTabName(String nameProcess) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.elementToBeClickable
                (By.xpath(String.format(Locators.TAB_PROCESS_CLOSE_ICON, nameProcess)))).click();
    }
    ...
    public String getMessFromSplitGitPanel(int numberPanel) {
        return new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.elementToBeClickable
                (By.xpath(String.format(Locators.GIT_INFO_PANEL, numberPanel)))).getText();
    }
}
