...
public class MachineInformationTab {
    ...
    @FindBy
            (xpath = Locators.INFORMATION_TAB_XPATH)
    ...
    public void waitInformationTab() {
        new WebDriverWait(seleniumWebDriver, LOADER_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(informationTab));
    }
    ...
    public void waitTextIntoInfoTab(String expectedText) {
        ...
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.textToBePresentInElementLocated(
