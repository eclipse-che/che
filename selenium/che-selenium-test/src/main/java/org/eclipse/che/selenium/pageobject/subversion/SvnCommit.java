...
public class SvnCommit {
    ...
    public void waitMainFormOpened() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(mainFormCommit));
    }

    public void waitMainFormClosed() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.invisibilityOfElementLocated(By.xpath
                (Locators.COMMIT_MAIN_FORM)));
    }
    ...
    public void clickDiffButton(String fileName, String folderName) {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.elementToBeClickable(By.xpath
                (String.format(Locators.DIFF_BUTTON, fileName, folderName)))).click();
    }
    ...
    public void waitTextDiffView(final String expContent) {
        ...
        new WebDriverWait(seleniumWebDriver, ELEMENT_TIMEOUT_SEC)
                .until((ExpectedCondition<Boolean>)webDriver -> seleniumWebDriver.findElement(By.tagName("pre")).getText().contains(expContent));
    ...
    public void clickCommitBtn() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.elementToBeClickable(buttonCommit));
        buttonCommit.click();
    }

    public void clickCancelBtn() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.elementToBeClickable(buttonCancel));
        buttonCancel.click();
    }
}
