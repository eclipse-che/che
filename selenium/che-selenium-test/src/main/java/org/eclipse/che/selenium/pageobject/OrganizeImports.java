...
public class OrganizeImports {
    ...
    public void waitOrganizeImportsDialog() {
        new WebDriverWait(seleniumWebDriver, ELEMENT_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(organizeImportsDialog));
    }
    ...
    public void clickOnFinishButton() {
        new WebDriverWait(seleniumWebDriver, ELEMENT_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(finishButton)).click();
    }
    ...
    public void clickOnBackButton() {
        new WebDriverWait(seleniumWebDriver, ELEMENT_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(backButton)).click();
    }
    ...
    public void clickOnNextButton() {
        new WebDriverWait(seleniumWebDriver, ELEMENT_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(nextButton)).click();
    }
    ...
    public void selectImport(String titleOfImport) {
        new WebDriverWait(seleniumWebDriver, ELEMENT_TIMEOUT_SEC)
                .until(ExpectedConditions.visibilityOfElementLocated(By.xpath(String.format(Locators.IMPORT_FIELD, titleOfImport))))
                .click();
    }
}
