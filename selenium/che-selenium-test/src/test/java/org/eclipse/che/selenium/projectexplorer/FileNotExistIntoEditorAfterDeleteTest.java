...
public class FileNotExistIntoEditorAfterDeleteTest {
    ...
    private static final String PATH_TO_JAVA_FILE = PROJECT_NAME + "/src/main/java/org/eclipse/qa/examples/AppController.java";
    private static final String EXPECTED_TEXT_2   = "package org.eclipse.qa.examples;\n" +
                                                    "\n" +
