...
public class QuickFixAndCodeAssistantFeaturesTest {
    private static final String PROJECT_NAME     = NameGenerator.generate(QuickFixAndCodeAssistantFeaturesTest.class.getSimpleName(), 4);
    ...
    public void quickFixAndCodeAssistantTest() {
        ...
        projectExplorer
                .selectVisibleItem("AppController.java"); // TODO because the cursor disappears after click in the autocomplete panel
        projectExplorer.openItemByVisibleNameInExplorer("AppController.java");
        editor.typeTextIntoEditor(";");
