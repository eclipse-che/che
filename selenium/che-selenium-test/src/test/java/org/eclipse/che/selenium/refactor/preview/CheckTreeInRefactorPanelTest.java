...
public class CheckTreeInRefactorPanelTest {
    ...
    public void setUp() throws Exception {
        URL resource = CheckTreeInRefactorPanelTest.this.getClass().getResource("/projects/guess-project");
    ...
    public void previewChangeTest() {
        ...
        Assert.assertFalse(refactorPanel.itemIsSelectedByNameAndPosition("Update local variable reference", 0),
                           "This item in tree mustn't be selected.");
        Assert.assertFalse(refactorPanel.itemIsSelectedByNameAndPosition("Update local variable reference", 1),
                           "This item in tree mustn't be selected.");
        Assert.assertFalse(refactorPanel.itemIsSelectedByNameAndPosition("Update local variable reference", 2),
                           "This item in tree mustn't be selected.");
        Assert.assertFalse(refactorPanel.itemIsSelectedByNameAndPosition("Update local variable reference", 3),
                           "This item in tree mustn't be selected.");
    }
}
