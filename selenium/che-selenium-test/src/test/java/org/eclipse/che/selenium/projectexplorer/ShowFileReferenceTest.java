...
public class ShowFileReferenceTest {
    private static final String PROJECT_NAME    = NavigationByKeyboardTest.class.getSimpleName() + new Random().nextInt(9999);
    private static final String FILE_FQN        = "org.eclipse.qa.examples.AppController";
    private static final String FILE_PATH       = PROJECT_NAME + "/src/main/java/org/eclipse/qa/examples/AppController.java";
    ...
    public void setUp() throws Exception {
        ...
        projectExplorer.clickOnItemInContextMenu(TestProjectExplorerContextMenuConstants.SHOW_REFERENCES);
    }
