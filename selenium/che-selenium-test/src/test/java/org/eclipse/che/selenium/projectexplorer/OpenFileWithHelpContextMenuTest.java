...
public class OpenFileWithHelpContextMenuTest {
    ...
    private static final String PATH_TO_LESS        = PROJECT_NAME + "/src/main/java/org/eclipse/qa/examples/LessFile.less";
    ...
    private static final String PATH_TO_HTML        = PROJECT_NAME + "/src/main/webapp/WEB-INF/htmlFile.html";
    private static final String PATH_TO_JAVA_CLASS  = PROJECT_NAME + "/src/main/java/org/eclipse/qa/examples/AppController.java";
    private static final String PATH_TO_SIMPLE_FILE = PROJECT_NAME + "/src/main/java/org/eclipse/qa/examples/another";
    ...
    private static final String LESS_TEXT           = "@CHARSET \"UTF-8\"\n" +
                                                      ";";
    private static final String XML_TEXT            = "<!DOCTYPE web-app PUBLIC\n" +
                                                      ...
                                                      "   </servlet-mapping>\n" +
                                                      "</web-app>\n";
    private static final String HTML_TEXT           = "<!DOCTYPE html>\n" +
                                                      "<html lang=\"en\">\n" +
                                                      "<head>\n" +
                                                      "    <meta charset=\"UTF-8\">\n" +
                                                      "    <title>Title</title>\n" +
    ...
    private static final String ANOTHER_FILE_TEXT   = "testExample1\n" +
                                                      ...
                                                      "testExample10\n" +
                                                      "testExample11";
    private static final String SQL_TEXT            = "Select * From Car Where Car.id > 100 and Car.speed < 180\n" +
    ...
    public void openFileTest() throws Exception {
        ...
        openFileFromContextMenu(PATH_TO_JAVA_CLASS,
                                NAME_JAVA_CLASS,
                                APP_CONTROLLER_TEXT);

        openFileFromContextMenu(PATH_TO_JSP,
                                NAME_JSP,
                                JSP_TEXT);

        openFileFromContextMenu(PATH_TO_CSS,
                                NAME_CSS,
                                CSS_TEST);

        openFileFromContextMenu(PATH_TO_XML,
                                NAME_XML,
                                XML_TEXT);

        openFileFromContextMenu(PATH_TO_LESS,
                                NAME_LESS,
                                LESS_TEXT);

        openFileFromContextMenu(PATH_TO_HTML,
                                NAME_HTML,
                                HTML_TEXT);
        ...
        openFileFromContextMenu(PATH_TO_SQL,
                                NAME_SQL,
                                SQL_TEXT);
    }

    private void openFileFromContextMenu(String pathToFile,
                                         String fileName,
