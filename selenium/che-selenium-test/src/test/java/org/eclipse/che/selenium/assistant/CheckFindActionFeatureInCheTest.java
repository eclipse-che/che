...
public class CheckFindActionFeatureInCheTest {
    ...
    private static final String FIRST_ACTION_NAME_EXPECTED_ARRAY_LOCAL_MODE = "Configuration...  Project\n" +
                                                                              "Configure Classpath  Project\n" +
                                                                              "Content Assist  Assistant\n" +
                                                                              "Convert To Project  Project\n" +
                                                                              "Edit Debug Configurations... [Alt+Shift+F9]  Run";

    private static final String SECOND_ACTION_NAME_EXPECTED_ARRAY_LOCAL_MODE = "Commands Palette [Shift+F10]  Run\n" +
    ...
    private static final String THIRD_ACTION_NAME_EXPECTED_ARRAY_LOCAL_MODE = "Branches...  GitCommandGroup\n" +
                                                                              "Checkout Reference...  GitCommandGroup";

    private static final String FIRST_ACTION_NAME_EXPECTED_ARRAY_WITH_FLAG_LOCAL_MODE = "Update Project Configuration...  Project\n" +
                                                                                        "Configure Classpath  Project\n" +
                                                                                        "Content Assist  Assistant\n" +
                                                                                        "Convert To Project  Project\n" +
                                                                                        "Edit Debug Configurations... [Alt+Shift+F9]  Run\n" +
    ...
    private static final String SECOND_ACTION_NAME_EXPECTED_ARRAY_WITH_FLAG_LOCAL_MODE = "Commands \n" +
    ...
    private static final String THIRD_ACTION_NAME_EXPECTED_ARRAY_WITH_FLAG_LOCAL_MODE = "Branches...  GitCommandGroup\n" +
                                                                                        "Checkout Reference...  GitCommandGroup";

    private static final String PROJECT_NAME = NameGenerator.generate(CheckFindActionFeatureInCheTest.class.getSimpleName(), 4);
