...
public class SplitEditorFeatureTest {
    ...
    private static final String PROJECT_NAME      = NameGenerator.generate(SplitEditorFeatureTest.class.getSimpleName(), 4);
    private static final String PATH_TEXT_FILE    = PROJECT_NAME + "/README.md";
    private static final String PATH_JAVA_FILE    = PROJECT_NAME + "/src/main/java/org/eclipse/che/examples/GreetingController.java";
    ...
    public void checkContentAfterRenameFile() {
        ...
        editor.typeTextIntoEditor("***" + TEXT);
        editor.waitTextIntoEditor("***" + TEXT);
        editor.selectTabByIndexEditorWindow(1, NEW_NAME_TXT_FILE);
        editor.waitActiveEditor();
        editor.waitTextIntoEditor("***" + TEXT);
        editor.selectTabByIndexEditorWindow(2, NEW_NAME_TXT_FILE);
        editor.waitActiveEditor();
        editor.waitTextIntoEditor("***" + TEXT);
    }
