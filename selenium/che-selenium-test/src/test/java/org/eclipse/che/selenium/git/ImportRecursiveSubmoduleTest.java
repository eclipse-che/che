...
public class ImportRecursiveSubmoduleTest {
    ...
    public void checkImportProjectSubmoduleByHttpsUrl() throws Exception {
        ...
        importRecursivelyFromGitUrl("https://github.com/" + gitHubUsername + "/ProjectGitSubmodule.git",
                                    PROJECT_NAME);
    ...
    public void checkImportProjectSubmoduleBySshUrl() throws Exception {
        projectExplorer.waitProjectExplorer();
        importRecursivelyFromGitUrl("git@github.com:" + gitHubUsername + "/ProjectGitSubmodule.git",
                                    PROJECT_NAME);
        openSubmoduleOne(PROJECT_NAME);
        openSubmoduleTwo(PROJECT_NAME);
    }
    ...
    private void importRecursivelyFromGitHub(String projectName) throws Exception {
        ...
        loader.waitOnClosed();
        importProject.selectItemInAccountList(gitHubClientService.getName(gitHubUsername, gitHubPassword));
    ...
    private void openSubmoduleOne(String projectName) throws Exception {
        ...
        menu.runCommand(TestMenuCommandsConstants.Project.PROJECT, TestMenuCommandsConstants.Project.CONVERT_TO_PROJECT);
        ...
        projectExplorer.expandPathInProjectExplorerAndOpenFile(
                projectName + "/" + SUBMODULE_NAME_1 + "/src/main/java/com.codenvy.example.spring", 1,
    ...
    private void openSubmoduleTwo(String projectName) throws Exception {
        ...
        projectExplorer.waitItem(projectName);
        projectExplorer
                .expandPathInProjectExplorerAndOpenFile(projectName + "/" + SUBMODULE_NAME_2 + "/src/main/java/com.company.example", 1,
                                                        "A.java");
        projectExplorer.openItemByPath(projectName + "/" + SUBMODULE_NAME_2 + "/src/main/java/commenttest");
