...
public class RenamePrivateMethodTest {
    ...
    private static final String nameOfProject            = RenamePrivateMethodTest.class.getSimpleName() + new Random().nextInt(9999);
    private static final String pathToPackageInChePrefix = nameOfProject + "/src" + "/main" + "/java" + "/renamePrivateMethods";
  ...
  @Test(priority = 1)
   ...
   @Test(priority = 7)
    public void testFail5() {
        ...
        askDialog.containsText("Problem in 'A.java'. Another name will shadow access to the renamed element");
    ...
    private void setFieldsForTest(String nameCurrentTest) throws Exception {
        ...
        URL resourcesIn = getClass().getResource("/org/eclipse/che/selenium/refactor/methods/private/" + nameCurrentTest + "/in/A.java");
        URL resourcesOut = getClass().getResource("/org/eclipse/che/selenium/refactor/methods/private/" + nameCurrentTest + "/out/B.java");
