...
public class RefactoringFeatureTest {
    ...
    private final        String PATH_TO_GREETING_FILE = PROJECT_NAME + "/src/main/java/org/eclipse/qa/examples/AppController.java";
    ...
    private void doMoveRefactor() {
        menu2.runCommand(TestMenuCommandsConstants.Assistant.ASSISTANT, TestMenuCommandsConstants.Assistant.Refactoring.REFACTORING,
