...
public class CommandsPaletteTest {
    ...
    public void newCommandTest() {
        projectExplorer.waitProjectExplorer();
        commandsBuilder(TestIntelligentCommandsConstants.CommandsGoals.COMMON_GOAL, TestIntelligentCommandsConstants.CommandsTypes.CUSTOM_TYPE);
        cop.openCommandPaletteByHotKeys();
