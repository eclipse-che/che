...
public class TestEnumerationsTest {
    private static final String NAME_OF_PROJECT               = NameGenerator.generate(TestEnumerationsTest.class.getName(), 2);
    private static final String PATH_TO_PACKAGE_IN_CHE_PREFIX = NAME_OF_PROJECT + "/src" + "/main" + "/java" + "/renametype";
    ...
    private void setFieldsForTest(String nameCurrentTest) throws Exception {
        ...
        URL resourcesInA = getClass().getResource("/org/eclipse/che/selenium/refactor/types/" + nameCurrentTest + "/in/A.java");
        URL resourcesOutA = getClass().getResource("/org/eclipse/che/selenium/refactor/types/" + nameCurrentTest + "/out/B.java");
