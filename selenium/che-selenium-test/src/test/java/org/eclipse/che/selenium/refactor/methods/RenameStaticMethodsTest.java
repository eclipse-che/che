...
public class RenameStaticMethodsTest {
    ...
    private static final String nameOfProject            = RenameStaticMethodsTest.class.getSimpleName() + new Random().nextInt(9999);
    private static final String pathToPackageInChePrefix = nameOfProject + "/src" + "/main" + "/java" + "/renameStaticMethods";
    ...
    private void doRefactorByWizardWithExpectedWarningMessage(int cursorPositionLine,
    ...
    private void setFieldsForTest(String nameCurrentTest) throws Exception {
        ...
        resourcesInA = getClass().getResource("/org/eclipse/che/selenium/refactor/methods/static/" + nameCurrentTest + "/in/A.java");
        resourcesOutB = getClass().getResource("/org/eclipse/che/selenium/refactor/methods/static/" + nameCurrentTest + "/out/B.java");
        resourceOutA = getClass().getResource("/org/eclipse/che/selenium/refactor/methods/static/" + nameCurrentTest + "/out/A.java");
    ...
    private String getTextFromFile(URL url) throws Exception {
        String result = "";
        List<String> listWithAllLines = Files.readAllLines(Paths.get(url.toURI()), Charset.forName("UTF-8"));
