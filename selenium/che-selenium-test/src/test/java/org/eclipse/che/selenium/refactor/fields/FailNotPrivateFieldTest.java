...
public class FailNotPrivateFieldTest {
    private static final String PROJECT_NAME             = NameGenerator.generate("FailNotPrivateFieldProject", 4);
    ...
    public void testFail7() throws Exception {
        ...
        askDialog.acceptDialogWithText("Problem in 'A.java'. Another name will shadow access to the renamed element");
        refactor.waitRenameFieldFormIsClosed();
        editor.closeFileByNameWithSaving("A");
    }
    ...
    private void setFieldsForTest(String nameCurrentTest) throws Exception {
        ...
        URL resources = getClass().getResource("/org/eclipse/che/selenium/refactor/fields/none-private/" + nameCurrentTest + "/in/A.java");
        List<String> listWithAllLines = Files.readAllLines(Paths.get(resources.toURI()), Charset.forName("UTF-8"));
        contentFromInA = "";
