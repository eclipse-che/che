...
public class MultimoduleProjectDebuggingTest {
    ...
    private static final String PATH_TO_APP_CLASS       = PROJECT + "/app/src/main/java/multimodule/App.java";
    private static final String PATH_TO_BOOK_IMPL_CLASS = PROJECT + "/model/src/main/java/multimodule/model/BookImpl.java";
    private static final String PATH_TO_BOOK_INTERFACE  = PROJECT + "/model/src/main/java/multimodule/model/Book.java";
    ...
    public void shouldStopInsideConstructor() {
        ...
        editor.setBreakPointAndWaitInactiveState(18);
    ...
    public void shouldDebugStaticDefaultMethod() {
        ...
        editor.setBreakPointAndWaitInactiveState(43);
        menu.runCommandByXpath(TestMenuCommandsConstants.Run.RUN_MENU,
                               TestMenuCommandsConstants.Run.DEBUG,
                               getXpathForDebugConfigurationMenuItem());
        // then
