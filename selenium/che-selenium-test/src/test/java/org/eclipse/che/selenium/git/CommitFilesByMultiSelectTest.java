...
public class CommitFilesByMultiSelectTest {
    ...
    private static final String PATH_FOR_EXPAND_FIRST_MODULE   = PROJECT_NAME + "/my-lib/src/test/java/hello";
    private static final String PATH_FOR_EXPAND_SECOND_MODULE  = PROJECT_NAME + "/my-webapp/src/main/java/helloworld";
    ...
    public void commitFilesByMultiSelect() {
        ...
        projectExplorer.expandPathInProjectExplorerAndOpenFile(PATH_FOR_EXPAND_FIRST_MODULE, "SayHelloTest.java");
        loader.waitOnClosed();
        ...
        projectExplorer.expandPathInProjectExplorerAndOpenFile(PATH_FOR_EXPAND_SECOND_MODULE, 1, "AppController.java");
        loader.waitOnClosed();
        editor.setCursorToLine(16);
        editor.typeTextIntoEditor("//" + CHANGE_CONTENT);
        editor.waitTextIntoEditor("//" + CHANGE_CONTENT);
        ...
        git.closeGitInfoPanel();
        projectExplorer.selectMultiFilesByCtrlKeys(PROJECT_NAME + "/my-webapp/src/main/java/helloworld/AppController.java");
        ...
        projectExplorer.selectMultiFilesByCtrlKeys(PROJECT_NAME + "/my-lib/src/test/java/hello/file.css");
        projectExplorer.selectMultiFilesByCtrlKeys(PROJECT_NAME + "/my-lib/src/test/java/hello/file.html");
        menu.runCommand(TestMenuCommandsConstants.Git.GIT, TestMenuCommandsConstants.Git.COMMIT);
