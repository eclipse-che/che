...
public class InheritClassTest {
    private static final String PROJECT_NAME   = NameGenerator.generate(InheritClassTest.class.getSimpleName(), 4);
    private static final String COMMON_PACKAGE = PROJECT_NAME + "/src/main/java/org/eclipse/qa/examples";
