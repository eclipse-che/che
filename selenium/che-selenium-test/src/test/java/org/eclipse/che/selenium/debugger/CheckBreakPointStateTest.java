...
public class CheckBreakPointStateTest {
    private static final String PROJECT_NAME   = NameGenerator.generate(CheckBreakPointStateTest.class.getSimpleName(), 3);
    private static final String PROJECT_NAME_2 = NameGenerator.generate(CheckBreakPointStateTest.class.getSimpleName(), 2);
    ...
    public void setUp() throws Exception {
        ...
        resource = CheckBreakPointStateTest.this.getClass().getResource("/projects/debudStepInto");
    ...
    public void checkStateAfterDeletionFileAndFolder() throws Exception {
        String expectedBreakpointsForAdditionalClass = "AdditonalClass.java - [line: 7]\n" +
                                                       "AdditonalClass.java - [line: 9]";

        String expectedBreakpointsForGreetingClass = "AppController.java - [line: 29]\n" +
        ...
        projectExplorer.waitDisappearItemByPath(PATH_TO_PROJECT_WITH_TWO_CLASSES + "AdditonalClass.java");
