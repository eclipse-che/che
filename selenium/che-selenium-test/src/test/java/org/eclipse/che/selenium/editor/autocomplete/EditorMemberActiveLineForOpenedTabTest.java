...
public class EditorMemberActiveLineForOpenedTabTest {
    ...
    public void createJavaSpringProjectAndTestEditor() {
        ...
        loader.waitOnClosed();
        projectExplorer.waitProjectExplorer();
        projectExplorer.waitDisappearItemByPath(PROJECT_NAME + "/src/main/java/org/eclipse/qa/examples/sqlFile.sql");
        editor.selectTabByName("another");
        editor.expectedNumberOfActiveLine(5);
        projectExplorer.selectItem(PROJECT_NAME + "/src/main/java/org/eclipse/qa/examples/LessFile.less");
        menu.runCommand(TestMenuCommandsConstants.Edit.EDIT, TestMenuCommandsConstants.Edit.DELETE);
        loader.waitOnClosed();
        askDialog.acceptDialogWithText(DELETE_TEXT_FOR_LESS);
        loader.waitOnClosed();
        projectExplorer.waitProjectExplorer();
        projectExplorer.waitDisappearItemByPath(PROJECT_NAME + "/src/main/java/org/eclipse/qa/examples/LessFile.less");
        editor.selectTabByName("another");
        loader.waitOnClosed();
        editor.expectedNumberOfActiveLine(5);
        ...
        loader.waitOnClosed();
        projectExplorer.waitProjectExplorer();
        projectExplorer.waitDisappearItemByPath(PROJECT_NAME + "/src/main/java/org/eclipse/qa/examples/another");
        editor.selectTabByName("AppController");
