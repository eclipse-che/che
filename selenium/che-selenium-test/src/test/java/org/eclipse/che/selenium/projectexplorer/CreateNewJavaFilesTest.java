...
public class CreateNewJavaFilesTest {
    ...
    public void createNewJavaFilesTest() throws Exception {
        ...
        //create new class
        createNewFileFromMenuFile(NEW_CLASS,
        ...
        createNewFileFromMenuFile(NEW_INTERFACE,
        ...
        //create new enum
        createNewFileFromMenuFile(NEW_ENUM,
    ...
    private void createNewFileFromMenuFile(String name,
