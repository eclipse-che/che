...
public class CreateProjectsForArtikPluginTest {
    ...
    private static final String TEXT_IN_CPP_FILE    = "#include <iostream>\n" +
                                                      "\n" +
                                                      "int main()\n" +
                                                      "{\n" +
                                                      ...
                                                      "    return 0;\n" +
                                                      "}";
    private static final String TEXT_IN_C_FILE      = "#include <stdio.h>\n" +
                                                      "\n" +
                                                      "int main(void)\n" +
                                                      "{\n" +
                                                      "    printf(\"hello, world\\n\");\n" +
    ...
    public void createCProjectTest() throws Exception {
        ...
        createAndCheckNewFile(NAME_C_PROJECT,
                              NAME_C_FILE,
    ...
    public void createCPlusPlusProjectTest() throws Exception {
        ...
        createAndCheckNewFile(NAME_CPP_PROJECT,
                              NAME_C_FILE,
                              TestProjectExplorerContextMenuConstants.SubMenuNew.C_FILE,
                              ".c");
        checkTextInEditorForFile(TEXT_IN_C_FILE, NAME_C_FILE + ".c");
    ...
    public void createPythonProjectTest() throws Exception {
        ...
        createAndCheckNewFile(NAME_PYTHON_PROJECT,
                              NAME_PYTHON_FILE,
    ...
    private void createAndCheckNewFile(String projectName,
                                       String fileName,
                                       String type,
                                       String fileExt) {
    ...
    private void checkTextInEditorForFile(String defaultText, String fileName) throws InterruptedException {
