...
public class RenamePackageSpringTest {
    private static final String PROJECT_NAME_1    = NameGenerator.generate("CheckRenamePackageSpringApp-", 4);
    private static final String PROJECT_NAME_2    = NameGenerator.generate("RenamePackageWithMainMethod-", 4);
    ...
    private static final String WARNING_TEXT = "Type org.eclipse.qa.examples.HelloWorld contains a main method - some " +
    ...
    public void checkRenamePackageSpringApp() {
        ...
        projectExplorer.openItemByPath(PROJECT_NAME_1 + "/src/main/java/org/eclipse/dev/examples/AppController.java");
