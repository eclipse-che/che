...
public class CheckCopyCutFeaturesForFilesTest {
    ...
    private static final String PATH_TO_XML_AFTER_MOVING  = PROJECT_NAME + "/src/main/webapp/WEB-INF/jsp/web.xml";
    private static final String PATH_TO_CSS_AFTER_MOVING  = PROJECT_NAME + "/src/main/webapp/WEB-INF/jsp/cssFile.css";
    private static final String PATH_TO_HTML_AFTER_MOVING = PROJECT_NAME + "/src/main/webapp/WEB-INF/jsp/htmlFile.html";
