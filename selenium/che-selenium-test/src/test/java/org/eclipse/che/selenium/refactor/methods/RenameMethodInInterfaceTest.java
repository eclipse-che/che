...
public class RenameMethodInInterfaceTest {
    ...
    private static final String nameOfProject             = RenameMethodInInterfaceTest.class.getSimpleName() + new Random().nextInt(9999);
    private static final String pathToPackageInChePrefix  = nameOfProject + "/src" + "/main" + "/java" + "/renameMethodsInInterface";
    ...
    private void setFieldsForTest(String nameCurrentTest) throws Exception {
        ...
        URL resourcesIn = getClass().getResource("/org/eclipse/che/selenium/refactor/methods/interface/" + nameCurrentTest + "/in/A.java");
        URL resourcesOut = getClass().getResource("/org/eclipse/che/selenium/refactor/methods/interface/" + nameCurrentTest + "/out/A.java");
