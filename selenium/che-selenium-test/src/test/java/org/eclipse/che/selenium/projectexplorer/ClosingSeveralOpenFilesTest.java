...
public class ClosingSeveralOpenFilesTest {
    private static final String PROJECT_NAME = NameGenerator.generate(ClosingSeveralOpenFilesTest.class.getSimpleName(), 4);
    private static final String PATH_FOR_EXPAND_FIRST_MODULE  = PROJECT_NAME + "/src/main/java/org/eclipse/qa/examples";
    private static final String PATH_FOR_EXPAND_SECOND_MODULE = PROJECT_NAME + "/src/main/webapp/WEB-INF";
