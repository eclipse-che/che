...
public class PreviewRefreshTest {
    ...
    private static final String EXPECTED_TEXT_BEFORE_CHANGE = "import javax.servlet.http.HttpServletResponse;\n" +
    ...
    private static final String EXPECTED_TEXT_BEFORE_FIRST_SELECT_CHANGE = "    @Override \n" +
                                                                           "    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response\n" +
    ...
    private static final String EXPECTED_TEXT_IN_RIGHT_EDITOR = "import javax.servlet.http.HttpServletResponse;\n" +
    ...
    public void checkPreviewRefreshTest() {
        ...
        loader.waitOnClosed();
        explorer.openItemByPath(PROJECT_NAME + "/src/main/java/org/eclipse/qa/examples/AppController.java");
