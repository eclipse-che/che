...
public class CheckReplaceFeatureInEditorTest {
    private static final String PROJECT_NAME = NameGenerator.generate(CheckReplaceFeatureInEditorTest.class.getSimpleName(), 4);
    ...
    @Inject
    private SearchReplacePanel       searchReplacePanel;
    @Inject
    ...
    public void setUp() throws Exception {
        ...
        List<String> expectedReplaseTextList = Files.readAllLines(Paths.get(resources.toURI()), Charset.forName("UTF-8"));
        ...
        List<String> expectedReplaseAllTextList = Files.readAllLines(Paths.get(resources.toURI()), Charset.forName("UTF-8"));
