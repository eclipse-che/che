...
public class ConfigureClasspathBaseTest {
    ...
    public void checkConfigureClasspath() {
        ...
        configureClasspath.waitExpectedTextJarsAndFolderArea("/" + PROJECT_NAME + "/my-lib/src/test/java");
        configureClasspath.selectLibrariesCategory();
        configureClasspath.waitExpectedTextJarsAndFolderArea("org.eclipse.che.MAVEN2_CLASSPATH_CONTAINER");
