...
public class CreateNewNotJavaFilesTest {
    ...
    public void createNewFileFromContextMenuTest() throws Exception {
        ...
        createNewFile(PATH_TO_FILES,
                      NEW_XML_FILE,
                      TestMenuCommandsConstants.Project.New.XML_FILE,
                      ".xml");
        ...
        createNewFile(PATH_TO_FILES,
                      NEW_LESS_FILE,
                      TestMenuCommandsConstants.Project.New.LESS_FILE,
                      ".less");
    ...
    private void createNewFile(String pathFromItem,
                               String name,
                               String type,
    ...
    private void checkDefaultTextInCodeMirrorEditorForFile(String defaultText, String fileName) throws InterruptedException {
