...
public class OrganizeImportsTest {
    private static final String PROJECT_NAME                    = NameGenerator.generate(OrganizeImportsTest.class.getSimpleName(), 4);
    private static final String SOURCE_FOLDER                   = "src/main/java";
    private static final String PATH_TO_CLASS_IN_SPRING_PACKAGE = PROJECT_NAME + "/src/main/java/org/eclipse/qa/examples/" +
                                                                  "AppController.java";
    ...
    private static final String PATH_TO_CLASS_IN_A_PACKAGE      = PROJECT_NAME + "/src/main/java/a/TestClass.java";
    private static final String PATH_TO_B_PACKAGE               = PROJECT_NAME + "/src/main/java/b";
    private static final String PATH_TO_CLASS_IN_B_PACKAGE      = PROJECT_NAME + "/src/main/java/b/TestClass.java";
    ...
    private static final String TEST_METHOD                     = "package a;\n" +
    ...
    public void organizeImportsTest() throws Exception {
        ...
        loader.waitOnClosed();
        menu.runCommand(TestMenuCommandsConstants.Assistant.ASSISTANT, TestMenuCommandsConstants.Assistant.ORGANIZE_IMPORTS);
        loader.waitOnClosed();
        editor.waitAllMarkersDisappear(ERROR_MARKER);
        Assert.assertTrue(editor.checkWhatTextLinePresentOnce("import org.springframework.web.servlet.ModelAndView;"));

        editor.setCursorToLine(20);
        editor.typeTextIntoEditorWithoutDelayForSaving("import org.springframework.web.servlet.ModelAndView;");
        loader.waitOnClosed();
        ...
        menu.runCommand(TestMenuCommandsConstants.Assistant.ASSISTANT, TestMenuCommandsConstants.Assistant.QUICK_FIX);
