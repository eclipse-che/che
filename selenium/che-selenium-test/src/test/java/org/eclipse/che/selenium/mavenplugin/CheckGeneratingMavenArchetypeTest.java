...
public class CheckGeneratingMavenArchetypeTest {
    private final static String NAME_OF_ARTIFACT = "quickStart";
    @Inject
    ...
    public void createMavenArchetypeStartProjectByWizard() throws Exception {
        Stream<String> expectedItems = Stream.of(NAME_OF_ARTIFACT + "/src/main/java/" + NAME_OF_ARTIFACT + "/App.java",
        ...
        URL resource = CheckGeneratingMavenArchetypeTest.class.getResource("pom-quick-start-archetype-context");
