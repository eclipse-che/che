...
public class NavigateToFileTest {
    ...
    private static final List<String> FILES_P_SYMBOL = Arrays.asList(
            "pom.xml (/NavigateFile_2)", "pom.xml (/NavigateFile)");
    private static final List<String> FILES_I_SYMBOL = Arrays.asList
            ("index.jsp (/NavigateFile/src/main/webapp)", "index.jsp (/NavigateFile_2/src/main/webapp)");
    private static final List<String> FILES_R_SYMBOL = Arrays.asList
            ("README.md (/NavigateFile)", "README.md (/NavigateFile_2)");
    private static final List<String> FILES_C_SYMBOL = Arrays.asList
    ...
    private void selectFileFromNavigate(String symbol, String pathName, List<String> files) {
        loader.waitOnClosed();
        menu.runCommand(TestMenuCommandsConstants.Assistant.ASSISTANT, TestMenuCommandsConstants.Assistant.NAVIGATE_TO_FILE);
