 ...
 */
public class CheckBitnamiLaravelFactoryTest {
    @Inject
    private Ide                     ide;
    @Inject
    ...
    public void setUp() throws Exception {
        testFactory = testFactoryInitializer.fromUrl("https://github.com/bitnami/bitnami-docker-laravel/tree/che");
    }
    ...
    @Test
    public void checkLaravelUrl() throws Exception {
        ...
        consoles.waitExpectedTextIntoConsole("*** Welcome to the che-laravel image ***");
    }
}
