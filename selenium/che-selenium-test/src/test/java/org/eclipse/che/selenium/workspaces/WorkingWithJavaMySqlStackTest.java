...
public class WorkingWithJavaMySqlStackTest {
    ...
    public void checkJavaMySqlAndRunApp() {
        ...
        projectExplorer.expandPathInProjectExplorer(PROJECT_NAME + "/src/main/java/org.springframework.samples.petclinic");
        projectExplorer.expandPathInProjectExplorer(PROJECT_NAME + "/src/test/java/org.springframework.samples.petclinic", 2);
        ...
        projectExplorer.openItemByPath(PROJECT_NAME + "/src/main/java/org/springframework/samples/petclinic/service");
        projectExplorer.openItemByPath
        ...
        projectExplorer.invokeCommandWithContextMenu(ProjectExplorer.CommandsGoal.COMMON, PROJECT_NAME, "show databases", "db");
        loader.waitOnClosed();
        ...
        projectExplorer
                .invokeCommandWithContextMenu(ProjectExplorer.CommandsGoal.RUN, PROJECT_NAME, "build and deploy", "dev-machine");
        loader.waitOnClosed();
