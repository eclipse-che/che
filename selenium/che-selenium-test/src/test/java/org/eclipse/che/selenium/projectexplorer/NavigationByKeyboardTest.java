...
public class NavigationByKeyboardTest {
    ...
    private String EXPECTED_TEXT_IN_JAVA_FILE = "package org.eclipse.qa.examples;\n" +
                                                "\n" +
    ...
    private void checkItemsOfTheSecondModuleIsNotVisible() {
        ...
        projectExplorer.waitItemIsNotPresentVisibleArea(PROJECT_NAME + "/src/main/java/" + modulePath + "/AppController.java");
        projectExplorer.waitItemIsNotPresentVisibleArea(PROJECT_NAME + "/src/main/java/" + modulePath + "/LessFile.less");
        projectExplorer.waitItemIsNotPresentVisibleArea(PROJECT_NAME + "/src/main/java/" + modulePath + "/another");
        projectExplorer.waitItemIsNotPresentVisibleArea(PROJECT_NAME + "/src/main/java/" + modulePath + "/sqlFile.sql");
    }
