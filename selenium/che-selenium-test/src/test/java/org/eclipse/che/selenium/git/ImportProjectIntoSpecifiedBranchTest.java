...
public class ImportProjectIntoSpecifiedBranchTest {
    ...
    public void checkImportProjectInBranchBySshUrl() throws IOException, JsonParseException {
        ...
        performImportIntoBranch("git@github.com:" + gitHubUsername + "/Repo_For_Test.git",
                                PROJECT_NAME,
                                BRANCH_1);
        ...
        loader.waitOnClosed();
        projectExplorer.openItemByPath(PROJECT_NAME + "/src/main/java/com/codenvy/example/spring/GreetingController.java");
    }

    @Test(priority = 1)
    public void checkImportProjectInBranchByHttpsUrl() throws IOException, JsonParseException {
        projectExplorer.waitProjectExplorer();
        performImportIntoBranch("https://github.com/" + gitHubUsername + "/Repo_For_Test.git",
                                PROJECT_NAME,
                                BRANCH_2);
        projectExplorer.waitItem(PROJECT_NAME);
        projectExplorer.selectVisibleItem(PROJECT_NAME);
    ...
    private void performImportIntoBranch(String url, String projectName, String branchName) throws IOException, JsonParseException {
        projectExplorer.waitProjectExplorer();
