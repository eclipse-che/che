...
public class RenameNotPrivateFieldTest {
    private static final String PROJECT_NAME             = NameGenerator.generate("RenameNotPrivateFieldProject", 4);
    ...
    public void prepare() throws Exception {
        ...
        new Services(projectExplorer, notificationsPopupPanel, refactor).expandSpringProjectNodes(PROJECT_NAME);
    }
    ...
    private void setFieldsForTest(String nameCurrentTest) throws Exception {
        ...
        URL resourcesIn = getClass().getResource("/org/eclipse/che/selenium/refactor/fields/none-private/" + nameCurrentTest + "/in/A.java");
        URL resourcesOut = getClass().getResource("/org/eclipse/che/selenium/refactor/fields/none-private/" + nameCurrentTest + "/out/A.java");
