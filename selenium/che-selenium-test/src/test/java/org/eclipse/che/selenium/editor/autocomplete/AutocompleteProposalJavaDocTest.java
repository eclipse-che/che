...
public class AutocompleteProposalJavaDocTest {
    ...
    private static final String PATH_TO_APP_CLASS       = PROJECT + "/app/src/main/java/multimodule/" + APP_CLASS_NAME + ".java";
    private static final String BOOK_IMPL_CLASS_NAME    = "BookImpl";
    private static final String PATH_TO_BOOK_IMPL_CLASS = PROJECT + "/model/src/main/java/multimodule/model/" +
                                                          BOOK_IMPL_CLASS_NAME + ".java";
    ...
    public void shouldDisplayJavaDocOfClassMethod()
            throws ForbiddenException, BadRequestException, IOException, ConflictException, NotFoundException, ServerException,
        ...
        // then
        verifyJavaDoc(editor.getAutocompleteProposalJavaDocHtml(),
    ...
    private void verifyJavaDoc(String javaDocHtml, String regex) {
        assertTrue(Pattern.compile(regex, Pattern.DOTALL)
                          .matcher(javaDocHtml)
                          .matches(),
