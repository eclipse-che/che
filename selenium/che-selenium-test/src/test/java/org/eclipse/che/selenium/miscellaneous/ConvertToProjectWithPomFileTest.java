...
public class ConvertToProjectWithPomFileTest {
    ...
    private static final String EXPECTED_TEXT    = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
    ...
    public void checkConvertToProjectWithPomFile() throws Exception {
        ...
        createNewFile("pom", PATH_TO_POM_FILE, TestProjectExplorerContextMenuConstants.SubMenuNew.XML_FILE);
