...
public class ContextMenuEditorTest {
    ...
    private static final String PROJECT_NAME   = NameGenerator.generate(ContextMenuEditorTest.class.getSimpleName(), 4);
    private static final String PROJECT_NAME_2 = "2_ContextMenuEditor" + new Random().nextInt(999);
    private static final String FORMATTED_TEXT = "public class AppController implements Controller {\n" +
    ...
    public void checkFormatContextMenu() {
        projectExplorer.waitVisibleItem(PROJECT_NAME);
        projectExplorer.scrollToItemByPath(PROJECT_NAME + "/src/main/java/org/eclipse/qa/examples/AppController.java");
    ...
    public void checkOpenDeclaration() {
        projectExplorer.waitItem(PROJECT_NAME_2);
        editor.setCursorToDefinedLineAndChar(25, 13);
    ...
    public void checkRefactoring() {
        projectExplorer.waitItem(PROJECT_NAME);
        projectExplorer.openItemByPath
                (PROJECT_NAME + "/src/main/java/com/example/Test1.java");
        editor.setCursorToDefinedLineAndChar(13, 15);
    ...
    public void checkNaviFileStructure() {
        ...
        loader.waitOnClosed();
        fileStructure.selectItemInFileStructure("handleRequest(HttpServletRequest, HttpServletResponse) : ModelAndView");
