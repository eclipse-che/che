...
public class CheckFileWatcherExcludeFeatureTest {
    ...
    public void checkAddRemoveFileFromFileWatcher() throws Exception {
        ...
        menu.runCommand(TestMenuCommandsConstants.Project.PROJECT, TestMenuCommandsConstants.Project.SHOW_HIDE_HIDDEN_FILES);
        ...
        doFileWatcherExcludeOperation(PATH_FOR_EXCLUDED_FILE, ProjectExplorer.FileWatcherExcludeOperations.ADD_TO_FILE_WATCHER_EXCLUDES);
        ...
        doFileWatcherExcludeOperation(PATH_FOR_EXCLUDED_FILE,
    ...
    public void checkFeatureAfterExcludingFolder() {
        doFileWatcherExcludeOperation(PROJECT_NAME + "/" + FOLDER_NAME_FOR_EXCLUDE,
        ...
        terminal.waitTerminalConsole();
        terminal.waitTerminalIsNotEmpty();
        terminal.typeIntoTerminal("cd /projects/" + PROJECT_NAME + "/src/main/java/org/eclipse/qa/examples" + Keys.ENTER);
        terminal.waitExpectedTextIntoTerminal("/projects/" + PROJECT_NAME + "/src/main/java/org/eclipse/qa/examples");
        terminal.typeIntoTerminal("pwd > " + "AppController.java" + Keys.ENTER);

        editor.selectTabByName("AppController");
        editor.waitTextNotPresentIntoEditor("/projects/" + PROJECT_NAME + "/src/main/java/org/eclipse/qa/examples");
        editor.clickOnCloseFileIcon("AppController");
        projectExplorer.openItemByVisibleNameInExplorer("AppController.java");
        editor.waitActiveEditor();
        editor.waitTextIntoEditor("/projects/" + PROJECT_NAME + "/src/main/java/org/eclipse/qa/examples");
        doFileWatcherExcludeOperation(PROJECT_NAME + "/" + FOLDER_NAME_FOR_EXCLUDE,
                                      ProjectExplorer.FileWatcherExcludeOperations.REMOVE_FROM_FILE_WATCHER_EXCLUDES);
    }
