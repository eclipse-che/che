...
public class CheckAutocompleteFeaturesInTheTestFolderTest {
    private static final String PROJECT_NAME           = NameGenerator.generate("CheckAuthoCompleteInTheTestFolder_", 4);
    private static final String tesClass               = "AppTest.java";
    private final        String pathToClassInTstFolder = PROJECT_NAME + "/src/test/java/com/codenvy/example/java/";
