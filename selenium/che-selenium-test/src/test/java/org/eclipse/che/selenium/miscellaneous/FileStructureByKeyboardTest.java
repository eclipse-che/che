...
public class FileStructureByKeyboardTest {
    ...
    public void expandTReeProjectAndOpenClass(String fileName) {
        ...
        projectExplorer.waitItem(PROJECT_NAME + "/src" + "/main" + "/java" + "/com/codenvy/qa/" + fileName + ".java");
        projectExplorer.openItemByPath(PROJECT_NAME + "/src" + "/main" + "/java" + "/com/codenvy/qa/" + fileName + ".java");
