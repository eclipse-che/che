...
public class CreateNewPackagesWithHelpCreationJavaClassTest {
    ...
    private static final String PROJECT_NAME      = CreateNewPackagesWithHelpCreationJavaClassTest.class.getSimpleName();
    ...
    public void createNewPackageFromContextMenuTest() throws Exception {
        ...
        askForValueDialog.createJavaFileByNameAndType(NEW_PACKAGE_NAME1 + "." + JAVA1, AskForValueDialog.JavaFiles.CLASS);
        ...
        askForValueDialog.createJavaFileByNameAndType(NEW_PACKAGE_NAME2 + "." + JAVA2, AskForValueDialog.JavaFiles.CLASS);
