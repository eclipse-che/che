...
public class FileStructureBaseOperationTest {
    ...
    private static final String CLASS_MEMBERS_1 = "AppController\n" +
                                                  "handleRequest(HttpServletRequest, HttpServletResponse) : ModelAndView\n" +
                                                  "secretNum";

    private static final String CLASS_MEMBERS_2 = "AppController\n" +
                                                  "handleRequest(HttpServletRequest, HttpServletResponse) : ModelAndView -> AppController\n" +
                                                  "secretNum -> AppController";

    private static final String INHERITED_MEMBERS = "Object() : void -> Object\n" +
    ...
    public void checkFileStructureBaseOperations() {
        ...
        projectExplorer
                .openItemByPath(PROJECT_NAME + "/src/main/java/org/eclipse/qa/examples/AppController.java");
