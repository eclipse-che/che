...
public class CommitFilesTest {
    ...
    private static final String TEXT_GROUP                 = "src/main\n" +
    ...
    public void testCheckBoxSelections() {
        ...
        git.waitItemCheckBoxToBeUnSelectedInCommitWindow("webapp",
                                                         "WEB-INF",
                                                         "jsp",
                                                         "guess_num.jsp",
                                                         "web.xml",
        ...
        git.clickItemCheckBoxInCommitWindow("webapp");
        git.waitItemCheckBoxToBeSelectedInCommitWindow("webapp",
                                                       "WEB-INF",
                                                       "jsp",
                                                       "guess_num.jsp",
                                                       "web.xml",
        ...
        git.waitItemCheckBoxToBeSelectedInCommitWindow("webapp",
                                                       ...
                                                       "jsp",
                                                       "guess_num.jsp");
        git.waitItemCheckBoxToBeUnSelectedInCommitWindow("web.xml",
                                                         "spring-servlet.xml",
                                                         "index.jsp");
        ...
        git.waitItemCheckBoxToBeSelectedInCommitWindow("webapp",
                                                       "WEB-INF");
        git.waitItemCheckBoxToBeUnSelectedInCommitWindow("jsp",
                                                         "guess_num.jsp");
        git.waitItemCheckBoxToBeSelectedInCommitWindow("web.xml",
                                                       "spring-servlet.xml",
                                                       "index.jsp");
    ...
    public void testFoldersStructureAfterRename() {
        ...
        menu.runCommand(TestMenuCommandsConstants.Assistant.ASSISTANT, TestMenuCommandsConstants.Assistant.Refactoring.REFACTORING,
        ...
        git.waitItemCheckBoxToBeSelectedInCommitWindow("src/main",
                                                       "java/org/eclipse/dev/examples",
                                                       "AppController.java",
                                                       "webapp",
                                                       "WEB-INF",
    ...
    public void commitFilesTest() {
        ...
        git.waitGitStatusBarWithMess("new file:   src/main/java/org/eclipse/dev/examples/AppController.java");
        ...
        menu.runCommand(TestMenuCommandsConstants.Project.PROJECT, TestMenuCommandsConstants.Project.New.NEW, TestMenuCommandsConstants.Project.New.JAVASCRIPT_FILE);
