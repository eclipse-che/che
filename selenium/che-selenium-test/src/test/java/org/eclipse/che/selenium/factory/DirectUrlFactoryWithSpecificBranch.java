...
public class DirectUrlFactoryWithSpecificBranch {
    ...
    public void setUp() throws Exception {
        testFactoryWithSpecificBranch =
                testFactoryInitializer.fromUrl("https://github.com/" + gitHubUsername + "/gitPullTest/tree/contrib-12092015");
    }
    ...
    public void factoryWithDirectUrlWithSpecificBranch() throws Exception {
        ...
        events.waitExpectedMessage("Successfully configured and cloned source code of gitPullTest.", UPDATING_PROJECT_TIMEOUT_SEC);
