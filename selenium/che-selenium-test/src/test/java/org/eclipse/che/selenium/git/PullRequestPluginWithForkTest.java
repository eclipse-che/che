...
public class PullRequestPluginWithForkTest {
    ...
    private static final String PROJECT_URL          = "https://github.com/iedexmain1/pull-request-plugin-fork-test.git";
    ...
    public void tearDown() throws Exception {
        ...
        List<String> listPullRequest =
                gitHubClientService.getNumbersOfOpenedPullRequests(NAME_REPO, githubUserCloneName, githubUserClonePassword);
        gitHubClientService.closePullRequest(NAME_REPO, Collections.max(listPullRequest), githubUserCloneName, githubUserClonePassword);
    }
