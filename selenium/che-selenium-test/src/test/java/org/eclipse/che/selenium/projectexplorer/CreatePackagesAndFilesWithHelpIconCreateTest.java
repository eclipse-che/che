...
public class CreatePackagesAndFilesWithHelpIconCreateTest {
    ...
    private static final String PROJECT_NAME     = CreatePackagesAndFilesWithHelpIconCreateTest.class.getSimpleName();
    ...
    public void createWithHelpCreateIcon() throws Exception {
        ...
        createNewFile(NEW_FILE_NAME,
                      IdeMainDockPanel.CreateMenuCommand.FILE,
                      "");
        editor.waitTabIsPresent(NEW_FILE_NAME);
        loader.waitOnClosed();
        createNewFile(NEW_XML_FILE,
                      IdeMainDockPanel.CreateMenuCommand.XML_FILE,
                      ".xml");
        loader.waitOnClosed();
        createNewFile(NEW_LESS_FILE,
                      IdeMainDockPanel.CreateMenuCommand.LESS_FILE,
                      ".less");
        loader.waitOnClosed();
        createNewFile(NEW_CSS_FILE,
                      IdeMainDockPanel.CreateMenuCommand.CSS_FILE,
                      ".css");
        loader.waitOnClosed();
        createNewFile(NEW_HTML_FILE,
                      IdeMainDockPanel.CreateMenuCommand.HTML_FILE,
                      ".html");
        loader.waitOnClosed();
        createNewFile(NEW_JS_FILE,
                      IdeMainDockPanel.CreateMenuCommand.JAVASCRIPT_FILE,
                      ".js");
        loader.waitOnClosed();
    }
