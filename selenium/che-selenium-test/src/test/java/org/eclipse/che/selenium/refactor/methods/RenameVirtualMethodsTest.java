...
public class RenameVirtualMethodsTest {
    ...
    private static final String nameOfProject            = RenameVirtualMethodsTest.class.getSimpleName() + new Random().nextInt(9999);
    private static final String pathToPackageInChePrefix = nameOfProject + "/src" + "/main" + "/java" + "/renameVirtualMethods";
    ...
    private void doRefactorByWizardWithClosingWarnMess(int cursorPositionLine, int cursorPositionChar, String newName) {
        prepareProjectForRefactor(cursorPositionLine, cursorPositionChar);
        editor.launchRefactorFormFromEditor();
        editor.launchRefactorFormFromEditor();
        refactor.waitRenameMethodFormIsOpen();
    ...
    private void setFieldsForTest(String nameCurrentTest) throws Exception {
        ...
        URL resourcesIn = getClass().getResource("/org/eclipse/che/selenium/refactor/methods/virtual/" + nameCurrentTest + "/in/A.java");
        URL resourcesOut = getClass().getResource("/org/eclipse/che/selenium/refactor/methods/virtual/" + nameCurrentTest + "/out/A.java");
