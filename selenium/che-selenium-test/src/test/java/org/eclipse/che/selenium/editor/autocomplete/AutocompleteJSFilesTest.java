...
public class AutocompleteJSFilesTest {
    private static final String PROJECT_NAME  = NameGenerator.generate(AutocompleteJSFilesTest.class.getSimpleName(), 4);
    private static final String EXPECTED_TEXT = "function a (){\n" +
                                                "    var b = 5;\n" +
                                                "    var c = b;\n" +
                                                "    return c;\n" +
                                                "}\n" +
