...
public class IllegalTypeNameTest {
    private static final String nameOfProject            = NameGenerator.generate(IllegalTypeNameTest.class.getName(), 2);
    ...
    private void setFieldsForTest(String nameCurrentTest) throws Exception {
        ...
        URL resourcesInA = getClass().getResource("/org/eclipse/che/selenium/refactor/types/" + nameCurrentTest + "//A.java");
