...
public class CheckBasicFunctionalityInCommandsExplorerTest {
    ...
    public void shouldCreateDifferentTypesCommandsInDifferentGoals() {
        ...
        commandsExplorer.checkCommandIsPresentInGoal(CommandsGoals.COMMON_GOAL, CommandsDefaultNames.JAVA_NAME);
        ...
        commandsExplorer.checkCommandIsPresentInGoal(CommandsGoals.DEBUG_GOAL, CommandsDefaultNames.CUSTOM_NAME);
        ...
        commandsExplorer.checkCommandIsPresentInGoal(CommandsGoals.RUN_GOAL, CommandsDefaultNames.GWT_NAME);
        ...
        commandsExplorer.checkCommandIsPresentInGoal(CommandsGoals.TEST_GOAL, CommandsDefaultNames.GWT_SDM_FOR_CHE);
