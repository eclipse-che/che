...
public class GitCompareTest {
    ...
    private static final String TEXT_GROUP      = "src/main/java/com/codenvy/example/spring\n" +
                                                  "A.java\n" +
    ...
    public void checkGitCompareTest() {
        ...
        menu.runCommand(TestMenuCommandsConstants.Git.GIT, TestMenuCommandsConstants.Git.Compare.COMPARE_TOP, TestMenuCommandsConstants.Git.Compare.COMPARE_LATEST_VER);
        loader.waitOnClosed();
        ...
        git.closeGroupGitCompareForm();
        projectExplorer.selectItem(PROJECT_NAME + "/src/main/java/com/codenvy/example/spring/HelloWorld.java");
        ...
        git.closeGroupGitCompareForm();
        projectExplorer.openItemByPath(PROJECT_NAME + "/src/main/java/com/codenvy/example/spring/A.java");
        ...
        loader.waitOnClosed();
        projectExplorer.selectItem(PROJECT_NAME + "/src/main/java/com/codenvy/example/spring/GreetingController.java");
        menu.runCommand(TestMenuCommandsConstants.Git.GIT, TestMenuCommandsConstants.Git.Compare.COMPARE_TOP, TestMenuCommandsConstants.Git.Compare.COMPARE_LATEST_VER);
        loader.waitOnClosed();
        warningDialog.waitWaitWarnDialogWindowWithSpecifiedTextMess("There are no changes in the selected item.");
        warningDialog.clickOkBtn();

        // check the 'git compare' for another local branch
        projectExplorer.waitProjectExplorer();
        menu.runCommand(TestMenuCommandsConstants.Git.GIT, TestMenuCommandsConstants.Git.Compare.COMPARE_TOP, TestMenuCommandsConstants.Git.Compare.COMPARE_WITH_BRANCH);
        ...
        projectExplorer.waitProjectExplorer();
        projectExplorer.selectItem(PROJECT_NAME + "/src/main/java/com/codenvy/example/spring/GreetingController.java");
        menu.runCommand(TestMenuCommandsConstants.Git.GIT, TestMenuCommandsConstants.Git.Compare.COMPARE_TOP, TestMenuCommandsConstants.Git.Compare.COMPARE_WITH_REVISION);
