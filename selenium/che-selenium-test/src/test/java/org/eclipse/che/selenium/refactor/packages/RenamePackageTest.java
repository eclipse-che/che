 ...
 *         TODO Part of test methods are fail. See issue - https://github.com/eclipse/che/issues/4979
 */
public class RenamePackageTest {
    ...
    private static String TEST0_P1_OUT = "package test0.p1;\n" +
                                         "/**\n" +
                                         " * This is in test0.r.\n" +
                                         " * @see test0.p1\n" +
                                         " * @see test0.p1.A\n" +
    ...
    private static String TEST10_HIERAR_OUT = "package your.pack;\n" +
                                              "\n" +
                                              "public class C {\n" +
                                              "/*\n" +
                                              "your.pack\n" +
    ...
    private static String TEST12_RENAME_WITH_RESOURCE_OUT = "mine\n" +
                                                            "mine.\n" +
                                                            "mine.subpack\n" +
                                                            "mine.pack2\n" +
                                                            "mine.pack2.subpack\n" +
    ...
    public void checkTest2() {
        ...
        projectExplorer.selectItem(PROJECT_NAME + "/src/main/java/test2/r");
        menu.runCommand(TestMenuCommandsConstants.Assistant.ASSISTANT,
                        TestMenuCommandsConstants.Assistant.Refactoring.REFACTORING,
                        TestMenuCommandsConstants.Assistant.Refactoring.RENAME);
        refactor.waitRenamePackageFormIsOpen();
    ...
    public void checkTest7() {
        ...
        editor.closeFileByNameWithSaving("A");
        editor.closeFileByNameWithSaving("B");
        projectExplorer.selectItem(PROJECT_NAME + "/src/main/java/test7/r");
        menu.runCommand(TestMenuCommandsConstants.Assistant.ASSISTANT,
                        TestMenuCommandsConstants.Assistant.Refactoring.REFACTORING,
                        TestMenuCommandsConstants.Assistant.Refactoring.RENAME);
    ...
    public void checkTestDisableImport11() {
        ...
        refactor.waitRenamePackageFormIsOpen();
        loader.waitOnClosed();
        refactor.typeAndWaitNewName("you");
