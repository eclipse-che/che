...
public class CreateFactoryFromUiWithKeepDirTest {
    private static final String   PROJECT_NAME                  =
            NameGenerator.generate(CreateFactoryFromUiWithKeepDirTest.class.getSimpleName().substring(6), 2);
    private static final Logger   LOG                           = LoggerFactory.getLogger(CreateFactoryFromUiWithKeepDirTest.class);
    ...
    @Inject
    private CreateFactoryWidget        factoryWidget;
    @Inject
    ...
    private void createFactoryAndSwitchToWs() throws IOException {
        ...
        projectExplorer.expandPathInProjectExplorerAndOpenFile(PROJECT_NAME + "/" + KEEPED_DIR + "/src" + "/main" + "/java/hello",
    ...
    private void makeKeepDirectoryFromGitUrl(String url, String projectName, String folderName) throws Exception {
