...
public class ShowHintsCommandTest {
    private static final String PROJECT_NAME = NameGenerator.generate(ShowHintsCommandTest.class.getSimpleName(), 4);

    private static final String TEXT_IN_POP_UP_1 = "<no parameters>\n" +
                                                   "int arg\n" +
                                                   "boolean arg\n" +
                                                   "String arg\n" +
                                                   "int arg, String arg2\n" +
    ...
    private static final String TEXT_IN_POP_UP_2 = "<no parameters>\n" +
                                                   "int arg\n" +
                                                   "int arg, String arg2\n" +
                                                   "int arg, String arg2, boolean arg3";
