...
public class PropertiesTest {
    ...
    private static final String CUSTOM_PROPERTY_VALUE    = "'custom property for all file in trunk' trunk/*";
    ...
    public void propertiesTest() throws Exception {
        ...
        menu.runAndWaitCommand(TestMenuCommandsConstants.Subversion.SUBVERSION, TestMenuCommandsConstants.Subversion.SVN_STATUS);
        loader.waitOnClosed();
    }

    private void addProperty(String name, String value) throws Exception {
        menu.runAndWaitCommand(TestMenuCommandsConstants.Subversion.SUBVERSION, TestMenuCommandsConstants.Subversion.SVN_PROPERTIES);
        loader.waitOnClosed();
