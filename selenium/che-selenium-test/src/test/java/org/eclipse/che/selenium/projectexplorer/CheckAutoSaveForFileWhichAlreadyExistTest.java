...
public class CheckAutoSaveForFileWhichAlreadyExistTest {
    ...
    private static final String PROJECT_NAME        = CheckAutoSaveForFileWhichAlreadyExistTest.class.getSimpleName();
    private static final String PATH_TO_JAVA        = PROJECT_NAME + "/src/main/java/org/eclipse/qa/examples/AppController.java";
