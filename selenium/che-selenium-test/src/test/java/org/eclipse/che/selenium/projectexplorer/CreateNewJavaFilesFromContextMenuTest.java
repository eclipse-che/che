...
public class CreateNewJavaFilesFromContextMenuTest {
    ...
    private static final String DEFAULT_TEXT_FOR_NEW_CLASS     = "package org.eclipse.qa.examples;\n" +
                                                                 "\n" +
