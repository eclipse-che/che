...
public class KeepDirectoryGitImportTest {
    ...
    @Test(enabled = false, description = "Need to fix the issue https://github.com/eclipse/che/issues/1853")
    public void keepDirectoryGitImport() throws Exception {
        // Check the 'keep directory' from SSH Git url
        projectExplorer.waitProjectExplorer();
        makeKeepDirectoryFromGitUrl("git@github.com:" + gitHubUsername + "/java-multimodule.git",
                                    PROJECT_NAME_1,
                                    DIRECTORY_NAME_1);
        ...
        loader.waitOnClosed();
        makeKeepDirectoryFromGitUrl("git@github.com:" + gitHubUsername + "/java-multimodule2.git",
                                    PROJECT_NAME_2,
                                    DIRECTORY_NAME_1);
        ...
        makeKeepDirectoryFromGitUrl("https://github.com/" + gitHubUsername + "/java-multimodule2.git",
                                    PROJECT_NAME_3,
                                    DIRECTORY_NAME_2);
        ...
        projectExplorer.openItemByPath(PROJECT_NAME_3 + "/my-lib/src/test/java/hello/SayHelloTest.java");
        loader.waitOnClosed();
    ...
    public void makeKeepDirectoryFromGitUrl(String url, String projectName, String folderName) throws Exception {
        menu.runCommand(TestMenuCommandsConstants.Workspace.WORKSPACE, TestMenuCommandsConstants.Workspace.IMPORT_PROJECT);
        importProject.waitMainForm();
        loader.waitOnClosed();
