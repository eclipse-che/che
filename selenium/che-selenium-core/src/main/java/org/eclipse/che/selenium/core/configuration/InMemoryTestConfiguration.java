    ...
    public String getString(String key) {
        ...
        if (value == null) {
            ...
            builder.append("\n")
                   ...
                   .append(key.toUpperCase().replace("_", "=").replace('.', '_').replace("=", "__")).append("=yourvalue \n")
                   .append("3. Or configured it in a property file in folder declared as ").append(CheBootstrap.CHE_LOCAL_CONF_DIR)
