...
/**
 * Contain information about occurrence of found phrase like:
 * - start and send offsets in the file for found phrase;
 * - number and content of line where given phrase found;
 * - found phrase itself;
...
public interface SearchOccurrence {
    ...
    /**
     * Found phrase
     * (eg if you try to find 'hel' and text contain 'hello', in this case phrase will be 'hello')
     *
     * @return
     */
    String getPhrase();
