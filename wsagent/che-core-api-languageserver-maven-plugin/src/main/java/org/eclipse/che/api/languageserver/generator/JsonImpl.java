...
public interface JsonImpl {
    ...
    /**
     * Write an iteration over the given json object to the output writer,
     * delegating handling of individual properties to the given handler
     *
     * @param indent
     *         the base indent to use
     * @param out
     *         where to write text
     * @param objectName
     *         the name of the json object to iterate over
     * @param handler
     *         the handler to delegate property writing to.
     */
    ...
    /**
     * @return write imports for all classes referenced in the implementation of
     * this interface
     */
