...
/**
 * Generates server side dto's from lsp4j message classes and che extensions thereof.
 * The classes in question must have a zero-arg constructor and standard getters/setters for all fields.
 *
 * @author Thomas Mäder
 */
public class ServerDtoGenerator extends DtoGenerator {
    ...
    public void generate(File targetFolder, String targetName, String targetPackage, String[] sourcePackages, String[] classes)
        ...
        File outServiceFile = new File(targetFolder, "META-INF/services/org.eclipse.che.dto.server.DtoFactoryVisitor");
