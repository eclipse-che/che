...
public class ProjectApiModule extends AbstractModule {
    ...
    private void configureVfsEvent() {
        ...
        registerRequestHandler("track:editor-file", FileTrackingOperationReceiver.class);
    }

    @SuppressWarnings("unchecked")
    private void registerRequestHandler(String method, Class requestHandlerImplementationClass) {
        MapBinder.newMapBinder(binder(), String.class, RequestHandler.class)
                 .addBinding(method)
                 .to(requestHandlerImplementationClass);
    }
}
