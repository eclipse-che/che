...
import org.eclipse.che.api.project.server.impl.SimpleProjectQualifier;
import org.eclipse.che.api.project.server.impl.SuspendingProjectManager;
...
public class ProjectApiModule extends AbstractModule {
  ...
  protected void configure() {
    ...
    bind(ProjectManager.class).to(SuspendingProjectManager.class);
