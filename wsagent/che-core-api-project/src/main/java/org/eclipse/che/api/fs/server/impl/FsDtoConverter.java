...
@Singleton
public class FsDtoConverter implements org.eclipse.che.api.fs.server.FsDtoConverter {
  ...
  @Inject
  public FsDtoConverter(
      FsPathResolver pathResolver, ProjectManager projectManager, FsManager fsManager) {
