...
/**
 * Notifies about changes of editor working copy.
 * The event is used by {@link EditorWorkingCopyManager} when working copy is changed to notify interested consumers about it.
 *
