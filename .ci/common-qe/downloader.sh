...
. "$SCRIPT_DIR/$COMMON_FOLDER_NAME/$CERT_GENERATION_SCRIPT_NAME"
. "$SCRIPT_DIR/$COMMON_FOLDER_NAME/$CHE_UTIL_SCRIPT_NAME"
. "$SCRIPT_DIR/$COMMON_FOLDER_NAME/$COMMON_UTIL_SCRIPT_NAME"
. "$SCRIPT_DIR/$COMMON_FOLDER_NAME/$INSTALLATION_UTIL_SCRIPT_NAME"
