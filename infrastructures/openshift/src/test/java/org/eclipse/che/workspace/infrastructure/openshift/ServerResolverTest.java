...
public class ServerResolverTest {
    ...
    public void testResolvingServersWhenThereIsNoMatchedServiceByPodLabels() {
        ...
        Service nonMatchedByPodService = createService("nonMatched", CONTAINER_PORT, ImmutableMap.of("kind", "db"));
    ...
    private Container createContainer() {
        return new ContainerBuilder().withPorts(new ContainerPortBuilder()
    ...
    private Route createRoute(String name, Map<String, ServerConfigImpl> servers) {
        return new RouteBuilder().withNewMetadata()
                                 .withName(name)
