...
public class ParallelDockerImagesResolver {
  ...
  public Map<String, String> resolveImages(Map<String, DockerContainerConfig> containers)
    ...
    Resolver r = new Resolver(dockerCredentials, dockerConnector);
                ...
                e ->
                    CompletableFuture.supplyAsync(
                        () -> {
                          ...
                          } catch (InternalInfrastructureException | SourceNotFoundException e1) {
                            firstFailed.completeExceptionally(e1);
                          }
