...
public class ProjectsVolumeProvisionerTest {
    ...
    private static final RuntimeIdentity RUNTIME_IDENTITY  = new RuntimeIdentityImpl(WORKSPACE_ID, "env", "owner");
    ...
    @Mock
    private LocalWorkspaceFolderPathProvider workspaceFolderPathProvider;
    @Mock
    ...
    public void setUp() throws Exception {
        provisioner = new ProjectsVolumeProvisioner(workspaceFolderPathProvider, pathEscaper, PATH_IN_CONTAINER, "");
    ...
    public void shouldThrowExceptionIfDevMachineIsNotFound() throws Exception {
        // given
        environment.getMachines().get(MACHINE_1_NAME).setInstallers(Collections.singletonList("org.eclipse.che.ssh"));
    ...
    public void shouldAddProjectsVolumeToDevMachine() throws Exception {
        ...
        expectedDockerEnv.getContainers().get(MACHINE_1_NAME).getVolumes().add(PATH_ON_HOST + ":" + PATH_IN_CONTAINER);
    ...
    @Test(expectedExceptions = InternalInfrastructureException.class,
          expectedExceptionsMessageRegExp = "Error occurred on resolving path to files of workspace " + WORKSPACE_ID)
