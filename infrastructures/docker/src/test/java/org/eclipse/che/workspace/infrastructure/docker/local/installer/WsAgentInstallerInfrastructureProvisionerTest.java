...
public class WsAgentInstallerInfrastructureProvisionerTest {
    private static final RuntimeIdentity RUNTIME_IDENTITY = new RuntimeIdentityImpl("wsId", "env", "owner");
    private static final String          MACHINE_1_NAME    = "machine1";
    private static final String          MACHINE_2_NAME    = "machine2";

    @Mock
    private WsAgentBinariesInfrastructureProvisioner  binariesProvisioner;
    @Mock
    private DockerExtConfBindingProvider              extConfBindingProvider;
    ...
    @Test
    public void shouldAddExtConfVolumeAndEnvVarWhenVolumeProviderReturnsNotNullValue() throws Exception {
        // given
        ...
        DockerContainerConfig expectedContainerConfig = expectedDockerEnv.getContainers().get(MACHINE_1_NAME);
        expectedContainerConfig.getEnvironment().put(CheBootstrap.CHE_LOCAL_CONF_DIR,
    ...
    @Test
    public void shouldNotAddNeitherExtConfVolumeNorEnvVarIfVolumeProviderReturnsNull() throws Exception {
        // given
        EnvironmentImpl expectedEnvConfig = new EnvironmentImpl(envConfig);
        DockerEnvironment expectedDockerEnv = new DockerEnvironment(dockerEnv);
    ...
    private EnvironmentImpl createEnvironment(String nameOfMachineWithWsagentInstaller,
                                              String... machinesNames) {
