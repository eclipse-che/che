...
/**
 * Sets RAM size configured in the system as a property in case it is missing in container configuration.
 *
...
public class DefaultRAMProvisioner implements ContainerSystemSettingsProvisioner {
    ...
    @Inject
    public DefaultRAMProvisioner(@Named("che.workspace.default_memory_mb") long defaultMachineMemorySizeMB) {
