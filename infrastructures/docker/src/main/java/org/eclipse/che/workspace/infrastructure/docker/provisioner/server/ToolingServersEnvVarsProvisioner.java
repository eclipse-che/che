...
/**
 * Adds environment variables needed for servers used by Che for providing IDE features
 * such as FS access, terminal, command execution, etc.
 *
...
public class ToolingServersEnvVarsProvisioner implements ConfigurationProvisioner {
    ...
    public void provision(EnvironmentImpl envConfig, DockerEnvironment internalEnv, RuntimeIdentity identity)
        ...
        Map<String, String> envVars = providers.stream()
