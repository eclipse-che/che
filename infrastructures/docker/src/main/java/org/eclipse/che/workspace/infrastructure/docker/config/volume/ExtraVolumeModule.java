 ...
 *******************************************************************************/
package org.eclipse.che.workspace.infrastructure.docker.config.volume;
 ...
 */
public class ExtraVolumeModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        devMachineVolumes.addBinding().toProvider(ExtraVolumeProvider.class);
    }
