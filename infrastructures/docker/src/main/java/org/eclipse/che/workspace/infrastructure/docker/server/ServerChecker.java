...
public abstract class ServerChecker {
     ...
     *
     * @param machineName
     *         name of machine to whom the server belongs
     * @param serverRef
     *         reference of the server
     * @param period
     *         period between unsuccessful availability checks, measured in {@code timeUnit}
     * @param timeout
     *         max time allowed for the server availability checks to last before
     *         server is treated unavailable, measured in {@code timeUnit}
     * @param timeUnit
     *         measurement unit for {@code period} and {@code timeout} parameters
     */
    protected ServerChecker(String machineName,
                            String serverRef,
                            long period,
                            long timeout,
                            TimeUnit timeUnit,
    ...
    /**
     * Returns {@code CompletableFuture} that will be completed when server become available or unavailable.
     * </p>
     * When server become available completable future returns server reference.
     * </br>This completable future can be used to chain {@code CompletableFuture} stage
     * to successful or unsuccessful completion of the server availability check.
     *
