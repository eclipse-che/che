...
public class KubernetesNamespaceFactoryTest {
  ...
  //  @Test
  //  public void
  // shouldNotThrowExceptionIfDefaultNamespaceIsSpecifiedOnCheckingIfNamespaceIsAllowed()
  //      throws Exception {
  //    namespaceFactory =
  ...
  //      expectedExceptions = InfrastructureException.class,
  //      expectedExceptionsMessageRegExp =
  //          "Error occurred when tried to list all available namespaces. Cause: connection
  // refused")
  ...
  //      throws Exception {
  //    // There is only one scenario where this can happen. The workspace was created and started
  // in
  ...
  //
  //    RoleBindingList bindings =
  // k8sClient.rbac().roleBindings().inNamespace("workspace123").list();
  //    assertEquals(
  //        bindings
  //            .getItems()
  //            .stream()
  ...
  //
  //    assertEqualsMessage(
  //        "The 'che.infra.kubernetes.namespace' configuration parameter has been deprecated and is
  // subject to removal in future releases. The current value is: `{}`. Legacy workspaces located in
  // this namespace may become unreachable in future releases. Please refer to the documentation
  ...
  //
  //    assertEqualsMessage(
  //        "Namespace strategies other than 'per user' have been deprecated and are subject to
  // removal in future releases. Using the {} placeholder is required in the
  // 'che.infra.kubernetes.namespace.default' parameter. The current value is: `{}`.");
  //  }
  //
  //  @Test
  ...
  // placeholder has been deprecated and is subject to removal in future releases. The current value
  // is: `{}`. Please refer to the documentation about possible next steps.");
  //  }
  //
  ...
  //  }
  //
  //  private void prepareNamespaceToBeFoundByName(String name, Namespace namespace) throws
  // Exception {
  ...
  //  }
  //
  //  private void throwOnTryToGetNamespaceByName(String namespaceName, Throwable e) throws
  // Exception {
  //    @SuppressWarnings("unchecked")
  //    Resource<Namespace, DoneableNamespace> getNamespaceByNameOperation = mock(Resource.class);
