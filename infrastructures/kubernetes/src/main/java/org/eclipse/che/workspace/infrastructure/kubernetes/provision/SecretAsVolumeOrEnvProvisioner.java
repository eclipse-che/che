...
public class SecretAsVolumeOrEnvProvisioner<E extends KubernetesEnvironment> {

  private final Map<String, String> secretLabels;

  @Inject
  public SecretAsVolumeOrEnvProvisioner(
  ...
  public void provision(E env, KubernetesNamespace namespace) throws InfrastructureException {
    ...
    for (Secret secret : secrets) {
      ...
      String targetContainerName = secret.getMetadata().getLabels().get("targetContainer");
