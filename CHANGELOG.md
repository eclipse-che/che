...
- /scripts/base/commands/cmd\_start.sh: line 75: CHE\_MIN\_RAM: unbound variable [\#3977](https://github.com/eclipse/che/issues/3977)
- How to run the custom assembly [\#3975](https://github.com/eclipse/che/issues/3975)
- Unable to find image 'eclipse/che:5.2.0' locally [\#3974](https://github.com/eclipse/che/issues/3974)
- Starting eclipse che with parameters in docker outputs "You are missing a mandatory parameter" [\#3955](https://github.com/eclipse/che/issues/3955)
- Could not start workspace workspace-man. Reason: Start of environment 'workspace-man' failed. Error: Can't create folder for the logs of machine [\#3929](https://github.com/eclipse/che/issues/3929)
- Debug Language Servers [\#3925](https://github.com/eclipse/che/issues/3925)
- Che workspace is not stopped if env.var to stop inactive workspace is set [\#3915](https://github.com/eclipse/che/issues/3915)
- mvn test fails with Exception StringIndexOutOfBounds [\#3907](https://github.com/eclipse/che/issues/3907)
- Where's the Operations perspective? [\#3905](https://github.com/eclipse/che/issues/3905)
- Replace CHE\_EXTRA\_VOLUME\_MOUNT with CHE\_WORKSPACE\_VOLUME in cli.sh [\#3903](https://github.com/eclipse/che/issues/3903)
- IDE error message is displayed when click on billing invoices  [\#3901](https://github.com/eclipse/che/issues/3901)
- How to use CHE\_EXTRA\_VOLUME\_MOUNT? [\#3888](https://github.com/eclipse/che/issues/3888)
- che init does not create any files in host folder [\#3887](https://github.com/eclipse/che/issues/3887)
- Creating a new project on /dashboard/\#/create-project with a new workspace gets stuck at "Creating and initializing workspace" forever [\#3884](https://github.com/eclipse/che/issues/3884)
- circular dependency in dockerfiles [\#3882](https://github.com/eclipse/che/issues/3882)
- "Unable to initialize IDE" when "Starting workspace agent." [\#3871](https://github.com/eclipse/che/issues/3871)
- Latest eclipse che image complains about /data not mounted although it is, and stops with exit code 2 [\#3863](https://github.com/eclipse/che/issues/3863)
- Workspace config json modification [\#3858](https://github.com/eclipse/che/issues/3858)
- Provide documentation for adding a stack to the default Che assembly [\#3804](https://github.com/eclipse/che/issues/3804)
- Creating or import project in the running workspace on the dashboard does not work \(regression\) [\#3797](https://github.com/eclipse/che/issues/3797)
- Create a prototype of maven archetype for Eclipse Che plugin developers. [\#3697](https://github.com/eclipse/che/issues/3697)
- Can't expand folder in project explorer [\#3465](https://github.com/eclipse/che/issues/3465)
- Provide docs and gifs for the new file watchers [\#3461](https://github.com/eclipse/che/issues/3461)
- Improve Find capabilities in IDE [\#2617](https://github.com/eclipse/che/issues/2617)
- Add scrollbars to terminal [\#2423](https://github.com/eclipse/che/issues/2423)
- che-ip tests does not work on CI [\#3982](https://github.com/eclipse/che/issues/3982)
- Tabs stacks absent on the dashboard \(regression\) [\#3981](https://github.com/eclipse/che/issues/3981)
- Workspace creation from custom recipe doesn't work in UD [\#3944](https://github.com/eclipse/che/issues/3944)
- Nightly che-cli did not auto detect IP [\#3941](https://github.com/eclipse/che/issues/3941)
- Proxy settings exported in the workspace container for a user not root [\#3920](https://github.com/eclipse/che/issues/3920)
- No che-server logs in logs folder [\#3913](https://github.com/eclipse/che/issues/3913)
- Package is not displayed in the 'Select Path' form [\#3896](https://github.com/eclipse/che/issues/3896)
- Don't sort node interceptors at initialization state [\#3894](https://github.com/eclipse/che/issues/3894)
- Create SystemService [\#3892](https://github.com/eclipse/che/issues/3892)
- CLI - Create graceful and forced stop options [\#3886](https://github.com/eclipse/che/issues/3886)
- Change workspace idle timeout [\#3873](https://github.com/eclipse/che/issues/3873)
- Recipe url is not pasted in the field\(regression\) [\#3869](https://github.com/eclipse/che/issues/3869)
- Show/Hide Hidden Files feature works incorrectly  [\#3770](https://github.com/eclipse/che/issues/3770)
- Workaround illegal response from docker daemon [\#3761](https://github.com/eclipse/che/issues/3761)
- Change schema data type for project attributes [\#3758](https://github.com/eclipse/che/issues/3758)
- Decouple different agents on different maven modules [\#3720](https://github.com/eclipse/che/issues/3720)
- Revise ws-agent and ws-master war assembly for gwt dependencies that is not used [\#3718](https://github.com/eclipse/che/issues/3718)
- Chefile Dockerfile Error: Fail launching agent Terminal [\#3704](https://github.com/eclipse/che/issues/3704)
- Che nightly does not start on Windows 10 [\#3686](https://github.com/eclipse/che/issues/3686)
- Use consistent versions of Che images used between nightly/latest [\#3667](https://github.com/eclipse/che/issues/3667)
- Not consistent version of Che used with chedir utility [\#3666](https://github.com/eclipse/che/issues/3666)
- UD doesn't save changes on "save" if "apply" wasn't clicked and doesn't inform user that changes will be discarded [\#3565](https://github.com/eclipse/che/issues/3565)
- UD doesn't allow to restart WS if previous start failed [\#3545](https://github.com/eclipse/che/issues/3545)
- Chefile error: location is undefined in workspace.runtime.image.location [\#3317](https://github.com/eclipse/che/issues/3317)
- Chefile needs to support docker-compose file [\#3144](https://github.com/eclipse/che/issues/3144)
- Docker opens container log files many times, seems we don't close every time [\#2962](https://github.com/eclipse/che/issues/2962)
- Update style for popups in Dashboard [\#2813](https://github.com/eclipse/che/issues/2813)
- Chefile ip parameter [\#2787](https://github.com/eclipse/che/issues/2787)
- Pressing Enter key on a node inside FindUsage widget works incorrectly [\#1959](https://github.com/eclipse/che/issues/1959)
