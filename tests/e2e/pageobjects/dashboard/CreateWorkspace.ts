...
export class CreateWorkspace {
	...
	async setCreateNewWorkspaceCheckbox(
		...
		await this.driverHelper.wait(TIMEOUT_CONSTANTS.TS_SELENIUM_CLICK_ON_VISIBLE_ITEM); // tODO: remove after debug of losing text.
		await this.driverHelper.scrollTo(CreateWorkspace.CREATE_NEW_WORKPACE_CHECKBOX, timeout); // tODO: remove after debug of losing text.
		...
		await this.driverHelper.scrollTo(CreateWorkspace.CREATE_AND_OPEN_BUTTON, timeout); // tODO: remove after debug of losing text.
		await this.driverHelper.wait(TIMEOUT_CONSTANTS.TS_SELENIUM_CLICK_ON_VISIBLE_ITEM); // tODO: remove; wait for state change to take effect
	}
