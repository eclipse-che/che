...
export class KubernetesLoginPage implements ICheLoginPage {
    ...
    async login(): Promise<void> {
        ...
        await this.dexLoginPage.enterUserNameKubernetes(TestConstants.TS_SELENIUM_K8S_USERNAME);
        await this.dexLoginPage.enterPasswordKubernetes(TestConstants.TS_SELENIUM_K8S_PASSWORD);
