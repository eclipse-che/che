...
export const TestConstants = {
     ...
     */
    TS_LOGIN_NAME_OF_OPENSHIFT_REGULAR_USER: process.env.TS_LOGIN_NAME_OF_OPENSHIFT_REGULAR_USER || '',

    /**
     * Password for a user whom has been created in the test Openshift cluster. Need for Openshift connector test
     */
    TS_PASSWORD_OF_OPENSHIFT_REGULAR_USER: process.env.TS_PASSWORD_OF_OPENSHIFT_REGULAR_USER || '',
