...
public class BreakpointsTest {
  ...
  public void setUp() throws Exception {
    ...
    Location location =
        new LocationImpl(
            "/test/src/org/eclipse/BreakpointsTest.java", 19, false, null, "/test", null, -1);
  ...
  public void shouldAddBreakpointInsideMethod() throws Exception {
    Location location =
        new LocationImpl(
            "/test/src/org/eclipse/BreakpointsTest.java", 35, false, null, "/test", null, -1);
  ...
  public void shouldAddBreakpointByFqn() throws Exception {
    Location location =
        new LocationImpl("org.eclipse.BreakpointsTest", 20, false, null, "/test", null, -1);
  ...
  public void shouldAddBreakpointInsideInnerClass() throws Exception {
    Location location =
        new LocationImpl(
            "/test/src/org/eclipse/BreakpointsTest.java", 40, false, null, "/test", null, -1);
  ...
  public void shouldAddBreakpointInsideAnonymousClass() throws Exception {
    Location location =
        new LocationImpl(
            "/test/src/org/eclipse/BreakpointsTest.java", 24, false, null, "/test", null, -1);
  ...
  public void shouldAddBreakpointInsideLambdaFunction() throws Exception {
    Location location =
        new LocationImpl(
            "/test/src/org/eclipse/BreakpointsTest.java", 30, false, null, "/test", null, -1);
