...
public interface IDbgDataType {
    ...
    public enum DataType {
        ...
        PHP_BOOL("bool"), PHP_INT("int"), PHP_FLOAT("float"), PHP_STRING("string"), PHP_NULL("null"), PHP_ARRAY(
                "array"), PHP_OBJECT("object"), PHP_RESOURCE("resource"), PHP_VIRTUAL_CLASS("class"), PHP_UNINITIALIZED(
                        "<uninitialized>");
