...
public interface IDbgDataFacet {
    ...
    public enum Facet {
         ...
         */
        KIND_THIS, /**
                    * Facet indicating that corresponding element is super
                    * global variable.
                    */
        KIND_SUPER_GLOBAL, /**
                            * Facet indicating that corresponding element is
                            * local variable.
                            */
        KIND_LOCAL, /**
                     * Facet indicating that corresponding element is object
                     * member.
                     */
        KIND_OBJECT_MEMBER, /**
                             * Facet indicating that corresponding element is
        ...
        KIND_ARRAY_MEMBER, /**
                            ...
                            */
        KIND_RESOURCE, /**
                        * Facet indicating that corresponding element has public
                        * visibility.
                        */
        MOD_PUBLIC, /**
                     * Facet indicating that corresponding element has protected
                     * visibility.
                     */
        MOD_PROTECTED, /**
                        * Facet indicating that corresponding element has
                        * private visibility.
                        */
        MOD_PRIVATE, /**
                      * Facet indicating that corresponding element has static
                      * accessibility.
                      */
        MOD_STATIC, /**
                     * Facet indicating that corresponding element is 'virtual
                     * class'.
                     */
        VIRTUAL_CLASS, /**
                        * Facet indicating that corresponding element is
                        ...
                        */
        VIRTUAL_PARTITION, /**
                            * Facet indicating that corresponding element is an
                            * element length.
                            */
        VIRTUAL_LENGTH, /**
                         * Facet indicating that corresponding element is
