...
public class RunAllTestAction extends JavaEditorAction {
    ...
    @Inject
    public RunAllTestAction(JUnitTestResources resources, NotificationManager notificationManager, EditorAgent editorAgent,
                            TestResultPresenter presenter, FileTypeRegistry fileTypeRegistry, TestServiceClient service,
                            DtoUnmarshallerFactory dtoUnmarshallerFactory, JUnitTestLocalizationConstant localization) {
