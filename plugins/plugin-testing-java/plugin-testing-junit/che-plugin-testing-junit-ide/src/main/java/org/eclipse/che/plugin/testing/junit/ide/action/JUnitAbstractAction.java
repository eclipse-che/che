...
/**
 * Abstract action for JUnit test actions.
 */
public abstract class JUnitAbstractAction extends RunDebugTestAbstractAction {
    ...
    public JUnitAbstractAction(EventBus eventBus,
