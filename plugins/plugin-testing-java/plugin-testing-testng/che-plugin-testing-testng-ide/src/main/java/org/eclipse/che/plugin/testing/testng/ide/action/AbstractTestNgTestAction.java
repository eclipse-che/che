...
/** Abstract action which describes base TestNg action. */
public abstract class AbstractTestNgTestAction extends RunDebugTestAbstractAction {
  public static final String TESTNG_FRAMEWORK_NAME = "testng";

  private TestDetector testDetector;
  private AppContext appContext;

  public AbstractTestNgTestAction(
