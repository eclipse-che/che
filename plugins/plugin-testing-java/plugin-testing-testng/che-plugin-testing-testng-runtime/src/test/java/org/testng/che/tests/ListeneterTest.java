...
public class ListeneterTest {
    ...
    private CheTestNGListener createListener(StringBuffer buffer) {
        return new CheTestNGListener(new PrintStream(new OutputStream() {
            @Override
    ...
    private static class TestResult extends TestResultWrapper {
        ...
        public boolean equals(Object o) {
            ...
            if (className != null ? !className.equals(result.className) : result.className != null) return false;
            if (methodName != null ? !methodName.equals(result.methodName) : result.methodName != null) return false;
