...
public class ProjectClasspathProviderTest {
    ...
    private static ResourcesPlugin RESOURCE_PLUGIN = new ResourcesPlugin("target/test-classes/index", PROJECTS_PATH, () -> null, () -> null);
    ...
    public void classpathProviderShouldProvideClasspathPathsWithExternalDependencies() throws Exception {
        ...
        assertThat(classPath).isNotNull().isNotEmpty().contains(PROJECTS_PATH + "/testProject/target/classes", "/absolute/path/to/jar.file");
    }
    ...
    public void classpathProviderShouldProvideClasspathPathsWithAnotherProject() throws Exception {
        ...
        IClasspathEntry entry = mockClasspathEntry(IClasspathEntry.CPE_SOURCE, "/anotherProject/src", "/anotherProject/target/classes");
        ...
        IClasspathEntry classpathEntry = mockClasspathEntry(IClasspathEntry.CPE_SOURCE, "", "/testProject/target/classes");
        IClasspathEntry jarClasspathEntry = mockClasspathEntry(IClasspathEntry.CPE_LIBRARY, "/absolute/path/to/jar.file", null);
        ...
        assertThat(classPath).isNotNull().isNotEmpty().contains(PROJECTS_PATH + "/testProject/target/classes", "/absolute/path/to/jar.file", PROJECTS_PATH + "/anotherProject/target/classes");
