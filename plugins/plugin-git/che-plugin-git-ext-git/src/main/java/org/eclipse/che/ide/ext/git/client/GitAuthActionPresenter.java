...
public class GitAuthActionPresenter {
  ...
  public GitAuthActionPresenter(NotificationManager notificationManager,
  ...
  /**
   * Performs git operation. If this operations fails with authorization error the operation
