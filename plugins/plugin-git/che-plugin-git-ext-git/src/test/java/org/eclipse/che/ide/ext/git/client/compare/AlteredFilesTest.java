...
public class AlteredFilesTest {
    ...
    private static final String[] FILES            = {"Test1.java", "Test2.java", "Test3.java", "/dir/Test4.java"};
    private static final String[] STATUSES_STRINGS = {"A", "M", "D", "M"};
    private static final Status[] STATUSES         = Arrays.stream(STATUSES_STRINGS).map(FileStatus::defineStatus).toArray(Status[]::new);
