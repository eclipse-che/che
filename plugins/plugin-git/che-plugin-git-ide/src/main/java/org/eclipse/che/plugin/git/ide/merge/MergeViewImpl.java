 ...
 *******************************************************************************/
package org.eclipse.che.plugin.git.ide.merge;
...
import static org.eclipse.che.plugin.git.ide.merge.Reference.RefType.LOCAL_BRANCH;
import static org.eclipse.che.plugin.git.ide.merge.Reference.RefType.REMOTE_BRANCH;
...
public class MergeViewImpl extends Window implements MergeView {
    ...
    protected MergeViewImpl(GitResources resources, GitLocalizationConstant locale, ReferenceTreeNodeRenderer.Resources rendererResources) {
        ...
        localBranch = new Reference(MergePresenter.LOCAL_BRANCHES_TITLE, MergePresenter.LOCAL_BRANCHES_TITLE, LOCAL_BRANCH);

        remoteBranch = new Reference(MergePresenter.REMOTE_BRANCHES_TITLE, MergePresenter.REMOTE_BRANCHES_TITLE, REMOTE_BRANCH);
