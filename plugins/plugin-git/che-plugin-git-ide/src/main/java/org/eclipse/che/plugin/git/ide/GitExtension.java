 ...
 *******************************************************************************/
package org.eclipse.che.plugin.git.ide;
...
import org.eclipse.che.plugin.git.ide.action.AddToIndexAction;
import org.eclipse.che.plugin.git.ide.action.CheckoutReferenceAction;
import org.eclipse.che.plugin.git.ide.action.CommitAction;
import org.eclipse.che.plugin.git.ide.action.CompareWithBranchAction;
import org.eclipse.che.plugin.git.ide.action.CompareWithLatestAction;
import org.eclipse.che.plugin.git.ide.action.CompareWithRevisionAction;
import org.eclipse.che.plugin.git.ide.action.DeleteRepositoryAction;
import org.eclipse.che.plugin.git.ide.action.FetchAction;
import org.eclipse.che.plugin.git.ide.action.HistoryAction;
import org.eclipse.che.plugin.git.ide.action.InitRepositoryAction;
import org.eclipse.che.plugin.git.ide.action.PullAction;
import org.eclipse.che.plugin.git.ide.action.PushAction;
import org.eclipse.che.plugin.git.ide.action.RemoveFromIndexAction;
import org.eclipse.che.plugin.git.ide.action.ResetFilesAction;
import org.eclipse.che.plugin.git.ide.action.ResetToCommitAction;
import org.eclipse.che.plugin.git.ide.action.ShowBranchesAction;
import org.eclipse.che.plugin.git.ide.action.ShowMergeAction;
import org.eclipse.che.plugin.git.ide.action.ShowRemoteAction;
import org.eclipse.che.plugin.git.ide.action.ShowStatusAction;
