...
public class ComparePresenter implements CompareView.ActionDelegate {
     ...
     */
    public void show(final File file, final FileStatus.Status status, final String revision) {
        this.comparedFile = file;
        this.revision = revision;

        if (status.equals(FileStatus.Status.ADDED)) {
            showCompare("");
            return;
        }
        ...
        if (status.equals(FileStatus.Status.DELETED)) {
