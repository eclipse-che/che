 ...
 *******************************************************************************/
package org.eclipse.che.plugin.git.ide.compare.changedList;
...
public class ChangedListViewImpl extends Window implements ChangedListView {
    ...
    @Override
    public void viewChangedFilesAsList(@NotNull Map<String, FileStatus.Status> items) {
    ...
    @Override
    public void viewChangedFilesAsTree(@NotNull Map<String, FileStatus.Status> items) {
        tree.getNodeStorage().clear();
    ...
    private List<Node> getGroupedNodes(Map<String, FileStatus.Status> items) {
