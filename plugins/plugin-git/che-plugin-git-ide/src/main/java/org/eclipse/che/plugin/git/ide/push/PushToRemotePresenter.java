 ...
 *******************************************************************************/
package org.eclipse.che.plugin.git.ide.push;
...
import org.eclipse.che.plugin.git.ide.BranchFilterByRemote;
...
import static org.eclipse.che.plugin.git.ide.compare.branchList.BranchListPresenter.BRANCH_LIST_COMMAND_NAME;
import static org.eclipse.che.plugin.git.ide.remote.RemotePresenter.REMOTE_REPO_COMMAND_NAME;
