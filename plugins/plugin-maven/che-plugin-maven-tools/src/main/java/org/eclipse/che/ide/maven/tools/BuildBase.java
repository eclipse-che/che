...
public class BuildBase {
     ...
     * <p/>
     * If {@code finalName} is {@code null} and this build instance is associated with
     * xml element then {@code finalName} will be removed from model as well as from xml.
     *
     * @param finalName
     *         new final name
     */
     ...
     * <p/>
     * If {@code defaultGoal} is {@code null} and this build instance is associated with
     * xml element then {@code defaultGoal} will be removed from model as well as from xml.
     *
     * @param defaultGoal
     *         new default goal
     */
    public BuildBase setDefaultGoal(String defaultGoal) {
        ...
        if (!isNew()) {
            if (isNullOrEmpty(defaultGoal)) {
                ...
                element.insertChild(createElement("defaultGoal", defaultGoal), after("finalName").or(inTheEnd()));
            }
        }
        return this;
    }
    ...
    /**
     * Sets build test resources, each resource contains information about where
     * associated with project test files should be included.
     * <p/>
     * If {@code resources} is {@code null} or <i>empty</i> and this build instance is associated with
     * xml element then {@code resources} will be removed from model as well as from xml.
     *
     * @param testResources
     *         new build test resources
     * @return this build instance
     */
