...
public class Profile {
     ...
     *
     * @param id
     *         new profile identifier, if it is {@code null} then <i>id</i> element will be removed from xml if exists
     */
    ...
    /**
     * Returns profile properties or empty map when the profile
     ...
     * <p/>
     * <b>Note: all existing repositories will be removed from profile and xml as well</b>
     *
     * @param repositories
     ...
     * from profile and from xml as well
     *
    ...
    public Profile setDependencyManagement(DependencyManagement dependencyManagement) {
        ...
        if (dependencyManagement == null) {
            ...
            if (element.hasSingleChild("dependencyManagement") && dependencyManagementElement != null) {
                ...
                element.insertChild(this.dependencyManagement.asXMLElement(), beforeAnyOf("dependencies").or(inTheEnd()));
                dependencyManagement.dmElement = dependencyManagementElement;
            }
        }
        return this;
    ...
    private Profile addRepository(Repository repository) {
        ...
        if (element.hasSingleChild("repositories") && repositoriesElement != null) {
            ...
            element.insertChild(createElement("repositories", repository.asXMLElement()),
