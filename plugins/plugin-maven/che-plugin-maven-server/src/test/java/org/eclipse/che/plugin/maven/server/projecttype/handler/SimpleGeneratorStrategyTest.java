...
public class SimpleGeneratorStrategyTest {
  ...
  //    simple = new SimpleGeneratorStrategy(fileSystemManager);
  //  }
  //
  //  @Test
  ...
  //
  //    simple.generateProject(org.eclipse.che.api.fs.Path.of("my_project"), attributeValues, null);
  //
