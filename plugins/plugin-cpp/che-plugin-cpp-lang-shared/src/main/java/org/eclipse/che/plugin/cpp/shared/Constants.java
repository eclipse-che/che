...
public final class Constants {
  ...
  /** C Project Type ID */
  public static final String C_PROJECT_TYPE_ID = "c";
  /** C++ Project Type ID */
  public static final String CPP_PROJECT_TYPE_ID = "cpp";
  /** C Language */
  public static final String C_LANG = "c_lang";
  /** C++ Language */
  public static final String CPP_LANG = "cpp_lang";
  /** Default extension for C files */
  public static final String C_EXT = "c";
