...
import static org.eclipse.che.ide.gdb.client.configuration.GdbConfigurationPagePresenter.BIN_PATH_CONNECTION_PROPERTY;
...
public class GdbConfigurationPagePresenterTest {
    ...
    public void testOnBinaryPathChanged() throws Exception {
        ...
        assertEquals(binPath, argumentCaptorValue.get(BIN_PATH_CONNECTION_PROPERTY));
