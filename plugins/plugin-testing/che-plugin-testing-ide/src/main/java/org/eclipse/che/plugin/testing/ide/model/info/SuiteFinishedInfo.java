...
public class SuiteFinishedInfo extends AbstractTestStateInfo {
    ...
    public static final SuiteFinishedInfo PASSED_SUITE = new SuiteFinishedInfo() {
        @Override
    ...
    public static final SuiteFinishedInfo FAILED_SUITE = new SuiteFinishedInfo() {
        @Override
    ...
    public static final SuiteFinishedInfo IGNORED_TEST_SUITE = new SuiteFinishedInfo() {
        @Override
        public boolean isProblem() {
            return true;
        }
    ...
    public static final SuiteFinishedInfo ERROR_SUITE = new SuiteFinishedInfo() {
        @Override
        public boolean isProblem() {
            return true;
        }
    ...
    public static final SuiteFinishedInfo EMPTY_LEAF_SUITE = new EmptySuite() {
        @Override
    ...
    public static final SuiteFinishedInfo TESTS_REPORTER_NOT_ATTACHED = new SuiteFinishedInfo() {
        @Override
        public boolean isProblem() {
            return false;
        }
