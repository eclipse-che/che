 ...
 *******************************************************************************/
package org.eclipse.che.plugin.orion.editor.ide.requirejs;

import com.google.gwt.core.client.JavaScriptObject;
import com.google.gwt.core.client.JsArrayString;

import org.eclipse.che.plugin.orion.editor.ide.requirejs.config.RequirejsConfig;
...
public class Requirejs extends JavaScriptObject {
    ...
    public final native void require(JsArrayString deps, RequirejsCallback callback, RequirejsErrorHandler errorHandler) /*-{
        var realCallback = function() {
            ...
            callback.@org.eclipse.che.plugin.orion.editor.ide.requirejs.RequirejsCallback::onReady(Lcom/google/gwt/core/client/JsArray;)(param);
        };
        var realErrHandler = function(err) {
            if (errorHandler) {
                errorHandler.@org.eclipse.che.plugin.orion.editor.ide.requirejs.RequirejsErrorHandler::onError(Lorg/eclipse/che/plugin/orion/editor/ide/requirejs/RequirejsErrorHandler$RequireError;)(err);
            } else {
    ...
    public final native void setOnError(RequirejsErrorHandler handler) /*-{
        this.onError = function(err) {
            handler.@org.eclipse.che.plugin.orion.editor.ide.requirejs.RequirejsErrorHandler::onError(Lorg/eclipse/che/plugin/orion/editor/ide/requirejs/RequirejsErrorHandler$RequireError;)(err);
        };
    }-*/;
}