 ...
 *******************************************************************************/
package org.eclipse.che.plugin.orion.editor.ide;
...
import org.eclipse.che.plugin.orion.editor.ide.events.HasScrollHandlers;
import org.eclipse.che.plugin.orion.editor.ide.events.ScrollEvent;
import org.eclipse.che.plugin.orion.editor.ide.events.ScrollHandler;
import org.eclipse.che.plugin.orion.editor.ide.incremental.find.IncrementalFindReportStatusObserver;
import org.eclipse.che.plugin.orion.editor.ide.message.StatusMessageReporter;
import org.eclipse.che.plugin.orion.editor.ide.jso.OrionEditorOptionsOverlay;
import org.eclipse.che.plugin.orion.editor.ide.jso.OrionAnnotationModelOverlay;
import org.eclipse.che.plugin.orion.editor.ide.jso.OrionAnnotationOverlay;
import org.eclipse.che.plugin.orion.editor.ide.jso.OrionCodeEditWidgetOverlay;
import org.eclipse.che.plugin.orion.editor.ide.jso.OrionContentAssistOverlay;
import org.eclipse.che.plugin.orion.editor.ide.jso.OrionEditorOverlay;
import org.eclipse.che.plugin.orion.editor.ide.jso.OrionEditorViewOverlay;
import org.eclipse.che.plugin.orion.editor.ide.jso.OrionEventTargetOverlay;
import org.eclipse.che.plugin.orion.editor.ide.jso.OrionExtRulerOverlay;
import org.eclipse.che.plugin.orion.editor.ide.jso.OrionInputChangedEventOverlay;
import org.eclipse.che.plugin.orion.editor.ide.jso.OrionKeyBindingsRelationOverlay;
import org.eclipse.che.plugin.orion.editor.ide.jso.OrionKeyModeOverlay;
import org.eclipse.che.plugin.orion.editor.ide.jso.OrionKeyStrokeOverlay;
import org.eclipse.che.plugin.orion.editor.ide.jso.OrionProblemOverlay;
import org.eclipse.che.plugin.orion.editor.ide.jso.OrionRulerClickEventOverlay;
import org.eclipse.che.plugin.orion.editor.ide.jso.OrionSelectionOverlay;
import org.eclipse.che.plugin.orion.editor.ide.jso.OrionStyleOverlay;
import org.eclipse.che.plugin.orion.editor.ide.jso.OrionTextViewOverlay;
import org.eclipse.che.plugin.orion.editor.ide.jso.StatusMessageReporterOverlay;
import org.eclipse.che.plugin.orion.editor.ide.jso.UiUtilsOverlay;
...
import org.eclipse.che.plugin.orion.editor.ide.requirejs.ModuleHolder;
...
public class OrionEditorWidget extends CompositeEditorWidget implements HasChangeHandlers,
    ...
    private class EditorViewCreatedOperation implements Operation<OrionEditorViewOverlay> {
        ...
        public void apply(OrionEditorViewOverlay arg) throws OperationException {
            ...
            keyModeInstances.add(KeyMode.VI, OrionKeyModeOverlay.getViKeyMode(moduleHolder.getModule("OrionVi"), textView));
            keyModeInstances.add(KeyMode.EMACS, OrionKeyModeOverlay.getEmacsKeyMode(moduleHolder.getModule("OrionEmacs"), textView));
    ...
    private native void registerPromptFunction() /*-{
        if (!$wnd["promptIDE"]) {
            ...
            $wnd["promptIDE"] = function(title, text, defaultValue, callback) {
                instance.@org.eclipse.che.plugin.orion.editor.ide.OrionEditorWidget::askLineNumber(*)(title, text, defaultValue, callback);
            };
        }
    }-*/;
    ...
    private class InputCallback implements org.eclipse.che.ide.api.dialogs.InputCallback {
        ...
        public native void accepted(String value) /*-{
            var callback = this.@org.eclipse.che.plugin.orion.editor.ide.OrionEditorWidget.InputCallback::callback;
            callback(value);
        }-*/;
