 ...
 *******************************************************************************/
package org.eclipse.che.plugin.orion.editor.ide.jso;

import elemental.dom.Element;

import com.google.gwt.core.client.JavaScriptObject;

import org.eclipse.che.plugin.orion.editor.ide.Action;
...
public class OrionTextViewOverlay extends JavaScriptObject {
    ...
    public final native boolean showSelection(double additionalFractionScroll, SimpleCallBack callback) /*-{
        return this.showSelection(additionalFractionScroll, function () {
            callback.@org.eclipse.che.plugin.orion.editor.ide.jso.OrionTextViewOverlay.SimpleCallBack::onFinished()();
        });
    }-*/;
    ...
    public final native void setAction(String actionId, Action action) /*-{
        this.setAction(actionId, function () {
            return action.@org.eclipse.che.plugin.orion.editor.ide.Action::onAction()();
        });
    }-*/;
    ...
    public final native void addEventListener(String eventType, EventHandlerNoParameter handler, boolean useCapture) /*-{
        this.addEventListener(eventType, function () {
            handler.@org.eclipse.che.plugin.orion.editor.ide.jso.OrionTextViewOverlay.EventHandlerNoParameter::onEvent()();
        }, useCapture);
    }-*/;
    ...
    public final native <T extends OrionEventOverlay> void addEventListener(String eventType, EventHandler<T> handler,
        ...
        var func = function (param) {
            handler.@org.eclipse.che.plugin.orion.editor.ide.jso.OrionTextViewOverlay.EventHandler::onEvent(*)(param);
        };
