...
import org.eclipse.che.plugin.orion.editor.ide.jso.OrionServiceRegistryOverlay;
...
public class OrionHoverRegistrant {
    ...
    @Inject
    public OrionHoverRegistrant(Provider<OrionCodeEditWidgetOverlay> codeEditWidgetProvider,
    ...
    public void registerHover(final JsArrayString contentTypes, final OrionHoverHandler handler) {
        editorModule.getInitializerPromise().then(new Operation<Void>() {
            ...
            public void apply(Void arg) throws OperationException {
                registerHover(codeEditWidgetProvider.get().getServiceRegistry(), contentTypes, handler);
            }
        });
    }

    private final native void registerHover(OrionServiceRegistryOverlay serviceRegistry, JsArrayString contentTypes,
