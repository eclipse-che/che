 ...
 * https://bugs.eclipse.org/bugs/show_bug.cgi?id=241696 Lukas Hanke <hanke@yatta.de> - Bug 430818
 * [1.8][quick fix] Quick fix for "for loop" is not shown for bare local variable/argument/field -
 * https://bugs.eclipse.org/bugs/show_bug.cgi?id=430818
 * *****************************************************************************
 */
...
public class LocalCorrectionsQuickFixTest extends QuickFixTest {
   ...
   * variable/argument/field caused by: Bug 430336: [1.8][compiler] Bad syntax error recovery:
  ...
  public void testUnusedVariable4() throws Exception {
    ...
    hashtable.put(JavaCore.COMPILER_PB_UNUSED_PARAMETER, JavaCore.ERROR);
    hashtable.put(
        JavaCore.COMPILER_PB_UNUSED_PARAMETER_INCLUDE_DOC_COMMENT_REFERENCE, JavaCore.DISABLED);
    JavaCore.setOptions(hashtable);
  ...
  public void testIndirectStaticAccess_bug40880() throws Exception {
    ...
    buf.append("}\n");
    pack1.createCompilationUnit(
        "ToolConfigurationSettingsConstants.java", buf.toString(), false, null);
  ...
  public void testAddTypeParametersToClassInstanceCreationTest02() throws Exception {
    ...
    buf.append("    public void foo() {\n");
    buf.append(
        "        List<List<Hashtable<Integer, HashSet<E>>>> l= new ArrayList<List<Hashtable<Integer, HashSet<E>>>>(); \n");
    buf.append("    }\n");
    buf.append("}\n");
    expected[0] = buf.toString();
  ...
  public void testMissingAnnotationAttributes_bug179316() throws Exception {
    ...
    buf.append("}\n");
    ICompilationUnit cu =
        pack1.createCompilationUnit("Requires1.java", buf.toString(), false, null);
  ...
  public void testMissingHashCode2() throws Exception {
    ...
    assertEquals(
        0,
        astRoot.getProblems().length); // see https://bugs.eclipse.org/bugs/show_bug.cgi?id=38751#c7
  }
  ...
  public void testGenerateForeachNotAddedForLowVersion() throws Exception {
    ...
    try {
      ...
      assertProposalDoesNotExist(
          proposals, CorrectionMessages.QuickAssistProcessor_generate_enhanced_for_loop);
