...
public class RenameTypeTest extends RefactoringTest {
  ...
  private String[] helper2_0(
      String oldName, String newName, String newCUName, boolean updateReferences) throws Exception {
  ...
  private void helper3_fail(
    ...
    RefactoringDescriptor descriptor =
        initWithAllOptions(
            ...
            updateSimilar,
            null,
            RenamingNameSuggestor.STRATEGY_SUFFIX);
    Assert.assertNotNull("was supposed to fail", performRefactoring(descriptor));
  }
  ...
  private void checkResultInClass(String typeName) throws JavaModelException, IOException {
    ...
    TestCase.assertTrue("cu " + newcu.getElementName() + " does not exist", newcu.exists());
    assertEqualLines(
        "invalid renaming", getFileContents(getOutputTestFileName(typeName)), newcu.getSource());
  }

  private void setSomeFieldOptions(
      IJavaProject project, String prefixes, String suffixes, boolean forStatic) {
    if (forStatic) {
  ...
  public void testWrongArg1() throws Exception {
    ...
    Assert.assertNotNull("empty name was supposed to trigger IAE", result);
  }
  ...
  public void testFailRegression1GCRKMQ() throws Exception {
    IPackageFragment myPackage =
        getRoot().createPackageFragment("", true, new NullProgressMonitor());
  ...
  public void test20() throws Exception {
    ...
    assertEqualLines(
        "invalid renaming", getFileContents(getOutputTestFileName("B")), newcu.getSource());
  }
  ...
  public void test30() throws Exception {
    ...
    assertEqualLines(
        "invalid renaming A", getFileContents(getOutputTestFileName("B")), newcu.getSource());
    assertEqualLines(
        "invalid renaming AA", getFileContents(getOutputTestFileName("AA")), newcuAA.getSource());
  }
  ...
  public void test63() throws Exception {
    ...
    assertEqualLines(
        "invalid renaming in another.p.A",
        getFileContents(getOutputTestFileName(type, folder)),
        cu.getSource());
  }
  ...
  public void testEnum3() throws Exception {
    ...
    helper2("A", "B");
    assertEqualLines(
        "invalid renaming in Enumbered",
        getFileContents(getOutputTestFileName("Enumbered")),
        enumbered.getSource());
  }
  ...
  public void testSimilarElements19() throws Exception {
    ...
    helper3_fail(
        "ThreeHunkClass", "TwoHunk", true, false, true, RenamingNameSuggestor.STRATEGY_SUFFIX);
  }
  ...
  public void testSimilarElements22() throws Exception {
    ...
    IField inInitializer =
        someClass.getInitializer(1).getType("InInitializer", 1).getField("someClassInInitializer");
