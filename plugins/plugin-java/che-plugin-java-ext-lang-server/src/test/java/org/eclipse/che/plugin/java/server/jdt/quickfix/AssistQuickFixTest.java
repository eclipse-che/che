 ...
 * <sdavids@gmx.de> - testInvertEquals1-23 Lukas Hanke <hanke@yatta.de> - Bug 241696 [quick fix]
 * quickfix to iterate over a collection - https://bugs.eclipse.org/bugs/show_bug.cgi?id=241696
 * Lukas Hanke <hanke@yatta.de> - Bug 430818 [1.8][quick fix] Quick fix for "for loop" is not shown
 * for bare local variable/argument/field - https://bugs.eclipse.org/bugs/show_bug.cgi?id=430818
 * *****************************************************************************
 */
...
public class AssistQuickFixTest extends QuickFixTest {
  ...
  private static final String CHANGE_MODIFIER_TO_FINAL =
  ...
  private static final Class[] FILTER_EQ = {
    LinkedNamesAssistProposal.class, /* RenameRefactoringProposal.class,*/
  ...
  public void testMakeFinal06() throws Exception {
    ...
    assertExpectedExistInProposals(
        proposals, new String[] {null}); // Wrap in buf.append() (to clipboard)
  }
