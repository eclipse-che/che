 ...
 * (reports 71244 & 74746: New Quick Assist's [quick assist]) Benjamin Muskalla
 * (buskalla@innoopract.com) - 104021: [quick fix] Introduce new local with casted type applied more
 * than once Billy Huang <billyhuang31@gmail.com> - [quick assist] concatenate/merge string literals
...
public class AdvancedQuickAssistTest extends QuickFixTest {
  ...
  public void testAddParenthesesForExpression6() throws Exception {
    ...
    AssistContext context =
        getCorrectionContext(cu, buf.toString().indexOf("a > 3"), "a > 3".length());
    List proposals = collectAssists(context, false);
  ...
  public void testReplaceReturnIfWithCondition2() throws Exception {
    try {
      ...
      buf.append("    public Number foo(Integer integer) {\n");
      buf.append(
          "        return integer != null ? integer : (Number) new Double(Double.MAX_VALUE);\n");
      buf.append("    }\n");
      buf.append("}\n");
      String expected1 = buf.toString();
  ...
  public void testCombineStringsProposals3() throws Exception {
    ...
    assertProposalDoesNotExist(
        proposals, CorrectionMessages.AdvancedQuickAssistProcessor_combineSelectedStrings);
  }
