...
public class Word {
	...
	public static Map<String, String> splitCXD(String originalName, String subsequentName, String candidateName) {
		Map<String, String> map = new HashMap<String, String>();
		...
		if(x.equals("")){
			...
			String tempC = "";
			String tempD = "";
			if(candidateName.indexOf(x) > 0) tempC = candidateName.substring(0, candidateName.indexOf(x));
