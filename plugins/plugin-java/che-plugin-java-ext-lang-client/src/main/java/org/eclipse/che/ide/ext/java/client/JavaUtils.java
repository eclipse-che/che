...
public class JavaUtils {
    ...
    private static final String ABSTRACT                    = "^abstract$|^abstract\\..*|.*\\.abstract\\..*|.*\\.abstract$";
    ...
    private static final String CONTINUE                    = "^continue$|^continue\\..*|.*\\.continue\\..*|.*\\.continue$";
    ...
    private static final String INSTANCE_OF                 = "^instanceof$|^instanceof\\..*|.*\\.instanceof\\..*|.*\\.instanceof$";
    ...
    private static final String PROTECTED                   = "^protected$|^protected\\..*|.*\\.protected\\..*|.*\\.protected$";
    ...
    private static final String STRICTFP                    = "^strictfp$|^strictfp\\..*|.*\\.strictfp\\..*|.*\\.strictfp$";
    private static final String SUPER                       = "^super$|^super\\..*|.*\\.super\\..*|.*\\.super$";
    private static final String SWITCH                      = "^switch$|^switch\\..*|.*\\.switch\\..*|.*\\.switch$";
    private static final String SYNCHRONIZED                = "^synchronized$|^synchronized\\..*|.*\\.synchronized\\..*|.*\\.synchronized$";
    ...
    private static final String TRANSIENT                   = "^transient$|^transient\\..*|.*\\.transient\\..*|.*\\.transient$";
    private static final String TRY                         = "^try$|^try\\..*|.*\\.try\\..*|.*\\.try$";
    private static final String VOID                        = "^void$|^void\\..*|.*\\.void\\..*|.*\\.void$";
    private static final String VOLATILE                    = "^volatile$|^volatile\\..*|.*\\.volatile\\..*|.*\\.volatile$";
    private static final String WHILE                       = "^while$|^while\\..*|.*\\.while\\..*|.*\\.while$";
    private static final String IF                          = "^if$|^if\\..*|.*\\.if\\..*|.*\\.if$";
    private static final String IMPLEMENTS                  = "^implements$|^implements\\..*|.*\\.implements\\..*|.*\\.implements$";
    private static final String INTERFACE                   = "^interface$|^interface\\..*|.*\\.interface\\..*|.*\\.interface$";
    private static final String LONG                        = "^long$|^long\\..*|.*\\.long\\..*|.*\\.long$";
    private static final String NATIVE                      = "^native$|^native\\..*|.*\\.native\\..*|.*\\.native$";
    private static final String RESERVED_WORDS              = "(?!" + ABSTRACT +
                                                              "|" + ASSERT +
                                                              "|" + BOOLEAN +
                                                              "|" + BREAK +
                                                              "|" + BYTE +
