...
@Singleton
@DynaObject
public class FindUsagesPresenterJls extends BasePresenter implements BaseActionDelegate {

  private WorkspaceAgent workspaceAgent;
  private JavaLocalizationConstant localizationConstant;
  private FindUsagesViewImplJls view;
  ...
  @Inject
  public FindUsagesPresenterJls(
      WorkspaceAgent workspaceAgent,
      JavaLocalizationConstant localizationConstant,
      FindUsagesViewImplJls view,
