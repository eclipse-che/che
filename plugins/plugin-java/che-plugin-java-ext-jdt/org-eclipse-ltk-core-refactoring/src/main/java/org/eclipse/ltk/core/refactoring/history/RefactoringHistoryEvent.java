 ...
 *
 * <p>Refactoring history listeners must be prepared to receive notifications from a background
...
public final class RefactoringHistoryEvent {
  ...
  /**
   * Event type indicating that a refactoring descriptor has been pushed to the history stack (value
   * 1)
   */
