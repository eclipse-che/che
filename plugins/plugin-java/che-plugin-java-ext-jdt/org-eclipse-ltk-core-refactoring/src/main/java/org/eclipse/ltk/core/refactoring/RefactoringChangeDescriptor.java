...
/**
 * A {@link RefactoringChangeDescriptor} describes changes created by a refactoring. Changes created
 * by a refactoring should provide an appropriate refactoring change descriptor, which allows to
 * completely reconstruct the particular refactoring instance from the encapsulated refactoring
 * descriptor.
 *
