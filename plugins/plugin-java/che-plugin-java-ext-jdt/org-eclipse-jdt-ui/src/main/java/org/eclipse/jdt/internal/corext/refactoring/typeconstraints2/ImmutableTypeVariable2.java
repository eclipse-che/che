...
/**
 * A ImmutableTypeVariable is a ConstraintVariable which stands for an immutable type (without an
 * updatable Source location)
 */
public final class ImmutableTypeVariable2 extends ConstraintVariable2 {
  ...
  public boolean equals(Object other) {
    ...
    if (other.getClass() != ImmutableTypeVariable2.class) return false;
