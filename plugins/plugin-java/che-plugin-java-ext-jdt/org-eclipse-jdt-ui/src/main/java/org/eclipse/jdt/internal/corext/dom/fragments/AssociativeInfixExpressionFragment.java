...
class AssociativeInfixExpressionFragment extends ASTFragment implements IExpressionFragment {
	...
	public static IExpressionFragment createSubPartFragmentBySourceRange(InfixExpression node, ISourceRange range, ICompilationUnit cu)
	...
	private static boolean rangeIncludesExtraNonWhitespace(ISourceRange range, List<Expression> operands, ICompilationUnit cu) throws
																															   JavaModelException {
