...
public interface IHtmlTagConstants {
  ...
  /** Html entity codes */
  public static final String[] HTML_ENTITY_CODES =
      new String[] {
        "&lt;", "&gt;", "&nbsp;", "&amp;", "&circ;", "&tilde;", "&quot;"
  ...
  /** Html general tags */
  public static final String[] HTML_GENERAL_TAGS =
      new String[] {
        "a",
        "b",
        "blockquote",
  ...
  // //$NON-NLS-13$ //$NON-NLS-14$ //$NON-NLS-15$ //$NON-NLS-16$ //$NON-NLS-17$
  // //$NON-NLS-18$ //$NON-NLS-19$ //$NON-NLS-20$ //$NON-NLS-21$ //$NON-NLS-22$
  // //$NON-NLS-23$ //$NON-NLS-24$ //$NON-NLS-25$ //$NON-NLS-26$ //$NON-NLS-27$
  // //$NON-NLS-28$ //$NON-NLS-29$ //$NON-NLS-30$
