...
public final class UseSupertypeDescriptor extends JavaRefactoringDescriptor {
	...
	public UseSupertypeDescriptor(String project, String description, String comment, Map arguments, int flags) {
		...
		fSupertype= (IType) JavaRefactoringDescriptorUtil
				.getJavaElement(arguments, JavaRefactoringDescriptorUtil.getAttributeName(ATTRIBUTE_ELEMENT, 1), project);
	}
	...
	protected void populateArgumentMap() {
		...
		JavaRefactoringDescriptorUtil
				.setJavaElement(fArguments, JavaRefactoringDescriptorUtil.getAttributeName(ATTRIBUTE_ELEMENT, 1), getProject(), fSupertype);
	}
