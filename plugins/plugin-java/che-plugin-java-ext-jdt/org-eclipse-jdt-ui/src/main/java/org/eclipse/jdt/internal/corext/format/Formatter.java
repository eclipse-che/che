...
public class Formatter {
     ...
     *
     * @param formatter
     *         The file with custom formatter settings
     * @param content
    ...
    public List<Change> getFormatChanges(IFile formatter, String content, int offset, int length)
        ...
        TextEdit textEdit = CodeFormatterUtil.format2(CodeFormatter.K_COMPILATION_UNIT, content, offset, length, 0, null, options);
