...
public class ExtractToNullCheckedLocalProposal extends LinkedCorrectionProposal {
			...
			public void insertIfStatement(IfStatement ifStmt, Block thenBlock) {
				...
				if (stmtIdx != -1 && stmtIdx < lastIdx) {
					thenBlock.statements()
							 .add(this.blockRewrite
										  .createMoveTarget(blockStmts.get(stmtIdx + 1), blockStmts.get(lastIdx), null, this.group));
				}
	...
	public ExtractToNullCheckedLocalProposal(ICompilationUnit cu, CompilationUnit compilationUnit, SimpleName fieldReference,
