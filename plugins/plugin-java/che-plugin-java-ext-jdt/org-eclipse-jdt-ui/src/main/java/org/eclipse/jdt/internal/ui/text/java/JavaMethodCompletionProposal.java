...
//			setUpLinkedMode(document, ';');
	...
	protected final boolean canAutomaticallyAppendSemicolon() {
		return !fProposal.isConstructor() && CharOperation
                .equals(new char[]{Signature.C_VOID}, Signature.getReturnType(fProposal.getSignature()));
	}
...
//		IPreferenceStore preferenceStore= JavaPlugin.getDefault().getPreferenceStore();
		boolean noOverwrite= /*preferenceStore.getBoolean(PreferenceConstants.CODEASSIST_INSERT_COMPLETION)*/ true ^ isToggleEating();
