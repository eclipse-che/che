...
public class CodeStyleCleanUp extends AbstractMultiFix {
	...
	protected ICleanUpFix createFix(CompilationUnit compilationUnit) throws CoreException {
		...
		return CodeStyleFix.createCleanUp(compilationUnit,
										  ...
										  nonStaticMethods && isEnabled(CleanUpConstants
	...
	public boolean canFix(ICompilationUnit compilationUnit, IProblemLocation problem) {
		...
		if (CodeStyleFix.isIndirectStaticAccess(problem))
			return isEnabled(CleanUpConstants.MEMBER_ACCESSES_STATIC_QUALIFY_WITH_DECLARING_CLASS) && isEnabled(CleanUpConstants
