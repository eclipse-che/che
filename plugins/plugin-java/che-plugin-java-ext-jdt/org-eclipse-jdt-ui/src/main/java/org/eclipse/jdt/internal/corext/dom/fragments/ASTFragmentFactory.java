...
public class ASTFragmentFactory {
	 ...
	 */
	public static IASTFragment createFragmentForSourceRange(ISourceRange range, ASTNode scope, ICompilationUnit cu) throws
																													JavaModelException {
	...
	private static boolean rangeIncludesNonWhitespaceOutsideNode(ISourceRange range, ASTNode node, ICompilationUnit cu) throws
																														JavaModelException {
	 ...
	 * fragment.
	 */
	private static IASTFragment createFragmentForSubPartBySourceRange(ASTNode node, ISourceRange range, ICompilationUnit cu) throws
																															 JavaModelException {
	...
	private static class FragmentForSubPartBySourceRangeFactory extends FragmentFactory {
		...
		private static IExpressionFragment createInfixExpressionSubPartFragmentBySourceRange(InfixExpression node, ISourceRange range,
																							 ICompilationUnit cu)
				throws JavaModelException {
