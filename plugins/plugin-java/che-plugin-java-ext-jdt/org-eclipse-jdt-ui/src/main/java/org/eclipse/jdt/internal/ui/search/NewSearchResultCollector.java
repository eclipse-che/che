...
public class NewSearchResultCollector extends SearchRequestor {
    ...
    public void acceptSearchMatch(SearchMatch match) throws CoreException {
        ...
        if (enclosingElement != null) {
            ...
            fSearch.addMatch(
                    new JavaElementMatch(enclosingElement, match.getRule(), match.getOffset(), match.getLength(), match.getAccuracy(),
                                         isReadAccess, isWriteAccess, match.isInsideDocComment(), isSuperInvocation));
        }
    }
