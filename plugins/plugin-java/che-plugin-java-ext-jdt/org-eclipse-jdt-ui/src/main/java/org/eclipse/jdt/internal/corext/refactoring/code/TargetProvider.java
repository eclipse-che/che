...
abstract class TargetProvider {
	...
	public abstract ICompilationUnit[] getAffectedCompilationUnits(RefactoringStatus status, ReferencesInBinaryContext binaryRefs, IProgressMonitor pm)  throws
	...
	static class ErrorTargetProvider extends TargetProvider {
		...
		@Override
		public ICompilationUnit[] getAffectedCompilationUnits(RefactoringStatus status, ReferencesInBinaryContext binaryRefs, IProgressMonitor pm) throws
																																				   JavaModelException {
			return null;
		}
		@Override
	...
	static class SingleCallTargetProvider extends TargetProvider {
		...
		@Override
		public ICompilationUnit[] getAffectedCompilationUnits(RefactoringStatus status, ReferencesInBinaryContext binaryRefs,
															  IProgressMonitor pm) {
