...
public class ControlStatementsFix extends CompilationUnitRewriteOperationsFix {
	...
	static class RemoveBlockOperation extends CompilationUnitRewriteOperation {
		...
		public static boolean satisfiesCleanUpPrecondition(Statement controlStatement, ChildPropertyDescriptor childDescriptor,
		...
		if (statement instanceof IfStatement) {
			...
			while (iter.hasNext()) {
				...
				if (RemoveBlockOperation.satisfiesQuickAssistPrecondition(item, IfStatement.THEN_STATEMENT_PROPERTY)) {
					...
					if (item == statement)
						result.add(new ControlStatementsFix(FixMessages.ControlStatementsFix_removeIfBlock_proposalDescription,
			...
			if (RemoveBlockOperation.satisfiesQuickAssistPrecondition(item, IfStatement.ELSE_STATEMENT_PROPERTY)) {
				...
				if (item == statement)
					result.add(
							new ControlStatementsFix(FixMessages.ControlStatementsFix_removeElseBlock_proposalDescription, compilationUnit,
