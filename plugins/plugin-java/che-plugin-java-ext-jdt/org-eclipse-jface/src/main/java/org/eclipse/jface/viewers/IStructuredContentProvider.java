...
public interface IStructuredContentProvider extends IContentProvider {
  /**
   * Returns the elements to display in the viewer when its input is set to the given element. These
   * elements can be presented as rows in a table, items in a list, etc. The result is not modified
   * by the viewer.
   *
