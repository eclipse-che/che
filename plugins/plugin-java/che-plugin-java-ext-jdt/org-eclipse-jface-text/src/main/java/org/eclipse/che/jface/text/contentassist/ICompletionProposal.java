 ...
 * <ul>
 * <li>{@link ICompletionProposalExtension} since version 2.0 introducing
 ...
 *			</ul>
 * </li>
 * <li>{@link ICompletionProposalExtension2} since version 2.1 introducing
 *		the following functions:
 *			<ul>
 ...
 *			</ul>
 * </li>
 * <li>{@link ICompletionProposalExtension3} since version 3.0 introducing
 *		the following functions:
 *			<ul>
 ...
 *			</ul>
 * </li>
 * <li>{@link ICompletionProposalExtension4} since version 3.1 introducing
 *		the following functions:
 *			<ul>
 *				<li>specify whether a proposal is automatically insertable</li>
 *			</ul>
 * </li>
 * <li>{@link ICompletionProposalExtension5} since version 3.2 introducing
 *		the following function:
 *			<ul>
 *				<li>Allow background computation of the additional info</li>
 *			</ul>
 * </li>
 * <li>{@link ICompletionProposalExtension6} since version 3.4 introducing
 *		the following function:
 *			<ul>
...
public interface ICompletionProposal {
	 ...
	 * document position during {@link #apply(org.eclipse.jface.text.IDocument)}.
	 *
