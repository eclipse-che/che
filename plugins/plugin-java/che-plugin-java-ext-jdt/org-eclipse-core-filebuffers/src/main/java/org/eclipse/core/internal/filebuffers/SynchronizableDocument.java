...
public class SynchronizableDocument extends Document implements ISynchronizable {
	 ...
	 * @since 3.4
	 */
	public Position[] getPositions(String category, int offset, int length, boolean canStartBefore, boolean canEndAfter) throws
	 ...
	 * @since 3.5
	 */
	public ITypedRegion[] computePartitioning(String partitioning, int offset, int length, boolean includeZeroLengthPartitions) throws
