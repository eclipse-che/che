...
/**
 * ContainerDescription is a lightweight description that describes a container to be created.
 *
...
public abstract class ContainerDescription extends AbstractResourceDescription {
   ...
   * the container. The returned ContainerDescription should represent any non-existing parents in
  ...
  /**
   * Create a group container description from the specified container handle that can be used to
   * create the container. The returned ContainerDescription should represent any non-existing
   * parents in addition to the specified container.
   *
   * @param container the handle of the container to be described
   * @return a container description describing the container and any non-existing parents.
   */
  ...
  public void addMember(AbstractResourceDescription member) {
    if (members == null) {
      ...
      AbstractResourceDescription[] expandedMembers =
          new AbstractResourceDescription[members.length + 1];
