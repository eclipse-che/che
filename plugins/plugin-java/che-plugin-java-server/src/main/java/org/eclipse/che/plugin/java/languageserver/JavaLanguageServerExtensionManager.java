...
/** Manager sends custom commands to our jdt.ls extension. */
@Singleton
public class JavaLanguageServerExtensionManager {
  private final Gson gson;
  private final LanguageServerRegistry registry;

  private static final Logger LOG =
      LoggerFactory.getLogger(JavaLanguageServerExtensionManager.class);

  @Inject
  public JavaLanguageServerExtensionManager(LanguageServerRegistry registry) {
