 ...
 *******************************************************************************/
package org.eclipse.che.plugin.sdk.ide.command;

import org.eclipse.che.ide.CommandLine;

import static org.eclipse.che.plugin.sdk.ide.command.GwtCheCommandType.CODE_SERVER_FQN;
import static org.eclipse.che.plugin.sdk.ide.command.GwtCheCommandType.COMMAND_TEMPLATE;
