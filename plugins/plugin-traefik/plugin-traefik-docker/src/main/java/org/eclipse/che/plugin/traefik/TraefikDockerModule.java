...
public class TraefikDockerModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        if (parseBoolean(getenv("CHE_PLUGIN_TRAEFIK_ENABLED"))) {
            ...
            final TraefikCreateContainerInterceptor
                traefikCreateContainerInterceptor = new TraefikCreateContainerInterceptor();
            requestInjection(traefikCreateContainerInterceptor);
            bindInterceptor(subclassesOf(DockerConnector.class), names("createContainer"),
