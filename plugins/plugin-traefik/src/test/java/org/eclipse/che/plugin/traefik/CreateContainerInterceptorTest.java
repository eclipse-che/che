...
public class CreateContainerInterceptorTest {
    ...
    @InjectMocks
    private CreateContainerInterceptor createContainerInterceptor;
    ...
    public void testRules() throws Throwable {
        ...
        createContainerInterceptor.invoke(methodInvocation);
