...
public final class KubernetesResourceUtil {
    ...
    public static Service getServiceBySelector(final String selectorKey, final String selectorValue, final String namespace) {
        try (OpenShiftClient openShiftClient = new DefaultOpenShiftClient()) {
    ...
    public static List<Route> getRoutesByLabel(final String labelKey, final String labelValue, final String namespace) throws IOException {
        try (OpenShiftClient openShiftClient = new DefaultOpenShiftClient()) {
