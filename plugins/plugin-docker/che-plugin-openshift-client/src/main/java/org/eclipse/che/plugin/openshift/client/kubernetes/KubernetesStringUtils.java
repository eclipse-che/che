...
public final class KubernetesStringUtils {
   ...
   *
   * <p>{@code docker tag eclipse/ubuntu_jdk8 eclipse-che/<workspace-id>},
   *
   * <p>this is not possible in OpenShift. This method returns a trimmed version of {@code
   * <workspace-id>}
   *
   ...
   *
   * <p>e.g. will convert {@code eclipse/ubuntu_jdk8} and {@code eclipse-che/<workspace-id>} into
   * {@code eclipse_ubuntu_jdk8:<workspace-id>}
   *
   ...
   * [<registry>]/[<organization>]/<image>:[<tag>]}, will return just {@code <image>}
   *
   * <p>In the case where the pull spec does not contain optional components, this method simply
   ...
   * [<registry>]/[<organization>]/<image>:[<tag>]}, will return just {@code <tag>}
   *
   * @param pullSpec
