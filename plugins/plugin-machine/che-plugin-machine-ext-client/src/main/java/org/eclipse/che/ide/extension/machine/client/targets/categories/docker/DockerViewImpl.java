...
public class DockerViewImpl implements DockerView {
    ...
    private static final DockerViewImplUiBinder UI_BINDER = GWT.create(DockerViewImplUiBinder.class);
    ...
    interface DockerViewImplUiBinder extends UiBinder<FlowPanel, DockerViewImpl> {
    }
}
