 ...
 */
class PHPUnitLogger5x extends PHPUnit_Util_Printer implements PHPUnit_Framework_TestListener
{
        ...
        if ($this->exception !== null) {
            ...
            $result += array(
                'exception' => array(
                    ...
                    'trace' => $this->filterTrace($this->exception->getTrace())
                )
            );
...
class ZendPHPUnitErrorHandlerTracer extends ZendPHPUnitErrorHandler
{
    ...
    public function handle($errno, $errstr, $errfile, $errline)
    {
        ...
        $warning = array(
            ...
            'file' => $errfile,
            'line' => $errline,
            'trace' => $this->filterTrace(debug_backtrace()),
