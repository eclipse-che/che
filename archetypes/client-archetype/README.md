...
# Use the archetype to generate a new plug-in
    mvn archetype:generate -DarchetypeCatalog=local -DarchetypeGroupId=org.eclipse.che.ide -DarchetypeArtifactId=che-client-extension-archetype -DinteractiveMode=false
