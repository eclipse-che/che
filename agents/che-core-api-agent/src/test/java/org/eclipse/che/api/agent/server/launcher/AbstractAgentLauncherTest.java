...
//        doReturn(process).when(launcher).start(any(Runtime.class), any(Agent.class));
...
//
//        // then
//        verify(launcher, never()).start(any(Runtime.class), any(Agent.class));
