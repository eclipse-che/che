...
DEFAULT_CHE_INFRA_OPENSHIFT_MASTER__URL="${OPENSHIFT_ENDPOINT}/auth/"
...
CHE_INFRA_OPENSHIFT_MASTER__URL=${CHE_INFRA_OPENSHIFT_MASTER__URL:-${DEFAULT_CHE_INFRA_OPENSHIFT_MASTER__URL}}
