...
let WorkspaceDetailsPlugins = class WorkspaceDetailsPlugins {
    ...
    addPluginAndOpenWorkspace(namespace, workspaceName, pluginName, pluginId, pluginVersion) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.testWorkspaceUtil.waitWorkspaceStatus(namespace, workspaceName, TestWorkspaceUtil_1.WorkspaceStatus.RUNNING);
...
WorkspaceDetailsPlugins = __decorate([
    ...
    __param(2, inversify_1.inject(inversify_types_1.CLASSES.TestWorkspaceUtil)),
