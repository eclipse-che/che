...
init_usage() {
  USAGE="
Usage: docker run <DOCKER_PARAMETERS> ${CHE_IMAGE_FULLNAME} [COMMAND]
...
Optional Docker Parameters:
  -e CHE_HOST                          IP address or hostname where ${CHE_FORMAL_PRODUCT_NAME} will serve its users
  -e CHE_PORT                          Port that $CHE_FORMAL_PRODUCT_NAME} will bind to
